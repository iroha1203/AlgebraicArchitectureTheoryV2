...
/-- Audit alias for base-change-stable architecture readings. -/
def standardSchemeEquationArchitectureReading :=
  @LawAlgebra.EquationArchitectureReading

/-- Audit alias for architecture reading pullback. -/
def standardSchemeEquationArchitectureReadingPullback :=
  @LawAlgebra.EquationArchitectureReading.pullback

/-- Audit alias for the object read from relative architecture data. -/
def standardSchemeEquationArchitectureReadingObject :=
  @LawAlgebra.EquationArchitectureReading.object

/-- Audit alias for residual compatibility under reading pullback. -/
def standardSchemeEquationArchitectureReadingResidualPullback :=
  @LawAlgebra.EquationArchitectureReading.residual_pullback

noncomputable def standardSchemeEquationArchitectureReadingPointFunctor :=
  @LawAlgebra.EquationArchitectureReading.pointFunctor

def standardSchemeEquationArchitectureReadingPointFunctorMap :=
  @LawAlgebra.EquationArchitectureReading.pointFunctor_map

/-- Audit alias for equation-system-generated points. -/
def standardSchemeEquationArchitecturePoint :=
  @LawAlgebra.EquationArchitecturePoint

/-- Audit alias for generated point pullback. -/
def standardSchemeEquationArchitecturePointPullback :=
  @LawAlgebra.EquationArchitecturePoint.pullback

/-- Audit alias for generated point extensionality. -/
def standardSchemeEquationArchitecturePointExt :=
  @LawAlgebra.EquationArchitecturePoint.ext

/-- Audit alias for identity preservation of generated point pullback. -/
def standardSchemeEquationArchitecturePointPullbackId :=
  @LawAlgebra.EquationArchitecturePoint.pullback_id

/-- Audit alias for composition preservation of generated point pullback. -/
def standardSchemeEquationArchitecturePointPullbackComp :=
  @LawAlgebra.EquationArchitecturePoint.pullback_comp

/-- Audit alias for represented equation-observable sources. -/
def standardSchemeEquationObservableRealization :=
  @LawAlgebra.EquationObservableRealization

noncomputable def standardSchemeEquationObservableSchemePointFunctor :=
  @LawAlgebra.EquationObservableRealization.schemePointFunctor

def standardSchemeEquationRepresentingGeometry :=
  @LawAlgebra.EquationObservableRealization.EquationRepresentingGeometry

noncomputable def standardSchemeEquationRepresentingGeometryRealization :=
  @LawAlgebra.EquationObservableRealization.EquationRepresentingGeometry.realization

/-- Audit alias for the named representing-equivalence constructor. -/
noncomputable def standardSchemeEquationObservableRealizationOfRepresentingEquiv :=
  @LawAlgebra.EquationObservableRealization.ofRepresentingEquiv

/-- Audit alias for the constructor's architecture-reading equation. -/
def standardSchemeEquationObservableRealizationOfRepresentingEquivReading :=
  @LawAlgebra.EquationObservableRealization.ofRepresentingEquiv_reading

/-- Audit alias for the constructor's representing-equivalence equation. -/
def standardSchemeEquationObservableRealizationOfRepresentingEquivRepresentingEquiv :=
  @LawAlgebra.EquationObservableRealization.ofRepresentingEquiv_representingEquiv

/-- Audit alias for represented source points. -/
noncomputable def standardSchemeEquationObservableRealizationPointAt :=
  @LawAlgebra.EquationObservableRealization.pointAt

/-- Audit alias for section-dependent architecture readings. -/
noncomputable def standardSchemeEquationObservableRealizationArchitectureAt :=
  @LawAlgebra.EquationObservableRealization.architectureAt

/-- Audit alias for observable evaluation at represented points. -/
noncomputable def standardSchemeEquationObservableRealizationEvaluation :=
  @LawAlgebra.EquationObservableRealization.evaluation

/-- Audit alias for universal contextwise observable maps. -/
noncomputable def standardSchemeEquationObservableRealizationSectionMap :=
  @LawAlgebra.EquationObservableRealization.sectionMap

/-- Audit alias for generated regular residual sections. -/
noncomputable def standardSchemeEquationObservableRealizationResidualSection :=
  @LawAlgebra.EquationObservableRealization.residualSection

/-- Audit alias for recognition of represented equation-observable sources. -/
def standardSchemeIsEquationObservableRealization :=
  @LawAlgebra.IsEquationObservableRealization

/-- Audit alias for naturality of the representing equivalence. -/
def standardSchemeIsEquationObservableRealizationRepresentingEquivNatural :=
  @LawAlgebra.IsEquationObservableRealization.representingEquiv_natural

/-- Audit alias for validity generated by the named constructor. -/
def standardSchemeEquationObservableRealizationOfRepresentingEquivValid :=
  @LawAlgebra.EquationObservableRealization.ofRepresentingEquiv_valid

def standardSchemeEquationRepresentingGeometryRealizationValid :=
  @LawAlgebra.EquationObservableRealization.EquationRepresentingGeometry.realization_valid

noncomputable def standardSchemeEquationObservableRealizationRepresentingIso :=
  @LawAlgebra.EquationObservableRealization.representingIso

noncomputable def standardSchemeEquationObservableRealizationToRepresentingGeometry :=
  @LawAlgebra.EquationObservableRealization.toRepresentingGeometry
...
def closedEquationalGeometryEquationWitnessIndex :=
  @LawAlgebra.EquationObservableRealization.WitnessIndex

def closedEquationalGeometryEquationPointAtComp :=
  @LawAlgebra.EquationObservableRealization.pointAt_comp

def closedEquationalGeometryEquationArchitectureReadingAtComp :=
  @LawAlgebra.EquationObservableRealization.architectureReadingAt_comp

def closedEquationalGeometryEquationResidualEvaluationComp :=
  @LawAlgebra.EquationObservableRealization.residualEvaluation_comp

def closedEquationalGeometryEquationEvaluationEqPullback :=
  @LawAlgebra.EquationObservableRealization.evaluation_eq_pullback

def closedEquationalGeometryEquationSectionMapNatural :=
  @LawAlgebra.EquationObservableRealization.sectionMap_natural
...
def closedEquationalGeometryEquationViolationSectionNatural :=
  @LawAlgebra.EquationObservableRealization.violationSection_natural
...
noncomputable def closedEquationalGeometryEquationRealizationIdeal :=
  @LawAlgebra.EquationObservableRealization.realizationIdeal

noncomputable def closedEquationalGeometryEquationChartRealizationRelation :=
  @LawAlgebra.EquationObservableRealization.chartRealizationRelation

noncomputable def closedEquationalGeometryEquationChartRealizationIdeal :=
  @LawAlgebra.EquationObservableRealization.chartRealizationIdeal

def closedEquationalGeometryEquationChartRealizationIdealEqMap :=
  @LawAlgebra.EquationObservableRealization.chartRealizationIdeal_eq_map

noncomputable def closedEquationalGeometryEquationRealizationIdealSheaf :=
  @LawAlgebra.EquationObservableRealization.realizationIdealSheaf

noncomputable def closedEquationalGeometryEquationRealizationScheme :=
  @LawAlgebra.EquationObservableRealization.realizationScheme

noncomputable def closedEquationalGeometryEquationRealizationImmersion :=
  @LawAlgebra.EquationObservableRealization.realizationImmersion

def closedEquationalGeometryEquationRealizationImmersionIsClosed :=
  @LawAlgebra.EquationObservableRealization.realizationImmersion_isClosedImmersion

def closedEquationalGeometryEquationRealizationImmersionKer :=
  @LawAlgebra.EquationObservableRealization.realizationImmersion_ker
...
noncomputable def closedEquationalGeometryEquationAmbientChartCover :=
  @LawAlgebra.EquationObservableRealization.ambientChartCover

noncomputable def closedEquationalGeometryEquationRealizationChartCover :=
  @LawAlgebra.EquationObservableRealization.realizationChartCover

noncomputable def closedEquationalGeometryEquationTestChartCover :=
  @LawAlgebra.EquationObservableRealization.testChartCover

noncomputable def closedEquationalGeometryEquationTestChart :=
  @LawAlgebra.EquationObservableRealization.testChart

noncomputable def closedEquationalGeometryEquationTestChartMap :=
  @LawAlgebra.EquationObservableRealization.testChartMap

noncomputable def closedEquationalGeometryEquationTestChartEvaluation :=
  @LawAlgebra.EquationObservableRealization.testChartEvaluation

def closedEquationalGeometryEquationTestChartEvaluationEqRestrict :=
  @LawAlgebra.EquationObservableRealization.testChartEvaluation_eq_restrict

def closedEquationalGeometryEquationTestChartEvaluationNatural :=
  @LawAlgebra.EquationObservableRealization.testChartEvaluation_natural
...
noncomputable def closedEquationalGeometryEquationTestChartResidualValue :=
  @LawAlgebra.EquationObservableRealization.testChartResidualValue

def closedEquationalGeometryEquationTestChartResidualValueEqRestrict :=
  @LawAlgebra.EquationObservableRealization.testChartResidualValue_eq_restrict
...
def closedEquationalGeometryEquationContextWitnessIdealEqOfHom :=
  @LawAlgebra.EquationObservableRealization.contextWitnessIdeal_eq_of_hom
...
noncomputable def closedEquationalGeometryEquationChartWitnessIdeal :=
  @LawAlgebra.EquationObservableRealization.chartWitnessIdeal

def closedEquationalGeometryEquationChartWitnessIdealEqMapContext :=
  @LawAlgebra.EquationObservableRealization.chartWitnessIdeal_eq_map_context

def closedEquationalGeometryEquationChartWitnessIdealEqMapGlobal :=
  @LawAlgebra.EquationObservableRealization.chartWitnessIdeal_eq_map_global

noncomputable def closedEquationalGeometryEquationOverlapChart :=
  @LawAlgebra.EquationObservableRealization.overlapChart

noncomputable def closedEquationalGeometryEquationOverlapToLeft :=
  @LawAlgebra.EquationObservableRealization.overlapToLeft

noncomputable def closedEquationalGeometryEquationOverlapToRight :=
  @LawAlgebra.EquationObservableRealization.overlapToRight

noncomputable def closedEquationalGeometryEquationOverlapWitnessIdealLeft :=
  @LawAlgebra.EquationObservableRealization.overlapWitnessIdealLeft

noncomputable def closedEquationalGeometryEquationOverlapWitnessIdealRight :=
  @LawAlgebra.EquationObservableRealization.overlapWitnessIdealRight

def closedEquationalGeometryEquationChartLocalization :=
  @LawAlgebra.EquationObservableRealization.EquationChartLocalization

def closedEquationalGeometryLocalizationTransportRingEquiv :=
  @LawAlgebra.IsLocalization.transportRingEquiv

def closedEquationalGeometryLocalizationTransportRingEquivOfEq :=
  @LawAlgebra.IsLocalization.transportRingEquivOfEq

noncomputable def closedEquationalGeometryEquationWitnessIdealLocalizes :=
  @LawAlgebra.EquationObservableRealization.witnessIdealLocalizes

noncomputable def closedEquationalGeometryEquationWitnessIdealLocalizationEquiv :=
  @LawAlgebra.EquationObservableRealization.witnessIdealLocalizationEquiv

def closedEquationalGeometryEquationOverlapWitnessIdealEq :=
  @LawAlgebra.EquationObservableRealization.overlapWitnessIdeal_left_eq_right
...
def closedEquationalGeometryEquationRealizationIdealChart :=
  @LawAlgebra.EquationObservableRealization.realizationIdealChart
...
def closedEquationalGeometryEquationWitnessChartRealized :=
  @LawAlgebra.EquationObservableRealization.EquationWitnessChartRealized

def closedEquationalGeometryEquationWitnessChartRealizedTheorem :=
  @LawAlgebra.EquationObservableRealization.equationWitnessChartRealized

def closedEquationalGeometryEquationIdealChartCondition :=
  @LawAlgebra.EquationObservableRealization.EquationIdealChartCondition
...
noncomputable def closedEquationalGeometryEquationGlobalObstructionIdeal :=
  @LawAlgebra.EquationObservableRealization.globalObstructionIdeal

def closedEquationalGeometryEquationGlobalObstructionIdealEqISupRequired :=
  @LawAlgebra.EquationObservableRealization.globalObstructionIdeal_eq_iSup_required

noncomputable def closedEquationalGeometryEquationGlobalWitnessIdealSheaf :=
  @LawAlgebra.EquationObservableRealization.globalWitnessIdealSheaf

noncomputable def closedEquationalGeometryEquationGlobalObstructionIdealSheaf :=
  @LawAlgebra.EquationObservableRealization.globalObstructionIdealSheaf

noncomputable def closedEquationalGeometryEquationWitnessIdealSheaf :=
  @LawAlgebra.EquationObservableRealization.witnessIdealSheaf

noncomputable def closedEquationalGeometryEquationGeneratedIdealSheaf :=
  @LawAlgebra.EquationObservableRealization.generatedIdealSheaf

def closedEquationalGeometryEquationGeneratedIdealSheafEqObstruction :=
  @LawAlgebra.EquationObservableRealization.generatedIdealSheaf_eq_globalObstructionIdealSheaf
...
def closedEquationalGeometryEquationLawfulAlongOfEquationLawful :=
  @LawAlgebra.EquationObservableRealization.equationLawfulAlong_of_equationLawful
...
def closedEquationalGeometryFactorsThroughEquationRealization :=
  @LawAlgebra.EquationObservableRealization.FactorsThroughRealization

def closedEquationalGeometryEquationRealizationIdealIffFactors :=
  @LawAlgebra.EquationObservableRealization.realizationIdeal_iff_nonempty_factorsThrough

def closedEquationalGeometryEquationHoldsIffWitnessIdeal :=
  @LawAlgebra.EquationObservableRealization.equationHoldsAlong_iff_witnessIdeal

noncomputable def closedEquationalGeometryEquationClosedSubscheme :=
  @LawAlgebra.EquationObservableRealization.equationClosedSubscheme

noncomputable def closedEquationalGeometryEquationClosedImmersion :=
  @LawAlgebra.EquationObservableRealization.equationClosedImmersion

def closedEquationalGeometryEquationClosedImmersionIsClosed :=
  @LawAlgebra.EquationObservableRealization.equationClosedImmersion_isClosedImmersion

def closedEquationalGeometryEquationClosedImmersionKer :=
  @LawAlgebra.EquationObservableRealization.equationClosedImmersion_ker

def closedEquationalGeometryFactorsThroughEquationClosedSubscheme :=
  @LawAlgebra.EquationObservableRealization.FactorsThroughEquationClosedSubscheme

def closedEquationalGeometryEquationWitnessIdealIffFactors :=
  @LawAlgebra.EquationObservableRealization.witnessIdeal_iff_nonempty_factorsThrough
...
noncomputable def closedEquationalGeometryEquationLawfulClosedImmersion :=
  @LawAlgebra.EquationObservableRealization.lawfulClosedImmersion

def closedEquationalGeometryEquationLawfulClosedImmersionIsClosed :=
  @LawAlgebra.EquationObservableRealization.lawfulClosedImmersion_isClosedImmersion

def closedEquationalGeometryEquationLawfulClosedImmersionKer :=
  @LawAlgebra.EquationObservableRealization.lawfulClosedImmersion_ker

def closedEquationalGeometryFactorsThroughEquationLawfulClosedSubscheme :=
  @LawAlgebra.EquationObservableRealization.FactorsThroughLawfulClosedSubscheme
...
def readingFunctoriality_equationBaseChangeRepresentation :=
  @AAT.AG.LawAlgebra.EquationObservableRealization.BaseChangeRepresentation

noncomputable def readingFunctoriality_equationBaseChangeRepresentationOfIsIso :=
  @AAT.AG.LawAlgebra.EquationObservableRealization.BaseChangeRepresentation.ofIsIso

noncomputable def readingFunctoriality_equationBaseChangeRepresentationOfBijectiveCoefficient :=
  @AAT.AG.LawAlgebra.EquationObservableRealization.BaseChangeRepresentation.ofBijectiveCoefficient

def readingFunctoriality_equationBaseChangeRepresentationNatural :=
  @AAT.AG.LawAlgebra.EquationObservableRealization.BaseChangeRepresentation.representingEquiv_natural
...
def readingFunctoriality_equationCoefficientSwapNeRefl :=
  @AAT.AG.LawAlgebra.EquationObservableRealization.BaseChangeRepresentation.coefficientSwap_ne_refl

noncomputable def readingFunctoriality_equationBaseChangeRepresentationOfCoefficientSwap :=
  @AAT.AG.LawAlgebra.EquationObservableRealization.BaseChangeRepresentation.ofCoefficientSwap
...
def readingFunctoriality_equationCoefficientSwapBaseChangeValid :=
  @AAT.AG.LawAlgebra.EquationObservableRealization.coefficientSwap_baseChange_valid

def readingFunctoriality_equationRealizationBaseChangeSectionMapEq :=
  @AAT.AG.LawAlgebra.EquationObservableRealization.baseChange_sectionMap_eq
...
def readingFunctoriality_equationBaseChangeUniversalReading :=
  @AAT.AG.LawAlgebra.EquationObservableRealization.baseChange_universalReading

def readingFunctoriality_equationViolationSectionBaseChange :=
  @AAT.AG.LawAlgebra.EquationObservableRealization.violationSection_baseChange
...
def readingFunctoriality_equationRealizationIdealBaseChange :=
  @AAT.AG.LawAlgebra.EquationObservableRealization.realizationIdeal_baseChange

def readingFunctoriality_equationGlobalWitnessIdealBaseChange :=
  @AAT.AG.LawAlgebra.EquationObservableRealization.globalWitnessIdeal_baseChange
...
def readingFunctoriality_equationGlobalWitnessIdealSheafBaseChange :=
  @AAT.AG.LawAlgebra.EquationObservableRealization.globalWitnessIdealSheaf_baseChange

def readingFunctoriality_equationGlobalObstructionIdealSheafBaseChange :=
  @AAT.AG.LawAlgebra.EquationObservableRealization.globalObstructionIdealSheaf_baseChange

noncomputable def readingFunctoriality_equationRealizationBaseChangeMap :=
  @AAT.AG.LawAlgebra.EquationObservableRealization.realizationBaseChangeMap

def readingFunctoriality_equationRealizationBaseChangeMapImmersion :=
  @AAT.AG.LawAlgebra.EquationObservableRealization.realizationBaseChangeMap_immersion

def readingFunctoriality_equationWitnessIdealSheafBaseChange :=
  @AAT.AG.LawAlgebra.EquationObservableRealization.witnessIdealSheaf_baseChange

def readingFunctoriality_equationGeneratedIdealSheafBaseChange :=
  @AAT.AG.LawAlgebra.EquationObservableRealization.generatedIdealSheaf_baseChange

noncomputable def readingFunctoriality_equationLawfulClosedSubschemeBaseChangeMap :=
  @AAT.AG.LawAlgebra.EquationObservableRealization.lawfulClosedSubschemeBaseChangeMap

def readingFunctoriality_equationLawfulClosedSubschemeBaseChangeMapImmersion :=
  @AAT.AG.LawAlgebra.EquationObservableRealization.lawfulClosedSubschemeBaseChangeMap_immersion
...
def standardGeometry_leftToOverlap_isLocalization :=
  @AAT.AG.Examples.StandardGeometryReferenceModels.leftToOverlap_isLocalization

def standardGeometry_rightToOverlap_isLocalization :=
  @AAT.AG.Examples.StandardGeometryReferenceModels.rightToOverlap_isLocalization
...
noncomputable def standardGeometry_referenceEquationArchitectureReading :=
  @AAT.AG.Examples.StandardGeometryReferenceModels.referenceEquationArchitectureReading

noncomputable def standardGeometry_referenceEquationRepresentingEquiv :=
  @AAT.AG.Examples.StandardGeometryReferenceModels.referenceEquationRepresentingEquiv

def standardGeometry_referenceEquationRepresentingEquiv_natural :=
  @AAT.AG.Examples.StandardGeometryReferenceModels.referenceEquationRepresentingEquiv_natural
...
noncomputable def standardGeometry_referenceEquationRepresentingGeometry :=
  @AAT.AG.Examples.StandardGeometryReferenceModels.referenceEquationRepresentingGeometry
...
def standardGeometry_disconnected_canonicalBaseRight_isIso :=
  @AAT.AG.Examples.StandardGeometryReferenceModels.DisconnectedGluing.canonicalBaseRight_isIso

noncomputable def standardGeometry_disconnected_globalToRaw :=
  @AAT.AG.Examples.StandardGeometryReferenceModels.DisconnectedGluing.globalToRaw

def standardGeometry_disconnected_globalToRaw_rawToGlobal :=
  @AAT.AG.Examples.StandardGeometryReferenceModels.DisconnectedGluing.globalToRaw_rawToGlobal

noncomputable def standardGeometry_disconnected_globalEvalZero :=
  @AAT.AG.Examples.StandardGeometryReferenceModels.DisconnectedGluing.globalEvalZero

noncomputable def standardGeometry_disconnected_globalEvalOne :=
  @AAT.AG.Examples.StandardGeometryReferenceModels.DisconnectedGluing.globalEvalOne
...
def standardGeometry_disconnected_globalEvalZero_idempotentSection :=
  @AAT.AG.Examples.StandardGeometryReferenceModels.DisconnectedGluing.globalEvalZero_idempotentSection

def standardGeometry_disconnected_globalEvalOne_idempotentSection :=
  @AAT.AG.Examples.StandardGeometryReferenceModels.DisconnectedGluing.globalEvalOne_idempotentSection
...
def standardGeometry_disconnected_chartOpen_componentB_ne_bot :=
  @AAT.AG.Examples.StandardGeometryReferenceModels.DisconnectedGluing.chartOpen_componentB_ne_bot

def standardGeometry_disconnected_ambient_disconnected :=
  @AAT.AG.Examples.StandardGeometryReferenceModels.DisconnectedGluing.ambient_disconnected

def standardGeometry_disconnected_ambientResidualSection_eq_zero :=
  @AAT.AG.Examples.StandardGeometryReferenceModels.DisconnectedGluing.ambientResidualSection_eq_zero

noncomputable def standardGeometry_disconnected_globalParity :=
  @AAT.AG.Examples.StandardGeometryReferenceModels.DisconnectedGluing.globalParity

def standardGeometry_disconnected_globalParity_realizationRelation :=
  @AAT.AG.Examples.StandardGeometryReferenceModels.DisconnectedGluing.globalParity_realizationRelation

def standardGeometry_disconnected_realizationIdeal_ne_top :=
  @AAT.AG.Examples.StandardGeometryReferenceModels.DisconnectedGluing.realizationIdeal_ne_top

def standardGeometry_disconnected_chartAgreement_fails :=
  @AAT.AG.Examples.StandardGeometryReferenceModels.DisconnectedGluing.chartAgreement_fails
...
def standardGeometry_referenceSiteAmbientResidualSection_image :=
  @AAT.AG.Examples.StandardGeometryReferenceModels.referenceSiteAmbientResidualSection_image
...
def standardGeometry_referenceSiteResidualSection_image :=
  @AAT.AG.Examples.StandardGeometryReferenceModels.referenceSiteResidualSection_image

def standardGeometry_referenceSiteGeneratedIdealSheaf_eq_obstructionIdeal :=
  @AAT.AG.Examples.StandardGeometryReferenceModels.referenceSiteGeneratedIdealSheaf_eq_obstructionIdeal

noncomputable def standardGeometry_referenceLegacySiteReading :=
  @AAT.AG.Examples.StandardGeometryReferenceModels.referenceLegacySiteReading

def standardGeometry_referenceLegacySiteReading_valid :=
  @AAT.AG.Examples.StandardGeometryReferenceModels.referenceLegacySiteReading_valid

def standardGeometry_referenceLegacySiteReading_requiredClosed :=
  @AAT.AG.Examples.StandardGeometryReferenceModels.referenceLegacySiteReading_requiredClosed

def standardGeometry_referenceLegacySiteReading_requiredLawIdealExact :=
  @AAT.AG.Examples.StandardGeometryReferenceModels.referenceLegacySiteReading_requiredLawIdealExact

def standardGeometry_referenceSite_acyclic_residual_zero :=
  @AAT.AG.Examples.StandardGeometryReferenceModels.referenceSite_acyclic_residual_zero

def standardGeometry_siteEquationModTwoPoint_realizationRelations :=
  @AAT.AG.Examples.StandardGeometryReferenceModels.siteEquationModTwoPoint_realizationRelations

def standardGeometry_siteEquationModTwoPoint_realizes :=
  @AAT.AG.Examples.StandardGeometryReferenceModels.siteEquationModTwoPoint_realizes

noncomputable def standardGeometry_siteEquationModTwoRealizationPoint :=
  @AAT.AG.Examples.StandardGeometryReferenceModels.siteEquationModTwoRealizationPoint

def standardGeometry_siteEquationModTwoRealizationPoint_immersion :=
  @AAT.AG.Examples.StandardGeometryReferenceModels.siteEquationModTwoRealizationPoint_immersion

def standardGeometry_siteEquationModTwoPoint_residualRepresentable :=
  @AAT.AG.Examples.StandardGeometryReferenceModels.siteEquationModTwoPoint_residualRepresentable

def standardGeometry_siteEquationModTwoPoint_equationLawful :=
  @AAT.AG.Examples.StandardGeometryReferenceModels.siteEquationModTwoPoint_equationLawful
...
def standardGeometry_siteEquationModTwoPoint_factors_equation :=
  @AAT.AG.Examples.StandardGeometryReferenceModels.siteEquationModTwoPoint_factors_equation
...
noncomputable def standardGeometry_cyclicUnitEquationArchitectureReading :=
  @AAT.AG.Examples.StandardGeometryReferenceModels.cyclicUnitEquationArchitectureReading

noncomputable def standardGeometry_cyclicUnitEquationRepresentingEquiv :=
  @AAT.AG.Examples.StandardGeometryReferenceModels.cyclicUnitEquationRepresentingEquiv

def standardGeometry_cyclicUnitEquationRepresentingEquiv_natural :=
  @AAT.AG.Examples.StandardGeometryReferenceModels.cyclicUnitEquationRepresentingEquiv_natural
...
def standardGeometry_cyclicUnitSitePoint_not_factors_equation :=
  @AAT.AG.Examples.StandardGeometryReferenceModels.cyclicUnitSitePoint_not_factors_equation
...
def standardGeometry_siteEquationModTwoPoint_factors_legacy :=
  @AAT.AG.Examples.StandardGeometryReferenceModels.siteEquationModTwoPoint_factors_legacy
...
(cochain level — the class vanishes, unlike the C7 class-level alias
`sagaCircleWitnessSemanticResidualNeZero`). -/
def sagaDescentWitnessSemanticResidualCochainNeZero :=
...
(cochain level — the class vanishes). -/
def sagaDescentWitnessEquationResidualCochainNeZero :=
...
/-- Kernel-audit alias for the constructed cover-sieve topology membership. -/
def sagaDescentWitnessMemTopology :=
  @SemanticRepair.Saga.DescentWitness.descentCover_mem_topology

/-- Kernel-audit alias for the `P_sem` state-presheaf sheaf condition. -/
def sagaDescentWitnessStateSheaf :=
  @SemanticRepair.Saga.DescentWitness.descent_stateSheaf

/-- Kernel-audit alias for the `P_E` state-presheaf sheaf condition. -/
def sagaDescentWitnessEquationStateSheaf :=
  @SemanticRepair.Saga.DescentWitness.descent_equationStateSheaf

/-- Kernel-audit alias for the semantic residual coboundary computation. -/
def sagaDescentWitnessSemanticResidualCoboundary :=
  @SemanticRepair.Saga.DescentWitness.descent_semanticResidual_coboundary

/-- Kernel-audit alias for the equation residual coboundary computation. -/
def sagaDescentWitnessEquationResidualCoboundary :=
  @SemanticRepair.Saga.DescentWitness.descent_equationResidual_coboundary

/-- Kernel-audit alias for the Theorem 8.2 forward corrected-family gluing. -/
def sagaDescentWitnessGlobalRepairOfH1IsZero :=
  @SemanticRepair.Saga.DescentWitness.descent_globalRepair_of_h1IsZero

/-- Kernel-audit alias for the Corollary 8.3 base-level `β_W` bijectivity. -/
def sagaDescentWitnessBetaBaseBijective :=
  @SemanticRepair.Saga.DescentWitness.descent_betaBase_bijective

/-- Kernel-audit alias for the atlas-independent vanishing of the class. -/
def sagaDescentWitnessEveryAtlasClassIsZero :=
  @SemanticRepair.Saga.DescentWitness.descent_every_atlas_residualClass_isZero

/-- Kernel-audit alias for nonemptiness of the selected lift fiber. -/
def sagaDescentWitnessLiftFiberStateNonempty :=
  @SemanticRepair.Saga.DescentWitness.descentLiftFiber_state_nonempty

/-- Kernel-audit alias for the equation-side global lift existence. -/
