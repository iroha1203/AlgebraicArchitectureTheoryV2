...
/-- Audit alias for the site-owned equation-system realization in global sections. -/
noncomputable def standardSchemeReadingSiteEquationGlobalSectionMap :=
  @LawAlgebra.AATReadingDecoration.siteEquationGlobalSectionMap
...
/-- Audit alias for evaluation of the site-owned equation-system realization. -/
def standardSchemeReadingSiteEquationGlobalSectionMapApply :=
  @LawAlgebra.AATReadingDecoration.siteEquationGlobalSectionMap_apply
...
/-! #### Site-owned equation-system standard geometry -/

/-- Audit alias for the global equation generated by the site-owned equation system. -/
noncomputable def closedEquationalGeometrySiteEquationGlobalEquation :=
  @LawAlgebra.siteEquationGlobalEquation

/-- Audit alias for the geometric reading generated by the site-owned equation system. -/
noncomputable def closedEquationalGeometrySiteEquationGeometricReading :=
  @LawAlgebra.GeometricLawReading.ofSiteEquationSystem

/-- Audit alias for validity of the site-owned geometric reading. -/
def closedEquationalGeometrySiteEquationGeometricReadingValid :=
  @LawAlgebra.GeometricLawReading.ofSiteEquationSystem_valid

/-- Audit alias for the site-owned geometric predicate characterization. -/
def closedEquationalGeometrySiteEquationGeometricReadingHoldsOn :=
  @LawAlgebra.GeometricLawReading.ofSiteEquationSystem_holdsOn

/-- Audit alias for the witness generated by the site-owned equation system. -/
noncomputable def closedEquationalGeometrySiteEquationWitness :=
  @LawAlgebra.ClosedEquationalLawWitness.ofSiteEquationSystem

/-- Audit alias for validity of the site-owned equation witness. -/
def closedEquationalGeometrySiteEquationWitnessValid :=
  @LawAlgebra.ClosedEquationalLawWitness.ofSiteEquationSystem_valid

/-- Audit alias for the closed-equational reading generated by the site-owned equation system. -/
noncomputable def closedEquationalGeometrySiteEquationReading :=
  @LawAlgebra.ClosedEquationalLawReading.ofSiteEquationSystem

/-- Audit alias for the witness projection of the site-owned reading. -/
def closedEquationalGeometrySiteEquationReadingWitness :=
  @LawAlgebra.ClosedEquationalLawReading.ofSiteEquationSystem_witness

/-- Audit alias for validity of the site-owned closed-equational reading. -/
def closedEquationalGeometrySiteEquationReadingValid :=
  @LawAlgebra.ClosedEquationalLawReading.ofSiteEquationSystem_valid

/-- Audit alias for required closedness of the site-owned reading. -/
def closedEquationalGeometrySiteEquationRequiredClosed :=
  @LawAlgebra.ClosedEquationalLawReading.ofSiteEquationSystem_requiredClosed

/-- Audit alias for all-law selection of the site-owned reading. -/
...
/-- Audit alias for the required generated ideal as a fixed-index supremum. -/
def closedEquationalGeometryLawGeneratedIdealSheafEqISupRequired :=
  @LawAlgebra.lawGeneratedIdealSheaf_eq_iSup_required

/-- Audit alias for the all-law generated ideal as a fixed-index supremum. -/
def closedEquationalGeometryAllLawGeneratedIdealSheafEqISup :=
  @LawAlgebra.allLawGeneratedIdealSheaf_eq_iSup

/-- Audit alias for preservation of suprema by global-ideal sheafification. -/
def closedEquationalGeometryOfIdealTopISup :=
  @LawAlgebra.ofIdealTop_iSup

/-- Audit alias for the site-owned required witness ideal sheaf. -/
noncomputable def closedEquationalGeometrySiteEquationWitnessIdealSheaf :=
  @LawAlgebra.siteEquationWitnessIdealSheaf

/-- Audit alias identifying a site-owned witness ideal sheaf with the mapped witness ideal. -/
def closedEquationalGeometrySiteEquationWitnessIdealSheafEq :=
  @LawAlgebra.siteEquationWitnessIdealSheaf_eq_ofIdealTop_map

/-- Audit alias for the site-owned generated ideal sheaf. -/
noncomputable def closedEquationalGeometrySiteEquationGeneratedIdealSheaf :=
  @LawAlgebra.siteEquationGeneratedIdealSheaf

/-- Audit alias identifying the generated ideal sheaf with the mapped obstruction ideal. -/
def closedEquationalGeometrySiteEquationGeneratedIdealSheafEq :=
  @LawAlgebra.siteEquationGeneratedIdealSheaf_eq_ofIdealTop_map_obstructionIdeal

/-- Audit alias for the site-owned lawful closed subscheme. -/
noncomputable def closedEquationalGeometrySiteEquationLawfulClosedSubscheme :=
  @LawAlgebra.siteEquationLawfulClosedSubscheme

/-- Audit alias for the site-owned lawful closed immersion. -/
noncomputable def closedEquationalGeometrySiteEquationLawfulClosedImmersion :=
  @LawAlgebra.siteEquationLawfulClosedImmersion

/-- Audit alias comparing the site-owned and generic lawful closed subschemes. -/
def closedEquationalGeometrySiteEquationLawfulClosedSubschemeEq :=
  @LawAlgebra.siteEquationLawfulClosedSubscheme_eq_lawfulClosedSubscheme

/-- Audit alias identifying the lawful closed subscheme with the obstruction-ideal subscheme. -/
def closedEquationalGeometrySiteEquationLawfulClosedSubschemeEqObstruction :=
  @LawAlgebra.siteEquationLawfulClosedSubscheme_eq_obstructionIdealSubscheme

/-- Audit alias for closedness of the site-owned lawful immersion. -/
def closedEquationalGeometrySiteEquationLawfulImmersionIsClosed :=
  @LawAlgebra.siteEquationLawfulClosedImmersion_isClosedImmersion

/-- Audit alias for the kernel of the site-owned lawful immersion. -/
...
/-- Audit alias for the site-owned semantic, ideal, and factorization correspondence. -/
...
/-! Site-owned equation-system coefficient change. -/

/-- Audit alias for the transported site-owned global equation. -/
noncomputable def readingFunctoriality_baseChangedSiteEquationGlobalEquation :=
  @AAT.AG.LawAlgebra.baseChangedSiteEquationGlobalEquation

/-- Audit alias for the coefficient-changed site-owned equation reading. -/
noncomputable def readingFunctoriality_baseChangeOfSiteEquationSystem :=
  @AAT.AG.LawAlgebra.ClosedEquationalLawReading.baseChangeOfSiteEquationSystem

/-- Audit alias for geometric vanishing under site-owned equation transport. -/
def readingFunctoriality_baseChangeOfSiteEquationSystem_geometric_iff :=
  @AAT.AG.LawAlgebra.ClosedEquationalLawReading.baseChangeOfSiteEquationSystem_geometric_iff

/-- Audit alias for validity of the transported site-owned equation reading. -/
def readingFunctoriality_baseChangeOfSiteEquationSystem_valid :=
  @AAT.AG.LawAlgebra.ClosedEquationalLawReading.baseChangeOfSiteEquationSystem_valid

/-- Audit alias for required closedness after site-owned equation transport. -/
def readingFunctoriality_baseChangeOfSiteEquationSystem_requiredClosed :=
  @AAT.AG.LawAlgebra.ClosedEquationalLawReading.baseChangeOfSiteEquationSystem_requiredClosed

/-- Audit alias for all-law selection after site-owned equation transport. -/
def readingFunctoriality_baseChangeOfSiteEquationSystem_allLawsSelected :=
  @AAT.AG.LawAlgebra.ClosedEquationalLawReading.baseChangeOfSiteEquationSystem_allLawsSelected

/-- Audit alias for per-law witness ideal transport from the site-owned equation system. -/
def readingFunctoriality_siteEquationWitnessIdealSheaf_baseChange :=
  @AAT.AG.LawAlgebra.siteEquationWitnessIdealSheaf_baseChange

/-- Audit alias for generated ideal-sheaf transport from the site-owned equation system. -/
def readingFunctoriality_siteEquationGeneratedIdealSheaf_baseChange :=
  @AAT.AG.LawAlgebra.siteEquationGeneratedIdealSheaf_baseChange

/-- Audit alias for the generated lawful closed-subscheme coefficient-change map. -/
noncomputable def readingFunctoriality_siteEquationLawfulClosedSubschemeBaseChangeMap :=
  @AAT.AG.LawAlgebra.siteEquationLawfulClosedSubschemeBaseChangeMap

/-- Audit alias for the generated lawful closed-subscheme projection triangle. -/
def readingFunctoriality_siteEquationLawfulClosedSubschemeBaseChangeMap_immersion :=
  @AAT.AG.LawAlgebra.siteEquationLawfulClosedSubschemeBaseChangeMap_immersion
