...
/-! ## Site-selected standard scheme equations -/

/--
The global equation generated by the equation system owned by the ambient AAT
site.

The selected observable ring is the coefficient ring of `siteRaw`, so the
coordinate follows the canonical realization in `StandardScheme` without a
second coordinate family or a presentation bridge.
-/
noncomputable def siteEquationGlobalEquation
    (W : S.category)
    (siteRaw :
      RawAmbientRestrictionSystem S (S.equationSystem.Observable W))
    [HasSheafify S.topology
    ...
    Γ(Y.underlying, ⊤) :=
  Y.decoration.siteEquationGlobalSectionMap W siteRaw hcontext
    (S.equationSystem.violationCoordinate W i a)

/--
The geometric equation reading generated by the equation system owned by the
ambient AAT site.
-/
noncomputable def GeometricLawReading.ofSiteEquationSystem
    (W : S.category)
    (siteRaw :
      RawAmbientRestrictionSystem S (S.equationSystem.Observable W))
    [HasSheafify S.topology
    ...
    (Y : StandardArchitectureScheme siteRaw)
    (hcontext : Y.decoration.context = W) :
    GeometricLawReading siteRaw Y S.equationSystem where
  HoldsOn s i :=
    GlobalEquationsVanishAlong siteRaw Y
      (siteEquationGlobalEquation W siteRaw Y hcontext i) s

/-- Site-generated scheme equations are stable under base change of test sections. -/
theorem GeometricLawReading.ofSiteEquationSystem_valid
    (W : S.category)
    (siteRaw :
      RawAmbientRestrictionSystem S (S.equationSystem.Observable W))
    [HasSheafify S.topology
    ...
    (Y : StandardArchitectureScheme siteRaw)
    (hcontext : Y.decoration.context = W) :
    IsGeometricLawReading siteRaw Y
      (GeometricLawReading.ofSiteEquationSystem W siteRaw Y hcontext) := by
  intro T T' s f i hs a
  rw [Scheme.Hom.comp_appTop, CommRingCat.comp_apply, hs a, map_zero]
...
theorem GeometricLawReading.ofSiteEquationSystem_holdsOn
    ...
    (GeometricLawReading.ofSiteEquationSystem
      W siteRaw Y hcontext).HoldsOn s i ↔
      ∀ a, s.appTop
        (siteEquationGlobalEquation W siteRaw Y hcontext i a) = 0 :=
  Iff.rfl
...
/-- The canonical closed-equational witness generated by the ambient site's equation system. -/
noncomputable def ClosedEquationalLawWitness.ofSiteEquationSystem
    (W : S.category)
    (siteRaw :
      RawAmbientRestrictionSystem S (S.equationSystem.Observable W))
    [HasSheafify S.topology
    ...
    (hcontext : Y.decoration.context = W)
    (i : S.equationSystem.Index) :
    ClosedEquationalLawWitness siteRaw Y S.equationSystem i :=
  ClosedEquationalLawWitness.ofGlobalSections siteRaw Y i
    (siteEquationGlobalEquation W siteRaw Y hcontext i)

/-- Site-generated closed-equational witnesses satisfy basic-open compatibility. -/
theorem ClosedEquationalLawWitness.ofSiteEquationSystem_valid
    (W : S.category)
    (siteRaw :
      RawAmbientRestrictionSystem S (S.equationSystem.Observable W))
    [HasSheafify S.topology
    ...
    (hcontext : Y.decoration.context = W)
    (i : S.equationSystem.Index) :
    IsClosedEquationalLawWitness siteRaw Y
      (ClosedEquationalLawWitness.ofSiteEquationSystem
        W siteRaw Y hcontext i) :=
  ClosedEquationalLawWitness.ofGlobalSections_valid siteRaw Y i _
...
/--
The standard closed-equational reading generated from the equation system
owned by the ambient AAT site.

Its geometric predicate, closed selection, and witnesses are all constructed;
none is supplied by the caller.
-/
noncomputable def ClosedEquationalLawReading.ofSiteEquationSystem
    (W : S.category)
    (siteRaw :
      RawAmbientRestrictionSystem S (S.equationSystem.Observable W))
    [HasSheafify S.topology
    ...
    (Y : StandardArchitectureScheme siteRaw)
    (hcontext : Y.decoration.context = W) :
    ClosedEquationalLawReading siteRaw Y S.equationSystem where
  geometric :=
    GeometricLawReading.ofSiteEquationSystem W siteRaw Y hcontext
  closed := Set.univ
  selected := fun _ => Set.univ
  witness i _ :=
    ClosedEquationalLawWitness.ofSiteEquationSystem
...
theorem ClosedEquationalLawReading.ofSiteEquationSystem_witness
    ...
    (hi :
      (ClosedEquationalLawReading.ofSiteEquationSystem
        W siteRaw Y hcontext).closed i) :
    (ClosedEquationalLawReading.ofSiteEquationSystem
      W siteRaw Y hcontext).witness i hi =
        ClosedEquationalLawWitness.ofSiteEquationSystem
          W siteRaw Y hcontext i :=
  rfl

/-- The standard site-generated reading satisfies the closed-equational recognition laws. -/
theorem ClosedEquationalLawReading.ofSiteEquationSystem_valid
    (W : S.category)
    (siteRaw :
      RawAmbientRestrictionSystem S (S.equationSystem.Observable W))
    [HasSheafify S.topology
    ...
    (Y : StandardArchitectureScheme siteRaw)
    (hcontext : Y.decoration.context = W) :
    IsClosedEquationalLawReading siteRaw Y
      (ClosedEquationalLawReading.ofSiteEquationSystem
        W siteRaw Y hcontext) where
  geometric_stable :=
    GeometricLawReading.ofSiteEquationSystem_valid W siteRaw Y hcontext
  witness_compatible := by
    intro i hi
    exact ClosedEquationalLawWitness.ofSiteEquationSystem_valid
      W siteRaw Y hcontext i
  selected_closed := fun _ i _ => Set.mem_univ i
  selected_basicOpen := fun _ _ i =>
    iff_of_true (Set.mem_univ i) (Set.mem_univ i)

/-- Every required site equation is closed and selected by the standard generated reading. -/
theorem ClosedEquationalLawReading.ofSiteEquationSystem_requiredClosed
    (W : S.category)
    (siteRaw :
      RawAmbientRestrictionSystem S (S.equationSystem.Observable W))
    [HasSheafify S.topology
    ...
    (Y : StandardArchitectureScheme siteRaw)
    (hcontext : Y.decoration.context = W) :
    RequiredClosed siteRaw Y
      (ClosedEquationalLawReading.ofSiteEquationSystem
        W siteRaw Y hcontext) where
  closed := fun i _ => Set.mem_univ i
  selected := fun _ i _ => Set.mem_univ i

/-- Every site equation is selected by the standard generated reading. -/
theorem ClosedEquationalLawReading.ofSiteEquationSystem_allLawsSelected
    (W : S.category)
    (siteRaw :
      RawAmbientRestrictionSystem S (S.equationSystem.Observable W))
    [HasSheafify S.topology
...
/--
On an affine scheme, vanishing of a family of global equations is equivalent
to vanishing of the Mathlib ideal sheaf generated by their span.
-/
theorem globalEquationsVanishAlong_iff_ofIdealTop_span_comap_eq_bot
    [IsAffine X.underlying]
    (equation : U.Atom → Γ(X.underlying, ⊤))
...
/--
The required equation witness ideal sheaf generated by the equation system
owned by the ambient AAT site.
-/
noncomputable def siteEquationWitnessIdealSheaf
    (W : S.category)
    (siteRaw :
      RawAmbientRestrictionSystem S (S.equationSystem.Observable W))
    [HasSheafify S.topology
    ...
    Y.underlying.IdealSheafData :=
  lawWitnessIdealSheaf siteRaw Y
    (ClosedEquationalLawReading.ofSiteEquationSystem
      W siteRaw Y hcontext)
    (ClosedEquationalLawReading.ofSiteEquationSystem_valid
      W siteRaw Y hcontext).witness_compatible
    i.1
    ((ClosedEquationalLawReading.ofSiteEquationSystem_requiredClosed
      W siteRaw Y hcontext).closed i.1 i.2)

/--
The standard scheme witness ideal sheaf is the image of the equation
system's generated witness ideal; no separate coordinate family is used.
-/
theorem siteEquationWitnessIdealSheaf_eq_ofIdealTop_map
    (W : S.category)
    (siteRaw :
      RawAmbientRestrictionSystem S (S.equationSystem.Observable W))
    [HasSheafify S.topology
    ...
    (hcontext : Y.decoration.context = W)
    (i : S.equationSystem.RequiredIndex) :
    siteEquationWitnessIdealSheaf W siteRaw Y hcontext i =
      Scheme.IdealSheafData.ofIdealTop
        (X := Y.underlying)
        (Ideal.map
          (Y.decoration.siteEquationGlobalSectionMap W siteRaw hcontext)
          (S.equationSystem.witnessIdeal W i.1)) := by
  rw [siteEquationWitnessIdealSheaf,
    lawWitnessIdealSheaf_ofGlobalSections siteRaw Y
      (ClosedEquationalLawReading.ofSiteEquationSystem
        W siteRaw Y hcontext)
      (ClosedEquationalLawReading.ofSiteEquationSystem_valid
        W siteRaw Y hcontext).witness_compatible
      ...
      ((ClosedEquationalLawReading.ofSiteEquationSystem_requiredClosed
        W siteRaw Y hcontext).closed i.1 i.2)
      (siteEquationGlobalEquation W siteRaw Y hcontext i.1)]
  · congr 1
    rw [S.equationSystem.witnessIdeal_eq_span, Ideal.map_span]
    congr 1
    ext x
    constructor
    · rintro ⟨a, rfl⟩
      exact ⟨S.equationSystem.violationCoordinate W i.1 a,
        ⟨a, rfl⟩, rfl⟩
    · rintro ⟨_, ⟨a, rfl⟩, rfl⟩
      exact ⟨a, rfl⟩
  · exact ClosedEquationalLawReading.ofSiteEquationSystem_witness
      W siteRaw Y hcontext i.1 _

/--
The required scheme ideal sheaf generated from the equation system owned by
the ambient AAT site.
-/
noncomputable def siteEquationGeneratedIdealSheaf
    (W : S.category)
    (siteRaw :
      RawAmbientRestrictionSystem S (S.equationSystem.Observable W))
    [HasSheafify S.topology
    ...
    (hcontext : Y.decoration.context = W) :
    Y.underlying.IdealSheafData :=
  lawGeneratedIdealSheaf siteRaw Y
    (ClosedEquationalLawReading.ofSiteEquationSystem
      W siteRaw Y hcontext)
    (ClosedEquationalLawReading.ofSiteEquationSystem_valid
      W siteRaw Y hcontext)
...
/--
The standard generated ideal sheaf is exactly the image of the equation
system's generated obstruction ideal.
-/
theorem siteEquationGeneratedIdealSheaf_eq_ofIdealTop_map_obstructionIdeal
    (W : S.category)
    (siteRaw :
      RawAmbientRestrictionSystem S (S.equationSystem.Observable W))
    [HasSheafify S.topology
    ...
    (Y : StandardArchitectureScheme siteRaw)
    (hcontext : Y.decoration.context = W) :
    siteEquationGeneratedIdealSheaf W siteRaw Y hcontext =
      Scheme.IdealSheafData.ofIdealTop
        (X := Y.underlying)
        (Ideal.map
          (Y.decoration.siteEquationGlobalSectionMap W siteRaw hcontext)
          (S.equationSystem.obstructionIdeal W)) := by
  rw [siteEquationGeneratedIdealSheaf,
    lawGeneratedIdealSheaf_eq_iSup_required siteRaw Y
      (ClosedEquationalLawReading.ofSiteEquationSystem
        W siteRaw Y hcontext)
      (ClosedEquationalLawReading.ofSiteEquationSystem_valid
        W siteRaw Y hcontext)
  ...
  congr 1
  funext i
  exact siteEquationWitnessIdealSheaf_eq_ofIdealTop_map
    W siteRaw Y hcontext i
...
/--
The closed subscheme cut out by the required equations generated by the
ambient AAT site's equation system.
-/
noncomputable def siteEquationLawfulClosedSubscheme
    (W : S.category)
    (siteRaw :
      RawAmbientRestrictionSystem S (S.equationSystem.Observable W))
    [HasSheafify S.topology
  ...
  (siteEquationGeneratedIdealSheaf W siteRaw Y hcontext).subscheme

/-- The canonical closed immersion of the site-equation lawful subscheme. -/
noncomputable def siteEquationLawfulClosedImmersion
    (W : S.category)
    (siteRaw :
      RawAmbientRestrictionSystem S (S.equationSystem.Observable W))
    [HasSheafify S.topology
    ...
    (Y : StandardArchitectureScheme siteRaw)
    (hcontext : Y.decoration.context = W) :
    siteEquationLawfulClosedSubscheme W siteRaw Y hcontext ⟶ Y.underlying :=
  (siteEquationGeneratedIdealSheaf W siteRaw Y hcontext).subschemeι

/--
The site-equation lawful subscheme is the required-law subscheme for the
standard generated reading.
-/
theorem siteEquationLawfulClosedSubscheme_eq_lawfulClosedSubscheme
    (W : S.category)
    (siteRaw :
      RawAmbientRestrictionSystem S (S.equationSystem.Observable W))
    [HasSheafify S.topology
    ...
    siteEquationLawfulClosedSubscheme W siteRaw Y hcontext =
      lawfulClosedSubscheme siteRaw Y
        (ClosedEquationalLawReading.ofSiteEquationSystem
          W siteRaw Y hcontext)
        (ClosedEquationalLawReading.ofSiteEquationSystem_valid
          W siteRaw Y hcontext)
...
/--
The site-equation lawful subscheme is cut out by the image of the generated
obstruction ideal.
-/
theorem siteEquationLawfulClosedSubscheme_eq_obstructionIdealSubscheme
    (W : S.category)
    (siteRaw :
      RawAmbientRestrictionSystem S (S.equationSystem.Observable W))
    [HasSheafify S.topology
    ...
    siteEquationLawfulClosedSubscheme W siteRaw Y hcontext =
      (Scheme.IdealSheafData.ofIdealTop
        ...
        (Ideal.map
          (Y.decoration.siteEquationGlobalSectionMap W siteRaw hcontext)
          (S.equationSystem.obstructionIdeal W))).subscheme := by
  rw [siteEquationLawfulClosedSubscheme,
    siteEquationGeneratedIdealSheaf_eq_ofIdealTop_map_obstructionIdeal]

/-- The site-equation lawful subscheme map is a closed immersion. -/
theorem siteEquationLawfulClosedImmersion_isClosedImmersion
    (W : S.category)
    (siteRaw :
      RawAmbientRestrictionSystem S (S.equationSystem.Observable W))
    [HasSheafify S.topology
    ...
    (hcontext : Y.decoration.context = W) :
    IsClosedImmersion
      (siteEquationLawfulClosedImmersion W siteRaw Y hcontext) := by
...
theorem siteEquationLawfulClosedImmersion_ker
    ...
    (Y : StandardArchitectureScheme siteRaw)
    (hcontext : Y.decoration.context = W) :
    (siteEquationLawfulClosedImmersion W siteRaw Y hcontext).ker =
      siteEquationGeneratedIdealSheaf W siteRaw Y hcontext :=
...
/--
For an affine standard scheme, the site-generated semantic equation predicate
is exactly vanishing of its generated witness ideal sheaf.
-/
theorem ClosedEquationalLawReading.ofSiteEquationSystem_requiredLawIdealExact
    (W : S.category)
    (siteRaw :
      RawAmbientRestrictionSystem S (S.equationSystem.Observable W))
    [HasSheafify S.topology
    ...
    (Y : StandardArchitectureScheme siteRaw)
    (hcontext : Y.decoration.context = W)
    [IsAffine Y.underlying] :
    RequiredLawIdealExact siteRaw Y
      (ClosedEquationalLawReading.ofSiteEquationSystem
        W siteRaw Y hcontext)
      (ClosedEquationalLawReading.ofSiteEquationSystem_valid
        W siteRaw Y hcontext)
      (ClosedEquationalLawReading.ofSiteEquationSystem_requiredClosed
        W siteRaw Y hcontext) := by
  intro i hi T s
  change
    GlobalEquationsVanishAlong siteRaw Y
        (siteEquationGlobalEquation W siteRaw Y hcontext i) s ↔
      (lawWitnessIdealSheaf siteRaw Y
        ...
        i
        ((ClosedEquationalLawReading.ofSiteEquationSystem_requiredClosed
          W siteRaw Y hcontext).closed i hi)).comap s = ⊥
  rw [lawWitnessIdealSheaf_ofGlobalSections siteRaw Y
    (ClosedEquationalLawReading.ofSiteEquationSystem
      W siteRaw Y hcontext)
    (ClosedEquationalLawReading.ofSiteEquationSystem_valid
      W siteRaw Y hcontext).witness_compatible
