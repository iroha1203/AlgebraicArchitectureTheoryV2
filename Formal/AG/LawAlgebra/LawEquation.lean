...
/-- Restriction evaluator generated by quotient vanishing. -/
def GeneratedRestrictionEvaluator (D : LawEquationDefectSource G) : Prop :=
...
/-- III.定理11.4: displayed law fulfillment constructs the generated evaluator. -/
theorem displayedRequiredLawsHoldOn_constructs_restrictionEvaluator
    (D : LawEquationDefectSource G)
    (hholds : D.DisplayedRequiredLawsHoldOn) :
