...
/-! ### End-to-end ringed AAT site generation -/

/--
SD5: generate the ringed presentation on the site selected from a generated
AAT core and the actual raw ambient restriction system on that same site.
-/
...
/-- The generated ringed presentation stays on the selected generated site. -/
@[simp]
theorem generateRingedAATSite_site
    {U : AtomCarrier.{u}}
...
/-- The generated raw presheaf is the actual quotient restriction functor. -/
@[simp]
theorem generateRingedAATSite_raw
    {U : AtomCarrier.{u}}
    (S : AtomAxiomSystem U) (coreReading : CoreReading U)
    (reading : Site.SelectedGeometryReading
      (AATCorePackage.generate S coreReading))
...
/-- The generated structure sheaf is Mathlib sheafification of the raw functor. -/
@[simp]
theorem generateRingedAATSite_structureSheaf
    {U : AtomCarrier.{u}}
    (S : AtomAxiomSystem U) (coreReading : CoreReading U)
    (reading : Site.SelectedGeometryReading
      (AATCorePackage.generate S coreReading))
...
/-- The generated canonical map is Mathlib's sheafification unit. -/
@[simp]
theorem generateRingedAATSite_canonical
    {U : AtomCarrier.{u}}
    (S : AtomAxiomSystem U) (coreReading : CoreReading U)
    (reading : Site.SelectedGeometryReading
      (AATCorePackage.generate S coreReading))
...
/-- The generated architecture object is the object generated by the same core input. -/
@[simp]
theorem generateRingedAATSite_architectureObject
    {U : AtomCarrier.{u}}
    (S : AtomAxiomSystem U) (coreReading : CoreReading U)
    (reading : Site.SelectedGeometryReading
      (AATCorePackage.generate S coreReading))
