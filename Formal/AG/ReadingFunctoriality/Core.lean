...
abbrev lawUniverse (p : ReadingCore.{u, v} U) : LawUniverse U :=
  p.site.equationSystem.toLegacyLawUniverse
...
structure ObjectAlgebraHom
  ...
  lawMap :
    K.equationReading.toLegacyLawReading.lawUniverse.Index →
      L.equationReading.toLegacyLawReading.lawUniverse.Index
  /-- Preservation and reflection of required-law status. -/
  required_iff :
    ∀ i,
      K.equationReading.toLegacyLawReading.lawUniverse.Required i ↔
        L.equationReading.toLegacyLawReading.lawUniverse.Required (lawMap i)
  /-- Preservation and reflection of law satisfaction. -/
  law_holds_iff :
    ∀ i A,
      (K.equationReading.toLegacyLawReading.lawUniverse.law i).holds (K.object A) ↔
        (L.equationReading.toLegacyLawReading.lawUniverse.law (lawMap i)).holds
          (L.object (objMap A))
...
structure SignedExactCoreReadingHom
  ...
  lawMap :
    P.algebra.equationReading.toLegacyLawReading.lawUniverse.Index →
      Q.algebra.equationReading.toLegacyLawReading.lawUniverse.Index
  /-- Preservation and reflection of required-law status. -/
  required_iff :
    ∀ i,
      P.algebra.equationReading.toLegacyLawReading.lawUniverse.Required i ↔
        Q.algebra.equationReading.toLegacyLawReading.lawUniverse.Required (lawMap i)
  /-- Preservation and reflection of law satisfaction on mapped objects. -/
  law_holds_iff :
    ∀ i A,
      (P.algebra.equationReading.toLegacyLawReading.lawUniverse.law i).holds A ↔
        (Q.algebra.equationReading.toLegacyLawReading.lawUniverse.law (lawMap i)).holds
          (objectMap A)
  ...
  accepts_iff :
    ∀ i Qry,
      P.algebra.equationReading.toLegacyLawReading.circuits.accepts i Qry = true ↔
        Q.algebra.equationReading.toLegacyLawReading.circuits.accepts
...
def PositiveCircuitDatum
    (P : AATCorePackage U)
    (A : P.algebra.Obj)
    (i : P.algebra.equationReading.toLegacyLawReading.lawUniverse.Index) : Type u :=
...
def mapPositiveCircuit
    ...
    (f : PositiveCoreReadingHom P Q)
    {A : P.algebra.Obj}
    {i : P.algebra.equationReading.toLegacyLawReading.lawUniverse.Index}
