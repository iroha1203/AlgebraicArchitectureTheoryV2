...
structure KuranishiLocalModelStatement {U : AtomCarrier.{u}} {A : ArchitectureObject U}
    ...
    (K : KuranishiData.{u, v, y, z} D) : Prop where
  lawful_eq_zeroLocus :
...
variable {K : KuranishiData.{u, v, y, z} D}
...
theorem nonzero_not_lawful_lift
    (M : KuranishiLocalModelStatement.{u, v, y, z} K)
...
theorem singular_holds
    (G : GodObject.{u, v, y, z} D LawCoordinateAlgebra P_law) :
    USingular D :=
  G.singular
