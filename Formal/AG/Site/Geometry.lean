...
/-- II.定義8.1: one-way natural-language law display generated by the site equations. -/
def lawUniverse {U : AtomCarrier.{u}} {A : ArchitectureObject U}
    (S : AATSite A) : LawUniverse U :=
...
/-- The selected site's legacy law display is generated from the core equations. -/
@[simp]
theorem toAATSite_lawUniverse {U : AtomCarrier.{u}}
    {core : AATCorePackage U} (reading : SelectedGeometryReading core) :
    reading.toAATSite.lawUniverse = core.equationSystem.toLegacyLawUniverse :=
  rfl
