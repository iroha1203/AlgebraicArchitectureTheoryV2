...
/tooling/
  Tooling overview / bridge page。
  AAT / SFT / ArchSig の関係と、tool output を Lean theorem と読まない境界を短く説明する。
  詳細な manual / reference は `/archsig/` に置く。
...
### Tooling / Outreach / Profile

Tooling bridge 以降は hub page として扱う。
