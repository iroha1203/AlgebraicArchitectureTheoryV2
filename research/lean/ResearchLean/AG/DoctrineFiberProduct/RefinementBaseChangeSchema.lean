...
structure RefinementBCRegime (C : RefinementBCConfiguration U) where
  ...
  /--
  Naturality of the exact-square route before universal factorization.  The
  mate component and its naturality are generated below by the pulled
  cartesian universal property; neither is regime input.
  -/
  mateRoute_natural : ∀ {source target : CoreFiber C.DOne}
    (vertical : source ⟶ target),
