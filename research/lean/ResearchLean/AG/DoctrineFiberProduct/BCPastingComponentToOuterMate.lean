...
component mates agree with the canonical mate generated from normalized outer
presentation provenance after the named source and target alignments.
...
The vertical normal form has deeply nested functor and mate endpoints, so this
module raises `maxRecDepth` for elaboration of those generated types.  The
public characterization lemmas below keep downstream proofs independent of
the chosen definitional expansion.
-/
...
/-- Public characterization of the generated horizontal target alignment. -/
theorem horizontalOuterMateTargetAlignment_eq
    {U : AtomCarrier.{u}} [DecidableEq U.Atom]
    (data : HorizontalBCPastingData U) :
    horizontalOuterMateTargetAlignment data =
      Functor.whiskerRight
        ...
        (selectedCoreFiberReindexFunctor
          (bcPastingNormalizedProvenance
            (.horizontal data)).rightProvenance.toRealizableHom) := rfl
...
/-- Public characterization of the direction-qualified top compositor. -/
theorem horizontalDataNormalizedTopCompositor_eq
    {U : AtomCarrier.{u}} [DecidableEq U.Atom]
    (data : HorizontalBCPastingData U) :
    horizontalDataNormalizedTopCompositor data =
      horizontalBCPastingNormalizedTopCompositor data := rfl
...
/-- Public characterization of the direction-qualified northwest reindex
alignment. -/
theorem horizontalDataNormalizedNorthwestReindexAlignment_eq
    {U : AtomCarrier.{u}} [DecidableEq U.Atom]
    (data : HorizontalBCPastingData U) :
    horizontalDataNormalizedNorthwestReindexAlignment data =
      ((mateEquiv
        ...
        (TwoSquare.mk _ _ _ _
          ...
          (selectedCoreFiberReindexFunctor
            (typedRealizableHom
              (bcLeftPresentation data.leftPresentation))).leftUnitor.hom := rfl
...
/-- Public characterization of the generated horizontal source alignment. -/
theorem horizontalDataMateSourceAlignment_eq
    {U : AtomCarrier.{u}} [DecidableEq U.Atom]
    (data : HorizontalBCPastingData U) :
        ...
        Functor.whiskerLeft
          ...
          (coreFiberCompositor
            (typedPresentationToSemantic
              (bcTopPresentation data.leftPresentation))
            (typedPresentationToSemantic
              (bcTopPresentation data.rightPresentation))).hom := rfl
...
/-- Public constructor equation for the direction-qualified horizontal typed
outer normal form. -/
theorem horizontalDataTypedOuterComparisonNormalForm_eq_whiskered
    {U : AtomCarrier.{u}} [DecidableEq U.Atom]
    (data : HorizontalBCPastingData U) :
    horizontalDataTypedOuterComparisonNormalForm data =
      ((horizontalDataTypedRawComparisonSquare data).whiskerTop
        (horizontalOuterTopToTypedComponents data)).whiskerBottom
          (horizontalTypedComponentsToOuterBottom data) := rfl
...
/-- The aligned horizontal composite mate equals the canonical mate generated
from normalized outer presentation provenance. -/
theorem horizontalComponentMate_eq_outerCanonicalMate
  ...
  rw [horizontalDataTypedOuterComparisonNormalForm_eq_whiskered]
  ...
  rw [horizontalOuterMateTargetAlignment_eq]
  apply NatTrans.ext
  funext X
  rw [horizontalDataMateSourceAlignment_eq]
  rw [horizontalDataNormalizedTopCompositor_eq]
  rw [horizontalDataNormalizedNorthwestReindexAlignment_eq]
...
/-- G-110(E) horizontal acceptance theorem with the literal vertical
composition of the two generated component mates on the left.  It consumes
the predecessor mate-composition law and the generated component-to-outer
alignment equation; no mate or coherence equality is an input. -/
theorem horizontalLiteralComponentMates_eq_outerCanonicalMate
    {U : AtomCarrier.{u}} [DecidableEq U.Atom]
    (data : HorizontalBCPastingData U) :
    horizontalDataMateSourceAlignment data ≫
        ((TwoSquare.mk _ _ _ _
...
/-- Public characterization of the mate of the vertically composed component
squares. -/
theorem verticalComponentMateNatTrans_eq
    {U : AtomCarrier.{u}} [DecidableEq U.Atom]
    (data : VerticalBCPastingData U) :
    verticalComponentMateNatTrans data =
      (mateEquiv
        ...
        ((TwoSquare.mk _ _ _ _
          (bcCoreTransportSquareIso data.upperPresentation).hom) ≫ᵥ
        (TwoSquare.mk _ _ _ _
          (bcCoreTransportSquareIso data.lowerPresentation).hom))).natTrans := rfl
...
/-- Public constructor equation for the decomposed vertical outer mate. -/
theorem verticalDecomposedOuterMateNatTrans_eq
    {U : AtomCarrier.{u}} [DecidableEq U.Atom]
    (data : VerticalBCPastingData U) :
      ...
      Functor.whiskerLeft
        ...
        ((((mateEquiv
          ...
          Functor.whiskerRight
            ...
            (selectedCoreFiberReindexFunctor
              (bcPastingNormalizedProvenance
                (.vertical data)).rightProvenance.toRealizableHom)) := rfl
...
/-- The aligned vertical composite mate equals the canonical mate generated
from normalized outer presentation provenance. -/
...
/-- G-110(E) vertical acceptance theorem with the literal horizontal
composition of the two generated component mates on the left.  It consumes
the predecessor mate-composition law, the public characterization of the
composed-square mate, and the generated component-to-outer alignment equation. -/
theorem verticalLiteralComponentMates_eq_outerCanonicalMate
    {U : AtomCarrier.{u}} [DecidableEq U.Atom]
    (data : VerticalBCPastingData U) :
    verticalMateSourceAlignment data ≫
        ((TwoSquare.mk _ _ _ _
      ...
      bcProvenanceCanonicalMate
        ...
        verticalMateTargetAlignment data := by
  rw [← congrArg TwoSquare.natTrans
    (verticalBCPasting_coreBeckChevalleyMate_hcomp data)]
  rw [← verticalComponentMateNatTrans_eq]
  exact verticalComponentMate_eq_outerCanonicalMate data
