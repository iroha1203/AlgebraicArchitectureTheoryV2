...
import ResearchLean.AG.DoctrineFiberProduct.DiagnosticConservativitySchemaWitnesses
...
import ResearchLean.AG.DoctrineFiberProduct.IndexedRawFamilyClassification
...
import ResearchLean.AG.DoctrineFiberProduct.BCPastingCoherenceWhiskeringWitnesses
import ResearchLean.AG.DoctrineFiberProduct.BCPastingCoherenceWhiskeredIso
import ResearchLean.AG.DoctrineFiberProduct.BCPastingCoherenceWhiskeredIsoWitnesses
import ResearchLean.AG.DoctrineFiberProduct.BCPastingCoherenceAssociator
import ResearchLean.AG.DoctrineFiberProduct.BCPastingCoherenceAssociatorWitnesses
import ResearchLean.AG.DoctrineFiberProduct.BCPastingCoherenceRoutes
import ResearchLean.AG.DoctrineFiberProduct.BCPastingCoherenceRoutesWitnesses
...
import ResearchLean.AG.DoctrineFiberProduct.BCDiagnosticAxisFoldWitnesses
...
import ResearchLean.AG.DoctrineFiberProduct.LaxDiagnosticProjectorPropagation
...
import ResearchLean.AG.DoctrineFiberProduct.IdempotentExchangeUniversalTargets
...
import ResearchLean.AG.DoctrineFiberProduct.ExactBottomCoverageClosure
...
import ResearchLean.AG.DoctrineFiberProduct.BCDiagnosticBaseChangeAutomorphismWitnesses
import ResearchLean.AG.DoctrineFiberProduct.BCDiagnosticFiberwiseTransport
import ResearchLean.AG.DoctrineFiberProduct.BCDiagnosticFiberwiseTransportWitnesses
import ResearchLean.AG.DoctrineFiberProduct.BCDiagnosticTotalTransport
import ResearchLean.AG.DoctrineFiberProduct.BCDiagnosticTotalTransportWitnesses
...
import ResearchLean.AG.DoctrineFiberProduct.TargetTheorem
...
import ResearchLean.AG.DoctrineFiberProduct.UpperGeometryFiniteComparatorNaturality
...
import ResearchLean.AG.DoctrineFiberProduct.UpperGeometryExchangeExactness
...
import ResearchLean.AG.DoctrineFiberProduct.UpperGeometryRealizationExactnessSwapWitnesses
...
the next layer now constructs the pullback reindexing functor generated by the
selected cartesian regime.  Its object action internally chooses the regime's
strong cartesian lift, while every vertical map is the unique factor through
the lift at its codomain; the factor graph, uniqueness, identity law, and
...
package-projection exactness layer now applies the explicit two-sided upper
inverse generated by the G-110 arbitrary-target `inverseCorePackageHom`
construction, then uses the generated universal properties to make the
selected transport unit strongly cartesian and counit strongly
