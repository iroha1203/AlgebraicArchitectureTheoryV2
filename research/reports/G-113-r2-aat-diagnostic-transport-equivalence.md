...
selection:
  ...
  anti_weakening: >-
    ...
    primitive source map identifies two named distinct cells. The source
    automorphism is generated by applying the already proved inverse fiber
    equivalence to a concrete visible target swap, not accepted from a caller.
result:
  proposed_result_type: proof-obligation-discharged
  ...
  evidence:
    ...
    - finiteNonIsoDiagnostic_initialRawDefect_ne_one
    ...
    - FiniteNonIsoDiagnosticNondegeneracy
    - finiteNonIsoDiagnosticNondegeneracy
  claim_mapping:
    i1:
    ...
    i2:
      ...
      nonidentity_defect: >-
        source initial raw defect and its transported raw defect at the named
        face are both nonidentity
      nonidentity_reselection: >-
        source right-edge swap reselection and its transported image are both
        nonidentity
      round_trips: >-
...
audits:
  material_premise_provenance:
    ...
    base_nonidentity: >-
      ...
      finiteSelectiveTwoToSupport_sourceMap_eq
    source_swap: >-
      inverse.mapIso of finiteNonIsoDiagnosticTargetSwap, whose target axis
      action visibly moves zero to one
    defect: >-
      identity boundary lifts make the initial canonical comparator identity,
      so the authored pulled-back swap is exactly the initial raw defect
    transported_defect: >-
  ...
  validation_refs:
    ...
    - "44 declarations under namespace / #assert_standard_axioms_only / pass"
    ...
    - "28 public declarations / individual #print axioms / propext, Classical.choice, Quot.sound only"
  blocking_findings: []
  next_obligation: >-
