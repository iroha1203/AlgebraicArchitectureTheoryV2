...
selection:
  ...
  anti_weakening: >-
    ...
    from the pre-existing visible axis swap, independently of the G-113
    diagnostic equivalence and without a caller-supplied nonidentity premise.
result:
  proposed_result_type: proof-obligation-discharged
...
audits:
  material_premise_provenance:
    ...
    base_nonidentity: >-
      ...
      finiteSelectiveTwoToSupport_sourceMap_eq
    source_swap: >-
      selectedCoreFiberReindexFunctor.mapIso on the pre-existing G-110
      finiteNonIsoDiagnosticTargetSwap; nonidentity follows from the actual
      reindexing factor graph and the selected lift's generated strong
