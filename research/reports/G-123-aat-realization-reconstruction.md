...
result:
  ...
  evidence:
    ...
    - AAT.AG.RealizationReconstruction.PrimitiveRawRestriction.g122MapsJStruct
    - AAT.AG.RealizationReconstruction.closedTaggedPrimitiveReferenceEquiv
  claim_mapping:
    input_premises:
    ...
    proof_use:
      ...
      - "g122MapsJStruct applies the recovered value's maps_JStruct field to arbitrary p and membership proof"
