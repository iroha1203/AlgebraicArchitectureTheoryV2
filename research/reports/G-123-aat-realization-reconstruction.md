...
result:
  ...
  claim_mapping:
    ...
    unfinished:
      ...
      - "Classical.choose fixes the target Atom value but not a unique target Fin index; duplicate occurrences obstruct strict raw-index identity/composition until a canonical-occurrence construction or value-level quotient is supplied"
...
audits:
  premise_delta:
    ...
    remaining:
      - "resolve duplicate-occurrence choice dependence before stating strict identity/composition for raw finite actions"
