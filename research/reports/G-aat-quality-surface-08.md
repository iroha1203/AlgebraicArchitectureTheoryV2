...
- latest reviewed cycle: 17
- completion candidate: no
- tracking Issue: #3282
- current phase: Phase 2 — Response-Kernel Descent
- next obligation: D0 construct `R = image(s_t)`, the short exact image
  sequence `0 -> K -> K_P -> R -> 0`, and the distinguished image section
  generated by selected local repairs
