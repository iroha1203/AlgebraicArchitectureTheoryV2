...
`BooleanCircleOperationResponsePrototype.lean` equips the existing square-zero
Boolean-circle law core with the concrete derivation
...
existing square-zero law witness is the constant dual-factor element
