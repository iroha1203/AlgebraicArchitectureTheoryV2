...
result:
  ...
  theorem_map:
    change_and_reconstruction:
      ...
      - UpperGeometryCompatibleSourcePresentationChange.changedEdgeLift_base
      ...
      - UpperGeometryCompatibleSourcePresentationChange.changedEdgeLift_coefficient_id
      - UpperGeometryCompatibleSourcePresentationChange.changedComparator
      - UpperGeometryCompatibleSourcePresentationChange.changedComparator_coefficient_id
    ...
    base_endpoint:
      - UpperGeometryCompatibleSourcePresentationChange.generatedBaseRouteExactCoreIsoAt
      ...
      - UpperGeometryCompatibleSourcePresentationChange.generatedBaseRouteRefinementGeometryIsoAt_hom_base
      - UpperGeometryCompatibleSourcePresentationChange.generatedBaseRouteRefinementGeometryIsoAt_inv_base
      - UpperGeometryCompatibleSourcePresentationChange.generatedBaseRouteExactGeometryHomAt
      - UpperGeometryCompatibleSourcePresentationChange.generatedBaseRouteExactGeometryInvAt
      - UpperGeometryCompatibleSourcePresentationChange.generatedBaseRouteExactGeometryHomAt_toRefinement
      - UpperGeometryCompatibleSourcePresentationChange.generatedBaseRouteExactGeometryInvAt_toRefinement
      - UpperGeometryCompatibleSourcePresentationChange.generatedBaseRouteExactGeometryIsoAt
    pulled_endpoint:
      - UpperGeometryCompatibleSourcePresentationChange.generatedPulledRouteExactCoreIsoAt
      ...
      - UpperGeometryCompatibleSourcePresentationChange.generatedPulledRouteRefinementGeometryIsoAt_hom_base
      - UpperGeometryCompatibleSourcePresentationChange.generatedPulledRouteRefinementGeometryIsoAt_inv_base
      - UpperGeometryCompatibleSourcePresentationChange.generatedPulledRouteExactGeometryHomAt
      - UpperGeometryCompatibleSourcePresentationChange.generatedPulledRouteExactGeometryInvAt
      - UpperGeometryCompatibleSourcePresentationChange.generatedPulledRouteExactGeometryHomAt_toRefinement
      - UpperGeometryCompatibleSourcePresentationChange.generatedPulledRouteExactGeometryInvAt_toRefinement
...
result:
  ...
  theorem_map:
    ...
    - UpperGeometryCompatibleSourcePresentationChange.Chain.recursiveSourcePairMulEquivAt
    - UpperGeometryCompatibleSourcePresentationChange.Chain.recursiveEndpointPairMulEquivAt
    - UpperGeometryCompatibleSourcePresentationChange.Chain.recursiveSourcePairMulEquivAt_nil
    - UpperGeometryCompatibleSourcePresentationChange.Chain.recursiveSourcePairMulEquivAt_cons
    - UpperGeometryCompatibleSourcePresentationChange.Chain.recursiveEndpointPairMulEquivAt_nil
    - UpperGeometryCompatibleSourcePresentationChange.Chain.recursiveEndpointPairMulEquivAt_cons
  ...
  acceptance_point: "The selected source comparison and the independently generated base- and pulled-endpoint comparisons are recursively pasted in tail-then-head order along the dependent chain. Induction using the Cycle 20 identity/composition laws identifies the first with the comparison structurally assembled by the Cycle 21 composite and the latter two with the endpoint comparisons freshly generated from that composite. The corresponding pair conjugation equivalences also equal the typed recursive composition of every actual link action."
  port_status: not-applicable
audits:
  premise_delta:
    discharged:
      ...
      - "explicit identity and typed cons-composition laws for both pair actions"
    remaining:
  ...
  proof_use:
    used:
      ...
      - "per-link F2 source and endpoint pair actions in recursive MulEquiv.trans composition"
    unused:
