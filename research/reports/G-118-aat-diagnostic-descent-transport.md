...
selection:
  ...
  selection_reason: "An indexed two-display C1 chain calculus exposes exactly the selected canonical/generated target changes and makes ill-typed arbitrary-context C3 composition unrepresentable."
  expected_result_type: proof-obligation-discharged
  lean_targets:
...
result:
  proposed_result_type: proof-obligation-discharged
  proof_obligation_delta: "C1 has typed finite chains generated by the selected forward/backward canonical/generated change. Its raw-pair MulEquiv interpretation has explicit identity, append, reverse/inverse, Gamma iff, coefficient-observation commutation, and bijectivity laws. C2 pointwise products retain edgewise Gamma membership, both coefficient identities, and actual solution naturality on every finite path. C3 is the actual generated pair hom followed by a type-correct finite target C1 chain; target identity and append laws, Gamma preservation, exact J_i=bottom reflection, coefficient commutation, and unconditional surjectivity onto its generated range are proved. The source-side C1 precomposition requirement remained unproved at this cycle. The fixed positive/negative observation collision, opposite decisions, and universal nonfactorization are bundled after every finite target C1 chain."
  completion_candidate: no
  lean_artifacts:
    - research/lean/ResearchLean/AG/DoctrineFiberProduct/QualifiedComparisonTransportClosure.lean
    - research/lean/ResearchLean/AG/DoctrineFiberProduct.lean
...
audits:
  ...
  blocking_findings:
    - "PR #4381 standard review found that source-side type-matching C1 precomposition before C3 was represented only by identity"
  next_obligation: "Cycle 12 source diagonal C1 precomposition repair"
```

## Cycle 12 — source diagonal C1 precomposition repair
...
cycle: 12
goal_blob_sha: 641f3255062d2578ef070cbb77c019cc28c3febf
base_oid: 4f8ba8f8396ce3bbdd00c581941acee73967096b
tracking_issue: 4367
report_path: research/reports/G-118-aat-diagnostic-descent-transport.md
selection:
  proof_state_ref: "PR #4381 protocol-correct standard review: https://github.com/iroha1203/AlgebraicArchitectureTheoryV2/pull/4381#issuecomment-5551275942"
  proof_dag_predecessors:
    - "CompositeFiberAut.coefficientObservation and its kernel"
    - "the source identity-comparison characterization as diagonal equality"
    - "generatedComparisonPairHomAt and the reviewed target C1 finite-chain closure"
    - "UpperDecisionWitness authored source comparator coefficient identity and nonidentity"
  proof_obligation: "Represent every coefficient-trivial simultaneous source inner-conjugation C1 that type-matches the diagonal Gamma before C3; prove identity, multiplication, inverse, Gamma iff, coefficient observation, two-sided C3 composition, exact reflection, and generated-image status; supply a fixed nonidentity actual source change"
  selection_reason: "The source diagonal relation admits simultaneous inner conjugation by any coefficient-trivial actual source automorphism. This is a typed, input-native C1 class with a fixed nonidentity witness and does not accept a comparison equality or conclusion certificate."
  expected_result_type: proof-obligation-discharged
  lean_targets:
    - research/lean/ResearchLean/AG/DoctrineFiberProduct/QualifiedComparisonTransportClosure.lean
  risks:
    - "source changes must preserve both diagonal Gamma and the complete coefficient observation"
    - "the C3 reflection condition must remain exactly J_i=bottom after precomposition"
    - "source multiplication order must match MonoidHom composition"
    - "the repaired class must have an actual nonidentity fixed witness"
  unchecked:
...
result:
  ...
  claim_mapping:
    theorem_names:
      - UpperGeometryCompatibleProblemInputData.SourceDiagonalC1ChangeAt
      - UpperGeometryCompatibleProblemInputData.sourceDiagonalC1PairMulEquivAt
      - UpperGeometryCompatibleProblemInputData.sourceDiagonalC1PairMulEquivAt_one_apply
      - UpperGeometryCompatibleProblemInputData.sourceDiagonalC1PairMulEquivAt_mul_apply
      - UpperGeometryCompatibleProblemInputData.sourceDiagonalC1PairMulEquivAt_inv_apply
      - UpperGeometryCompatibleProblemInputData.sourceDiagonalC1PairMulEquivAt_mem_identity_iff
      - UpperGeometryCompatibleProblemInputData.sourceDiagonalC1PairMulEquivAt_coefficientObservation
      - UpperGeometryCompatibleProblemInputData.closedComparisonPairHomAtWithSourceC1
      - UpperGeometryCompatibleProblemInputData.closedComparisonPairHomAtWithSourceC1_one
      - UpperGeometryCompatibleProblemInputData.closedComparisonPairHomAtWithSourceC1_mul_apply
      - UpperGeometryCompatibleProblemInputData.closedComparisonPairHomAtWithSourceC1_append_apply
      - UpperGeometryCompatibleProblemInputData.closedComparisonPairHomAtWithSourceC1_preserves_qualifiedComparison
      - UpperGeometryCompatibleProblemInputData.closedComparisonPairHomAtWithSourceC1_reflects_qualifiedComparison_iff
      - UpperGeometryCompatibleProblemInputData.closedComparisonPairHomAtWithSourceC1_coefficientObservation
      - UpperGeometryCompatibleProblemInputData.closedComparisonPairHomAtWithSourceC1_rangeRestrict_surjective
      - UpperDecisionWitness.fixedAuthoredSourceDiagonalC1Change
      - UpperDecisionWitness.fixedAuthoredSourceDiagonalC1Change_ne_one
    source_labels:
      - "target theorem C3 before/after C1 closure at GOAL lines 190--194"
    conjuncts:
      - "source diagonal C1 identity, multiplication, inverse, Gamma iff, coefficient compatibility, and bijectivity through MulEquiv"
...
audits:
  ...
  material_premise_classification:
    ...
    direction_hypothesis:
      - "C2 closure operands first/second and source membership"
      - "sourceChange and targetChain as elements of the proved closure classes"
    discharge_required:
      - "all source C1 and two-sided C3 laws listed above"
  certificate_provenance:
    discharged:
