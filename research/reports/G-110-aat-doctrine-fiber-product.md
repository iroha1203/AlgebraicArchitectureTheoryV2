...
### Cycle 83 — diagnostic reselection composition law
...
selection:
  proof_state_ref: Issue 4034 comment 5391145019
  ...
  risks:
    - replacing the generated endpoint automorphism equality by a supplied compatibility field
    - adding wrapper theorems that merely apply existing one-functor covariance
    - promoting the generic d4 core to complete horizontal and vertical D compatibility
  unchecked:
    - specialization to the actual horizontal and vertical direct and via-base routes
    - transported diagnostic-data, coherence, and vanishing composition compatibility
    - C comparison compatibility and pullback-side composition coherence
result:
  proposed_result_type: target-proof-checkpoint
  proof_obligation_delta: mapEdgeReselection_comp proves pointwise equality between the one-stage composite reselection map and the two successive maps by comparing their actual endpoint PackageFiberAut values through packageFiberAutCoreFiberEquiv and the functorial action on automorphisms
  ...
  claim_mapping:
    theorem_names:
      - mapEdgeReselection_comp
    source_labels:
      - target theorem E compatibility of D mapped reselection with horizontal and vertical pasting
    conjuncts:
...
audits:
  premise_delta:
    discharged:
      - d4 canonical reselection composition for arbitrary composable core-fiber functors
    remaining:
  ...
  certificate_provenance:
    discharged:
      - both sides are generated by mapEdgeReselection and coreFiberFunctorPackageAutHom from the same source reselection
    unresolved: []
  proof_use:
    used:
      - coreFiberFunctorPackageAutHom_hom
