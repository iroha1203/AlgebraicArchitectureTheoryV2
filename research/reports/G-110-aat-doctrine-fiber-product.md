...
result:
  ...
  proof_obligation_delta: arbitrary target reselections now transport invertibly across natural isomorphisms; the horizontal and vertical outer/component mate equations generate split diagnostic squares with package, comparator, path, coherence and vanishing equivalences; both literal component routes are exposed as three successive map and mapped-reselection actions; the horizontal diagnostic path consumes the G-106/G-109 associativity bridge, while the vertical target alignment is identified with the generated selected-reindex compositor
  ...
  evidence:
    ...
    - horizontalPastedDiagnosticPath_via_g106
  ...
  claim_mapping:
    ...
    conjuncts:
      - both actual outer routes retain generated d2-d6 composition packages
      ...
      - the horizontal diagnostic path proof uses coreFiberCompositor_assoc_via_g106, whose proof consumes transportAlong_comp_coherence
...
audits:
  premise_delta:
    discharged:
      ...
      - horizontal transportAlong_comp_coherence proof-use through the actual diagnostic path
