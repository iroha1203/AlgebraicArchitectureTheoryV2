...
selection:
  ...
  proof_dag_predecessors:
    ...
    - "LocalSemanticReconstruction.FinitePrecomposition.extension and extensionOfInjective_apply"
...
audits:
  material_premises:
    ...
    discharge_required:
      ...
      - "computed extension readback / discharged by Cycle 11 extensionOfInjective_apply"
    conclusion_equivalent_risk: []
  proof_use:
    used:
      ...
      - "FinitePrecomposition.extension and extensionOfInjective_apply"
    unused: []
  structure_field_escape: none-found
  route_integrity: pass
  target_fitting: none-found
  validation_refs:
    ...
    - "#assert_standard_axioms_only AAT.AG.LocalSemanticReconstruction.FiniteCoherentExtension: 11 declarations, standard axioms only"
  blocking_findings: []
