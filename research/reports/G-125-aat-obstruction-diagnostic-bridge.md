...
report_path: research/reports/G-125-aat-obstruction-diagnostic-bridge.md
selection:
  proof_state_ref: "Issue #4791 paper design section 3 and Cycle 2 merge 5dbcd31fb683f4d18c7617c3790376e1f147b79a"
  proof_dag_predecessors:
...
result:
  proposed_result_type: proof-obligation-discharged
  proof_obligation_delta: "The least additive congruence generated by declared primitive generator pairs now defines M_R. Maps in both directions between M_R and the free abelian group on B are constructed and proved inverse, deriving M_R equivalent to Z^B without an equivalence certificate."
  completion_candidate: no
  lean_artifacts:
  ...
  evidence:
    - "presentationCongruence is addConGen of pairs consisting exactly of related basis generators"
  ...
  claim_mapping:
    ...
    source_labels:
      ...
      - "Issue #4791 paper design section 3"
    conjuncts:
