...
result:
  ...
  lean_artifacts: [RefinementGeometryHom, RefinementGeometryCategory, refinementGeometryCategory, refinementGeometryProjection, exactGeometryToRefinementGeometry, exact_refinementGeometry_projection_square]
...
result:
  ...
  completion_candidate: no
  lean_artifacts: [refinementPackageHomOfOver, ActiveRefinementBCContext.baseCompositeLeg, ActiveRefinementBCContext.pulledCompositeLeg, ActiveRefinementBCContext.refinementMateAtTarget, ActiveRefinementBCContext.baseCompositeLeg_base, ActiveRefinementBCContext.pulledCompositeLeg_base, ActiveRefinementBCContext.refinementMate_isHomLift, ActiveRefinementBCContext.refinementMate_upper_triangle]
...
result:
  ...
  completion_candidate: no
  lean_artifacts: [FixedCoefficientGeometryAt, ActiveRefinementBCContext.retarget, ActiveRefinementBCContext.baseCompositeLegAt, ActiveRefinementBCContext.pulledCompositeLegAt, ActiveRefinementBCGeometryLegData, ActiveRefinementBCGeometryLegData.baseLeg, ActiveRefinementBCGeometryLegData.pulledLeg, ActiveRefinementBCGeometryLegData.baseLeg_projection, ActiveRefinementBCGeometryLegData.pulledLeg_projection, ActiveRefinementBCGeometryLegData.baseLeg_lower_factor, ActiveRefinementBCGeometryLegData.pulledLeg_lower_factor, RefinementGeometryHom.exact_comp_eq]
...
result:
  ...
  completion_candidate: no
  lean_artifacts: [PresentedPathCategory, FixedCoefficientTwoLayerTransportOver, FixedCoefficientTwoLayerTransportOver.edge_projection, ActiveRefinementBCContext.baseCoreDiagram, ActiveRefinementBCContext.pulledCoreDiagram, UpperRefinementBCProblemData, UpperRefinementBCProblem, UpperRefinementBCProblemData.base_naturality_projection, UpperRefinementBCProblemData.pulled_naturality_projection, UpperRefinementBCProblemData.base_path_naturality, UpperRefinementBCProblemData.pulled_path_naturality]
...
result:
  ...
  completion_candidate: no
  lean_artifacts: [refinementPackageHomOfOver_precomp, refinementPackageHomOfOver_postcomp, ActiveRefinementBCContext.baseCompositeLegAt_naturality, ActiveRefinementBCContext.pulledCompositeLegAt_naturality, UpperRefinementBCSolution, UpperRefinementBCProblemData.base_naturality_factor_graph, UpperRefinementBCProblemData.pulled_naturality_factor_graph, UpperRefinementBCSolution.path_naturality, UpperRefinementBCSolution.append_naturality, UpperRefinementBCSolution.authored_twoCell_pasting]
...
result:
  ...
  completion_candidate: no
  lean_artifacts: [exactSourceGeometry, exactSourceGeometry_raw_forward, refinementSourceGeometry, refinementBaseHom, refinementSourceGeometry_raw_forward, exactSupportComp, exactAxisComp, exactObservableComp, exactSupportReads, exactAxisReads, exactObservableReads, rawReindexUpper_id, rawReindexUpper_comp, rawReindexUpper_cancel]
...
result:
  ...
  completion_candidate: no
  lean_artifacts: [exactSourceCoefficientBackwardHom, refinementSourceCoefficientBackwardHom, refinementSourceBackwardUpper, rawReindexUpper_baseChange, generatedExactSupportComp_heq, generatedRefinementSupportComp_heq, generatedExactAxisComp_heq, generatedRefinementAxisComp_heq, generatedExactObservableComp_heq, generatedRefinementObservableComp_heq, pulledRouteBackwardSupportComp_heq, pulledRouteBackwardAxisComp_heq, pulledRouteBackwardObservableComp_heq, upperGeometryMate, upperGeometryMate_raw_eq, upperGeometryMate_fac, upperGeometryMateExplicitBase_eq, upperGeometryMateOverlap, upperGeometryMateCoefficient_fac]
...
result:
  ...
  completion_candidate: no
  lean_artifacts: [generatedBaseRouteFixedGeometryAt, generatedPulledRouteFixedGeometryAt, generatedBaseRouteFixedGeometryAt_package, generatedPulledRouteFixedGeometryAt_package, generatedBaseRouteLegAt_coefficient_id, generatedPulledRouteLegAt_coefficient_id, generatedBaseRouteFixedGeometryEdge, generatedPulledRouteFixedGeometryEdge, generatedBaseRouteFixedGeometryEdge_coefficient_id, generatedPulledRouteFixedGeometryEdge_coefficient_id, generatedBaseRouteFixedComparator, generatedPulledRouteFixedComparator, generatedBaseRouteFixedComparator_coefficient_id, generatedPulledRouteFixedComparator_coefficient_id, generatedBaseRouteLiftData, generatedPulledRouteLiftData, generatedBaseRoutePathLift_base, generatedPulledRoutePathLift_base, generatedBaseRouteTwoCellBase, generatedPulledRouteTwoCellBase, generatedBaseRouteTransport, generatedPulledRouteTransport]
...
result:
  ...
  completion_candidate: no
  lean_artifacts: [ExactUpperEquivalence, UpperRealizationTransportSupply, upperRealizationTransportSupplyEquiv, RealizationExactUpperEquivalence, RealizationExactUpperEquivalence.refl, RealizationExactUpperEquivalence.symm, RealizationExactUpperEquivalence.homTotalSupply, RealizationExactUpperEquivalence.invTotalSupply, RealizationExactUpperEquivalence.homHGeom, RealizationExactUpperEquivalence.invHGeom, negativeUpperUnitObject, negativeUpperBoolObject, negativeUpperUnitObject_ne_boolObject, negativeCoreUpper_objectMap_not_injective, no_negativeExactUpperEquivalence]
  source_sha256:
...
result:
  ...
  completion_candidate: no
  lean_artifacts: [canonicalAuthoredBaseToGeneratedRouteGeometryIsoAt_hom_base, canonicalAuthoredBaseToGeneratedRouteGeometryIsoAt_inv_base, canonicalAuthoredBaseToGeneratedRouteGeometryIsoAt_hom_inv, canonicalAuthoredBaseToGeneratedRouteGeometryIsoAt_inv_hom, canonicalAuthoredBaseToGeneratedRouteGeometryIsoAt_hom_coefficient_id, canonicalAuthoredBaseToGeneratedRouteGeometryIsoAt_inv_coefficient_id, canonicalAuthoredBaseToGeneratedRouteGeometryIsoAt_support_hom_inv, canonicalAuthoredBaseToGeneratedRouteGeometryIsoAt_support_inv_hom, canonicalAuthoredBaseToGeneratedRouteGeometryIsoAt_axis_hom_inv, canonicalAuthoredBaseToGeneratedRouteGeometryIsoAt_axis_inv_hom, canonicalAuthoredBaseToGeneratedRouteGeometryIsoAt_observable_hom_inv, canonicalAuthoredBaseToGeneratedRouteGeometryIsoAt_observable_inv_hom, canonicalAuthoredPulledToGeneratedRouteGeometryIsoAt_hom_base, canonicalAuthoredPulledToGeneratedRouteGeometryIsoAt_inv_base, canonicalAuthoredPulledToGeneratedRouteGeometryIsoAt_hom_inv, canonicalAuthoredPulledToGeneratedRouteGeometryIsoAt_inv_hom, canonicalAuthoredPulledToGeneratedRouteGeometryIsoAt_hom_coefficient_id, canonicalAuthoredPulledToGeneratedRouteGeometryIsoAt_inv_coefficient_id, canonicalAuthoredPulledToGeneratedRouteGeometryIsoAt_support_hom_inv, canonicalAuthoredPulledToGeneratedRouteGeometryIsoAt_support_inv_hom, canonicalAuthoredPulledToGeneratedRouteGeometryIsoAt_axis_hom_inv, canonicalAuthoredPulledToGeneratedRouteGeometryIsoAt_axis_inv_hom, canonicalAuthoredPulledToGeneratedRouteGeometryIsoAt_observable_hom_inv, canonicalAuthoredPulledToGeneratedRouteGeometryIsoAt_observable_inv_hom]
  source_sha256:
...
selection:
  ...
  expected_result_type: proof-obligation-discharged
  lean_targets: [ResearchLean/AG/DoctrineFiberProduct/UpperGeometryCompatibleComparatorIncoherence.lean, ResearchLean/AG/DoctrineFiberProduct/UpperGeometryCompatibleDecisionFixtures.lean]
...
result:
  ...
  source_sha256:
    UpperGeometryPairedRawCochainIntertwining.lean: 382b4ea779da16e1d830a0f986a3b649e5b84f0d4beceb3ee790f2e0158674a3
...
## Cycle 72 — same-witness paired restricted suborbit
...
goal_blob_sha: 9bf5b5d9ffc209dd050a90e4e3aad7c4d8378961
goal_sha256: 9a57647e18671e9903c695bea7276140172c0d59ce56e006cced8bd260a0dc38
base_oid: 51b2d5482e07a75b99d1e7a502a94e417d4ca0af
tracking_issue: 4250
report_path: research/reports/G-115-aat-upper-stage-lift.md
selection:
  proof_state_ref: Revision 8 Cycle 71 is merged and supplies the full transparent paired relation and its separately derived actual raw-cochain intertwining theorem.
  proof_dag_predecessors: [Cycle 71 full paired relation, Cycle 70 actual raw-cochain intertwining, existing one-sided coefficient-trivial restricted orbit]
  proof_obligation: Package both actual generated raw cochains in a paired restricted suborbit that retains one common base and pulled full-pair witness; derive both one-sided memberships, componentwise intertwining, composite coefficient identity, and a named nonidentity firing by eliminating that same witness.
  selection_reason: A conjunction of independently existential one-sided memberships would forget which base and pulled reselections intertwine. The paired orbit must preserve one common witness before endpoint conjugation is constructed.
  expected_result_type: proof-obligation-discharged
  lean_targets: [ResearchLean/AG/DoctrineFiberProduct/UpperGeometryPairedRestrictedOrbit.lean]
  risks: [independent one-sided witnesses, supplied final intertwining equality, replacement cochain, wrong source component, coefficient conclusion detached from the paired witness, full orbit MapsTo overclaim]
  unchecked: [endpoint-comparison forward and backward conjugation transports and inverse laws, canonical companion paired transport, UpperStageExchangeExact companion iff, K4 completion audit]
result:
  proposed_result_type: proof-obligation-discharged
  proof_state: target-proof-checkpoint
  proof_obligation_delta: InPairedCoefficientTrivialUpperReselectionOrbit existentially retains one generated base reselection, one generated pulled reselection, their full paired relation, and exact equalities identifying the requested cochains with the actual upperRawDefectCochains generated by that pair. Projection to both existing restricted orbits reuses those same witnesses. Componentwise intertwining rewrites both exact cochain equalities and invokes the Cycle 71 full-pair theorem. Composite coefficient identity rewrites the same equalities and consumes the coefficient conjunct of the same full-pair witness. A full pair enters its paired restricted orbit by reflexive generation equalities, and the named nonidentity generated pair fires this construction.
  completion_candidate: no
  lean_artifacts: [UpperGeometryCompatibleProblemInputData.InPairedCoefficientTrivialUpperReselectionOrbit, InPairedCoefficientTrivialUpperReselectionOrbit.base_mem, InPairedCoefficientTrivialUpperReselectionOrbit.pulled_mem, InPairedCoefficientTrivialUpperReselectionOrbit.cochain_intertwining, InPairedCoefficientTrivialUpperReselectionOrbit.composite_coefficient_id, PairedCoefficientTrivialUpperReselection.mem_pairedRestrictedOrbit, UpperDecisionWitness.generatedComparatorUpperReselections_pairedRestrictedOrbit_fires]
  source_sha256:
    UpperGeometryPairedRestrictedOrbit.lean: ccc5faa3c99e741c1f496b7d17a13e0c3e56740fa99df32230b53285a288751a
  evidence: [focused Lean single-file check, seven declaration namespace standard-axiom audit, targeted dependency DAG build, same-witness existential elimination, exact actual cochain rewrites, named generated firing]
  claim_mapping:
    theorem_names: [InPairedCoefficientTrivialUpperReselectionOrbit, InPairedCoefficientTrivialUpperReselectionOrbit.base_mem, InPairedCoefficientTrivialUpperReselectionOrbit.pulled_mem, InPairedCoefficientTrivialUpperReselectionOrbit.cochain_intertwining, InPairedCoefficientTrivialUpperReselectionOrbit.composite_coefficient_id, PairedCoefficientTrivialUpperReselection.mem_pairedRestrictedOrbit, generatedComparatorUpperReselections_pairedRestrictedOrbit_fires]
    source_labels: [revision 8 clause c paired restricted-suborbit preservation, target proof strategy K3 same-witness orbit bridge]
    conjuncts: [one common full paired witness, exact base actual raw cochain, exact pulled actual raw cochain, both existing restricted memberships, componentwise cochain intertwining, both composite coefficient identities, named nonidentity firing]
    undischarged_assumptions: [endpoint conjugation and companion transport obligations remain]
    acceptance_point: Both one-sided memberships and both component conclusions are obtained only after eliminating one common paired existential witness. The final componentwise equality is not a premise or stored field.
    port_status: not-applicable
audits:
  premise_delta:
    discharged: [same-witness paired restricted-suborbit representation, both one-sided restricted memberships, paired componentwise preservation, paired coefficient preservation, named generated firing]
    remaining: [bidirectional endpoint conjugation with inverse laws, canonical companion paired transport, exchange-exactness iff, final K4 audit]
  certificate_provenance:
    discharged: [orbit membership is generated reflexively from a full pair, cochain intertwining comes from the Cycle 70 proof through the extracted pair, coefficient identity comes from the extracted pair's substantive Cycle 71 coefficient conjunct]
    unresolved: [endpoint conjugation transports and inverse certificates]
  proof_use:
    used: [same base and pulled reselection witnesses, full paired relation, both exact upperRawDefectCochain equalities, full-pair raw-cochain theorem, full-pair coefficient conjunct]
    deliberately_not_used: [independently chosen one-sided witnesses, caller-supplied component equality, replacement cochain, selector, full orbit MapsTo]
  structure_field_escape: none-found; the paired orbit stores only its generating witnesses and exact generation equalities, while component conclusions are derived after existential elimination
  route_integrity: pass; both cochains use the exact generated base and pulled route data and the same reselection pair
  predecessor_integrity: pass; G-108 G-109 G-112 G-114 Formal the fixed revision 8 GOAL and reviewed Cycle 71 sources are unchanged
  target_fitting: none-found; the theorem proves paired preservation for the actual coefficient-trivial restricted suborbit without claiming an unconditional full-orbit map
  vacuity: pass; the named Cycle 71 pair retains its independently proved nonidentity base reselection and fires paired membership
  one_way_as_equivalence: none-found
  goal_or_report_reinterpretation: none-found; endpoint conjugation clause d and K4 remain explicitly open
...
result:
  ...
  claim_mapping:
    declaration_map_status: The exact-head declaration-to-module-to-head-hash map belongs to the schema-complete same-head final packet and remains unchecked at this standard-review candidate stage. The grouped historical references below and the principal current-head entry points delimit what that packet must enumerate; they do not claim that an earlier cycle hash is the current module hash.
    historical_declaration_refs:
      - "Cycle 1: lax geometry-refinement category, projection, and exact faithful embedding"
      - "Cycles 2 through 27: G-114 package and geometry routes, raw one-way comparison, factorization, finite mate, exactification, cartesianness, and authored comparator intertwining"
      - "Cycles 29 through 44: certificate-free compatible input, generated route/comparator spine, route qualifications, actual cochains, pseudofunctor coherence, global mate, and authored endpoint normalization"
      - "Cycles 45 through 48: realization-exact primitive, lossy-producer no-go, structure-preserving negative nonrealization witness, composition/reflection, and theorem-generated positive inhabitants"
      - "Cycles 49 through 64: route realization, endpoint normalization and isomorphisms, complete solution contracts and wrapper-free Equiv, vertical carrier-conservativity, and named decision firing"
      - "Cycles 66 and 68 through 72: coefficient-trivial suborbit, same-route/component comparator-descent positive and three-carrier negative pair, actual raw cochain, full paired relation, and same-witness restricted suborbit"
      - "Cycles 73 through 81: exact endpoint isomorphisms, reselection Equivs, exact edge/path/comparator/cochain transport, native four-conjunct paired transport, witness-bearing restricted-point Equiv, named companion cochain/suborbit, and exchange-exactness companion iff"
    principal_theorem_names: [RefinementGeometryHom, refinementGeometryProjection, exactGeometryToRefinementGeometry, generatedRouteRefinementMate, generatedRouteRefinementMate_fac, UpperGeometryCompatibleProblemInput, RealizationExactUpperEquivalence, structurePreservingSwapExactUpperEquivalence, not_realizationExact_structurePreservingSwap, generatedBaseRouteRealizationExactAt, generatedPulledRouteRealizationExactAt, canonicalAuthoredBaseToGeneratedRouteGeometryIsoAt, canonicalAuthoredPulledToGeneratedRouteGeometryIsoAt, canonicalAuthoredBaseToGeneratedRouteGeometryIsoAt_hom_inv, canonicalAuthoredBaseToGeneratedRouteGeometryIsoAt_inv_hom, canonicalAuthoredPulledToGeneratedRouteGeometryIsoAt_hom_inv, canonicalAuthoredPulledToGeneratedRouteGeometryIsoAt_inv_hom, canonicalSolutionForward, generatedSolutionBackward, generatedSolutionBackward_canonicalSolutionForward, canonicalSolutionForward_generatedSolutionBackward, canonicalGeneratedUpperRefinementBCSolutionEquiv, UpperComparatorDescentAt, generatedPulledIdentityComparatorTransport, upperDecisionSolution_comparatorDescentAt, generatedBaseIdentityPair_support_incoherent, generatedBaseIdentityPair_axis_incoherent, generatedBaseIdentityPair_observable_incoherent, PairedCoefficientTrivialUpperReselection, InPairedCoefficientTrivialUpperReselectionOrbit, canonicalAuthoredGeneratedBaseCoefficientTrivialReselectionEquiv, canonicalAuthoredGeneratedPulledCoefficientTrivialReselectionEquiv, canonicalAuthoredBaseUpperRawDefectCochain_forward, canonicalAuthoredPulledUpperRawDefectCochain_forward, CanonicalAuthoredPairedCoefficientTrivialUpperReselection, canonicalAuthoredPairedCoefficientTrivialUpperReselection_forward_transport, canonicalAuthoredPairedCoefficientTrivialUpperReselection_backward_transport, CanonicalAuthoredPairedRestrictedPoint, GeneratedPairedRestrictedPoint, canonicalAuthoredPairedRestrictedPointForward, canonicalAuthoredPairedRestrictedPointBackward, canonicalAuthoredPairedRestrictedPointBackward_forward, canonicalAuthoredPairedRestrictedPointForward_backward, canonicalAuthoredGeneratedPairedRestrictedPointEquiv, canonicalAuthoredPairedRestrictedPoint_baseCochain_forward_eq, canonicalAuthoredPairedRestrictedPoint_pulledCochain_forward_eq, CanonicalAuthoredPairedRestrictedPoint.forward_mem_pairedRestrictedOrbit, UpperStageExchangeExact, generatedComponent_isIso_iff_backwardCompanion, upperStageExchangeExact_iff_backwardCompanion]
...
selection:
  ...
  unchecked: [schema-complete final packet, fresh four-lane completion review, completion ledger, CI merge and durable status synchronization]
result:
  proposed_result_type: target-proof-checkpoint
  proof_state: target-proof-checkpoint
  completion_candidate: yes
  ...
  exact_declaration_map:
    ...
    sha256: f9e69ab6c9183e38dca29491d045a6774f32f4972215cd130ac7f3f92dcf3386
    generator: research/reports/evidence/g115_exact_declaration_map.rb
    generator_sha256: d3965fc607de335e679d373f15396adab357bdaac2fdf1d3d1b32530378658fc
    counts: {accepted_artifact_identities: 1063, public_source_declarations: 1516, modules: 80, resolved_artifacts: 1063, unresolved: 0, ambiguous: 0}
  evidence: [focused Lean check of UpperGeometryCompatibleSolutionEquivalence with 43 declarations under standard axioms only, focused Lean check of UpperGeometryExchangeExactness with five declarations under standard axioms only, source-field literal proof-use scan, all-public-source 1516-declaration map reproduction with modifier-aware kinds and same-snapshot module hashes, 1063 accepted artifact identities resolved, git diff check, hidden and bidirectional Unicode scan]
  claim_mapping:
...
audits:
  ...
  blocking_findings: []
  next_obligation: Bind the 1516-entry accepted-target source-surface map and its 1063 accepted artifact subset to one fixed head; add the disjoint structured external-dependency closure selected from the final packet's 13 material-premise rows; publish the schema-complete replacement packet; run four wholly fresh completion lanes; post the formal ledger; require green CI; merge PR #4338; then synchronize GOAL report registry and Issue #4250 while leaving the tracking Issue open.
```
...
selection:
  ...
  proof_obligation: Make the current-source declaration map fail closed on canonical namespace-qualified identities, remove unchecked manual overrides, and bind every identity to its defining module content hash while preserving the per-cycle focused Lean evidence as the acceptance provenance.
  selection_reason: K4 requires declaration-level completeness and proof-use evidence. Byte-exact reproduction and module hashes did not establish source identity correctness while the old resolver accepted a bogus qualified name; the repair must remain within the single-file Lean build hard rule.
  expected_result_type: target-proof-checkpoint
  lean_targets: []
  risks: [continuing to match only local names, treating report abbreviations as canonical identities, retaining hard-coded exceptions, silently emitting a partial map, replacing source evidence with forbidden module-group elaboration]
...
result:
  ...
  proof_state: target-proof-checkpoint
  completion_candidate: yes
  proof_obligation_delta: The source-only generator first requires the exact accepted Cycle manifest 1 through 83 with the intentional historical gaps 28 and 65, then verifies SHA-256 2b31e4c59f8e58c96ad6b8dcc3aa18879608c13127d1ef0a874a82a625524c44 over every accepted cycle's ordered target and artifact lists together with 1066 occurrences, 1063 report identities, and 80 targets. Invalid artifact tokens and non-Lean target entries are rejected rather than filtered. All 406 claim_mapping theorem_names and principal_theorem_names entries, including planned entries, are independently locked by SHA-256 19ace3fad97e92c04fee690cf9a9ea6913157320158046055a68c04ae51eda30; all 397 non-planned occurrences, representing 373 unique report tokens, must resolve uniquely into the map, and that ordered resolution is locked by SHA-256 e4444c10f8a2ffc0be62f93565384a75d0e71029519b0c30f95814d7d932216c. The 154 accepted-cycle source_sha256 and validation_refs blocks are independently locked by SHA-256 de6c74feeec5e51e1dcb266c3fdc696750d77339143c58024b6043d44633a661, so focused-check provenance drift fails before source resolution. The artifact manifest includes the 32 formerly omitted target-facing declarations, the Cycle 64 DecisionEdge and DecisionCell inductives and constructors, and nilPath and twistPath. Beyond those report projections, the emitted source-surface map contains all 1516 parsed nonprivate nonlocal source declarations defined in the 80 accepted target modules. It deliberately does not claim the transitive Lean environment or free-form prose as part of that closure. External predecessor and Mathlib declarations used as material evidence are a disjoint packet-level dependency surface: the schema-complete final packet selects them only through structured discharge_artifacts, proof_use_artifacts, and provenance_artifacts fields in the 13 material-premise rows, canonicalizes identity/module/kind/source revision or hash, and requires bidirectional row-to-map coverage. Private and local helper declarations are outside the accepted-target public source surface and remain modifier-visible to substitution checks rather than being misreported as public canonical identities. The 1063 accepted artifact identities still resolve cycle-locally, and their complete ordered result is independently locked by SHA-256 274037f43519768ca7cc5b7e5df733e4da6f5530358708be27a74abfc50ddebe over cycle, report token, canonical identity, declaration kind including declaration modifiers, and module. Thus a same-suffix structure field, private theorem, unsafe definition, or another declaration kind cannot replace a public theorem. Its state-machine lexer removes nested block comments, line comments, escaped strings, multiline strings, and hash-delimited raw strings and rejects any unterminated lexical state. Namespace and section ends are balanced and named ends must match. The declaration parser recognizes structures, classes, definitions, abbreviations, theorems, lemmas, opaques, axioms, constants, local/scoped/named instances, inductives, constructors, and structure fields. Because mapped files currently need neither syntax quotation nor escaped identifiers, any comment/string-external backtick or guillemet is rejected fail closed rather than parsed. Every parsed declaration must lie under AAT.AG.DoctrineFiberProduct; unresolved, ambiguous, duplicate-source, public-source collision, input-manifest, claim-manifest, provenance-manifest, or resolved-kind-manifest mismatch exits before output. The built-in probe covers nested comments, ordinary/multiline/raw strings, axiom, local instance, inductive, and constructor parsing. The Cycle 64 inductive commands include the deriving clauses that generate the DecidableEq and Fintype instances consumed by presentation inferInstance; those compiler-generated declarations have no separate source declaration command and are covered as provenance of the mapped inductive commands rather than falsely presented as parsed source declarations. The generator computes every module hash from the same in-memory byte snapshot used for identity resolution, completes the entire buffered YAML before one stdout write, and never rereads a source during output. The map authenticates this accepted-target source/report-evidence snapshot; commit OID and external dependency binding are deliberately deferred to the schema-complete same-head final packet because a committed artifact cannot contain its own commit OID and the packet owns the material-premise rows. The final Cycle 84 source-map reproduction runs no Lean or lake command; earlier forbidden group-build attempts are disqualified below and are not evidence.
  lean_artifacts: []
  evidence_artifacts:
    map:
      path: research/reports/evidence/G-115-revision9-exact-declaration-map.yml
      sha256: f9e69ab6c9183e38dca29491d045a6774f32f4972215cd130ac7f3f92dcf3386
      blob_sha: 3bd281a97e27937b7e40b3731a487fc2efb7d9f4
    generator:
      path: research/reports/evidence/g115_exact_declaration_map.rb
      sha256: d3965fc607de335e679d373f15396adab357bdaac2fdf1d3d1b32530378658fc
      blob_sha: c5845d87e23e5d0e248eeb8a4450c58d32c1c3f7
    counts: {accepted_artifact_occurrences: 1066, accepted_artifact_identities: 1063, public_source_declarations: 1516, modules: 80, resolved_artifacts: 1063, unresolved: 0, ambiguous: 0}
  evidence: [lossless accepted-cycle input-manifest SHA-256 and fixed count validation, all 1516 nonprivate nonlocal source declarations emitted from the 80 accepted target modules, locked accepted-artifact canonical-identity module modifier-aware declaration-kind manifest SHA-256, locked full claim list and unique non-planned claim-resolution manifests, locked source_sha256 and validation_refs acceptance-provenance projection, byte-exact source-map regeneration, comment ordinary-string multiline-string and raw-string aware cycle-local source namespace-stack resolution, syntax quotation fail-closed control, canonical-root namespace control, accepted-manifest identity mutation rejected before resolution with exit 1 and zero output, raw-string private unsafe and declaration-kind substitution controls rejected with zero output, arbitrary and incomplete report inputs rejected with exit 1 and zero output, former partial-output arguments rejected with exit 2 and zero output, same-byte-snapshot defining-module hashes, single buffered stdout write, per-cycle single-file focused Lean evidence recorded in Cycles 1 through 83]
audits:
  accepted_target_source_surface: pass; all 1516 parsed nonprivate nonlocal source declarations defined in the 80 accepted target modules are emitted, including source declarations outside lean_artifacts and claim_mapping projections
  external_dependency_surface: deferred; the final packet owns a disjoint structured map selected from discharge_artifacts, proof_use_artifacts, and provenance_artifacts in all 13 material-premise rows; no transitive-environment or free-form-prose closure is claimed
  declaration_identity: pass; all map identities are canonical source identities relative to AAT.AG.DoctrineFiberProduct and the ordered canonical identity module and modifier-aware declaration-kind resolution is locked independently of the report-token manifest
  ...
  lexer_regression_probe: pass; nested block comments, line comments, escaped strings, multiline strings, and hash-delimited raw strings cannot contribute declarations; unterminated lexical states fail closed
  declaration_parser_probe: pass; axioms, local/scoped/named instances, inductives, and constructors are recognized, duplicate parsed declarations are rejected, namespace and section scopes must balance, and named ends must match
  declaration_kind_substitution_control: pass; replacing the actual nil theorem with a same-suffix structure field, private theorem, axiom, or unsafe definition is rejected with exit 1 and zero stdout
  deriving_instance_provenance: pass; DecisionEdge and DecisionCell source commands contain the deriving clauses producing the DecidableEq and Fintype instances used by presentation inferInstance; the map remains explicitly a source-declaration map
  ...
  input_manifest: pass; exact accepted cycle list, every unfiltered ordered target and artifact entry, manifest SHA-256, 1066 occurrences, 1063 report identities, and 80 targets are checked before source resolution; malformed artifact and non-Lean target mutations fail with zero stdout
  claim_mapping_coverage: pass; all 406 claim and principal entries are hash-locked, and all 397 non-planned occurrences representing 373 unique report tokens resolve uniquely into the canonical map under a separately locked resolution manifest
  acceptance_provenance: pass; all 154 accepted-cycle source_sha256 and validation_refs blocks are hash-locked, so source-hash or focused-check record mutation exits 1 with zero stdout
  head_binding: deferred; this artifact binds the current source and report-evidence snapshot by content hashes, while the schema-complete final packet binds that snapshot to one exact PR head OID
  ...
  validation_refs:
    ...
    - "the 1516-entry public source map includes RefinementCoverageTransport.no_transport_to_emptyTarget, exactGeometryToRefinementGeometry_faithful, ActiveRefinementBCContext.compositeLegAt_upper_triangle, ActiveRefinementBCGeometryLegData.baseLeg_coefficient_id, ActiveRefinementBCGeometryLegData.pulledLeg_coefficient_id, and UpperRefinementBCSolution.nil_naturality beyond the 1063 accepted-artifact subset"
    - "the Bogus.Namespace report mutation was rejected at the input-manifest gate with exit 1 and zero stdout"
    - "claim_mapping theorem-name mutation and source_sha256 or validation_refs provenance mutation were rejected by their independent projection hashes with exit 1 and zero stdout"
    - "the canonical-manifest nested-comment and raw-string source mutations reached resolution and were rejected as unresolved with exit 1 and zero stdout"
    - "the canonical-manifest command-quotation, same-suffix structure-field, private theorem, unsafe definition, local-instance, and Bogus.Root namespace mutations were rejected with exit 1 and zero stdout"
    ...
    - "the final Cycle 84 source-map regeneration ran no Lean or lake command; earlier attempted group build and scratch audit are explicitly disqualified"
  blocking_findings: []
  next_obligation: Fix the Cycle 84 accepted-target source surface to one new head, add and bind the structured external-dependency surface in the schema-complete final packet, run four wholly fresh math-lean-review lanes, and only after four clean verdicts post the completion ledger and merge.
```
