...
- `focused Lean check: ResearchLean/AG/QualitySurface/SemanticResidualUnhitToTargetScannerBridge.lean`: pass。
- `Research module build: ResearchLean.AG.QualitySurface.SemanticResidualUnhitToTargetScannerBridge`: pass。
