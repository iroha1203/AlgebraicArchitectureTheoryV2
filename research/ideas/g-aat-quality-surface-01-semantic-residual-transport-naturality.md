...
- `focused Lean check: ResearchLean/AG/QualitySurface/SemanticResidualTransportNaturality.lean`: pass。
- `Research module build: ResearchLean.AG.QualitySurface.SemanticResidualTransportNaturality`: pass。
