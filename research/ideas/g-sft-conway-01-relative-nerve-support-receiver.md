...
- `proof_or_evidence_plan`: `lake env lean research/lean/ResearchLean/AG/SFT/ConwaySupportReceiver.lean`、`lake build ResearchLean.AG`、`#print axioms` で検証する。
...
- 2026-07-04: 作成。`lake env lean research/lean/ResearchLean/AG/SFT/ConwaySupportReceiver.lean` と
  `lake build ResearchLean.AG.SFT.ConwaySupportReceiver`、再実行後の `lake build ResearchLean.AG` が通過。
