...
Lean 証拠は `research/lean/ResearchLean/AG/QualitySurface/VisibleLawDeletionProtectedZero.lean` に置いた。主要 declaration は次の通り。
...
- `lake env lean research/lean/ResearchLean/AG/QualitySurface/VisibleLawDeletionProtectedZero.lean`: pass
