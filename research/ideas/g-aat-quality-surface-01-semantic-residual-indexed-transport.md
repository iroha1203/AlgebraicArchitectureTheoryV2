...
- `focused Lean check: ResearchLean/AG/QualitySurface/SemanticResidualIndexedTransport.lean`: pass。
- `Research module build: ResearchLean.AG.QualitySurface.SemanticResidualIndexedTransport`: pass。
