...
proof_or_evidence_plan: `Formal/AG/Research/SFT/ConwayConstrainedOwnerPotentialBoundary.lean` に support-constrained vanishing, endpoint-separating potential, receiver equivalence, finite example package を置く。
...
- `proof_or_evidence_plan`: `lake env lean Formal/AG/Research/SFT/ConwayConstrainedOwnerPotentialBoundary.lean`、
...
- 2026-07-04: 作成。`lake env lean Formal/AG/Research/SFT/ConwayConstrainedOwnerPotentialBoundary.lean`、
