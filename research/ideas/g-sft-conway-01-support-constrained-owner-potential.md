...
- `proof_or_evidence_plan`: `cd research/lean && lake env lean ResearchLean/AG/SFT/ConwayConstrainedOwnerPotentialBoundary.lean`、
...
- 2026-07-04: 作成。`cd research/lean && lake env lean ResearchLean/AG/SFT/ConwayConstrainedOwnerPotentialBoundary.lean`、
