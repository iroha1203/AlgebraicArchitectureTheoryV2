...
- `research/lean/ResearchLean/AG/QualitySurface/ScalarCollapse.lean`
...
Lean 証拠は `research/lean/ResearchLean/AG/QualitySurface/ReadingAdequacy.lean` に置いた。`TraceLocus.TraceLocusCertificate` を使い、reading equivalence を次のように段階化した。
...
- build: `lake build ResearchLean` pass、`lake env lean research/lean/ResearchLean/AG/QualitySurface/ReadingAdequacy.lean` pass。
