...
- `focused Lean check: ResearchLean/AG/QualitySurface/AntichainOverlapBasisTransversal.lean`: pass.
...
- 2026-06-21: Lean evidence を追加し、`Research package build` と full `lake build` を通過。G3 公理検査・形式化品質監査はいずれも pass。
