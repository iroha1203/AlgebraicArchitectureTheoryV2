...
- `proof_or_evidence_plan`: `research/lean/ResearchLean/AG/QualitySurface/SemanticResidualTransitionCutScanner.lean` で scanner predicate、finite scanner、some/none exactness、prefix-clear witness、selected frontier-flat scanner theorem、package theorem を証明する。
...
Lean 証拠は `research/lean/ResearchLean/AG/QualitySurface/SemanticResidualTransitionCutScanner.lean` に固定した。
...
- `lake env lean research/lean/ResearchLean/AG/QualitySurface/SemanticResidualTransitionCutScanner.lean`: pass。
