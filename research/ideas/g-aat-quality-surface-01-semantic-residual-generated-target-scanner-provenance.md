...
- `cd research/lean && lake env lean ResearchLean/AG/QualitySurface/SemanticResidualGeneratedTargetScannerProvenance.lean`: pass。
- `cd research/lean && lake build ResearchLean.AG.QualitySurface.SemanticResidualGeneratedTargetScannerProvenance`: pass。
