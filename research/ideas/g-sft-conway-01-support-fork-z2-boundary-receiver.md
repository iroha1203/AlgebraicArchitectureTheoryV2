...
- 2026-07-04: 作成。`lake env lean research/lean/ResearchLean/AG/SFT/ConwayBoundaryQuotient.lean` と
  `lake build ResearchLean.AG.SFT.ConwayBoundaryQuotient` が通過。`#print axioms` では
