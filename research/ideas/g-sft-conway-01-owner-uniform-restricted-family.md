...
proof_or_evidence_plan: `Formal/AG/Research/SFT/ConwayRestrictedCoherentFamily.lean` に owner-uniform support、finite restricted atlas、local support theorem、not owner-uniform theorem、receiver package を置く。
...
- `proof_or_evidence_plan`: `lake env lean Formal/AG/Research/SFT/ConwayRestrictedCoherentFamily.lean`、
...
- 2026-07-04: 作成。`lake env lean Formal/AG/Research/SFT/ConwayRestrictedCoherentFamily.lean`、
  module build、`lake build FormalAGResearch`、full `lake build` が通過。G2 二審判 pass、final score +120。
