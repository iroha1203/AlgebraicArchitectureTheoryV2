...
proof_or_evidence_plan: `Formal/AG/Research/SFT/ConwayBoundaryMap.lean` に global zero-cochain、boundary map、vanishing iff compatibility、generator-boundary factorization、finite example package を置く。
...
- `proof_or_evidence_plan`: `lake env lean Formal/AG/Research/SFT/ConwayBoundaryMap.lean`、
...
- 2026-07-04: 作成。`lake env lean Formal/AG/Research/SFT/ConwayBoundaryMap.lean`、
