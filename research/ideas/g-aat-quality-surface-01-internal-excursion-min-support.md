...
- `lake env lean research/lean/ResearchLean/QualitySurface/InternalExcursionMinSupport.lean`: pass
...
- `rg -n "\\b(axiom|admit|sorry|unsafe)\\b" research/lean/ResearchLean/QualitySurface/InternalExcursionMinSupport.lean research/lean/ResearchLean.lean`: 該当なし
