...
- `score threshold`: `1000`。1 セッションで 5-8 サイクル程度のまとまった研究フェーズを形成し、定義だけでなく複数の非自明な certificate / theorem / finite example が連動する paper seed 水準のまとまりを要求する。
