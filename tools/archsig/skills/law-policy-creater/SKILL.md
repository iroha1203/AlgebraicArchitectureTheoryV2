...
Use this skill to create a `law-policy/v0.5.1` file and, for AG evaluator
runs, a separate `measurement-profile/v0.5.1` file.
...
6. Run `archsig analyze --archmap <archmap> --law-policy <policy> --measurement-profile <profile> --law-surface <law-surface> --out-dir <run-dir>`.
