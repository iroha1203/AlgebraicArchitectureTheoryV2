...
| "Measure SAGA repair descent from observed cover data" | `law: "ag.saga-descent"`, `evaluator: "ag.saga-descent"`, plus `measurementProfileRef`; the finite complex is derived from ArchMap |
