...
`archmap-extraction-consistency/v0.5.2` is produced by `archsig extraction-diff`.
...
```json
{
  "schema": "archmap-extraction-consistency/v0.5.2",
...
`archmap-coverage-ledger/v0.5.2` records the selected-scope survey. Rows must be
