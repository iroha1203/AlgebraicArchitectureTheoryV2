...
| RepairPlan validation | `repair-plan` | Validates the supplied `archsig-repair-plan/v0.5.2` SAGA Stage 1 input side. Faithfulness, true-sheaf, gluing, and coefficient slots are checked; generated conclusion tokens and still-reserved comparison/grounding fields fail closed. |
