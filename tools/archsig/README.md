...
| RepairPlan validation | `repair-plan` | Validates the supplied `archsig-repair-plan/v0.5.2` SAGA Stage 1 input side. Generated conclusion tokens and reserved future fields fail closed. |
