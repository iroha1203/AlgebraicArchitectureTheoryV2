...
| Compatibility projection workflow | `archmap-workflow`, `air-from-archmap` | Bounded projection surface for AIR/report consumers. It is not the current source of truth for LLM-native ArchSig analysis. |
