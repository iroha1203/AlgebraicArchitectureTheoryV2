...
| RepairPlan validation | `repair-plan` | Validates the supplied `archsig-repair-plan/v0.5.4` SAGA input side. Faithfulness, true-sheaf, gluing, coefficient, and comparison slots are checked; generated conclusion tokens and unimplemented transport fields fail closed. |
