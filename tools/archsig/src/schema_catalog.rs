...
pub fn static_schema_version_catalog() -> SchemaVersionCatalogV0 {
    SchemaVersionCatalogV0 {
        ...
        catalog_version: "llm-atom-archmap/v0.5.2".to_string(),
        ...
        artifacts: vec![
            artifact(
                ...
                vec![
                    ...
                    "archsig-contract:v0.5.2-ag-measurement",
                ],
                "ArchMap v0.5.2 records source-grounded architecture observations. Finite-poset-site inputs contain sources, subject/axis-decorated atoms, contexts, and covers for AG measurement. They reject legacy v0 root fields, unknown atom kinds or predicates, and unresolved source refs before analysis.",
                vec![
            ...
            artifact(
                ...
                vec!["archsig-contract:v0.5.2-improvement"],
                "AAT atom vocabulary v0.5.2 is an artifact-side projection of allowed ArchMap atom kind tokens with provenance refs back to the AAT doctrine. ArchMap v2 validation enforces the compiled-in fixed AAT canonical doctrine before checking atoms[].kind membership.",
                vec![
            ...
            artifact(
                ...
                "authoring",
                "ArchSig v0.5.2 ArchMap authoring",
                vec!["archsig-contract:archmap-authoring-v0.5.2"],
                "Scope manifest v0.5.2 records the selected authoring scope, repository revision, deterministic worklist, content hashes, exclusions, and author-supplied evidence files before reading begins.",
                vec![
            ...
            artifact(
                ...
                "ArchSig v0.5.2 ArchMap authoring",
                vec!["archsig-contract:archmap-authoring-v0.5.2"],
                "Candidate packet v0.5.2 records one reading pass chunk: reviewed sources, candidate observations, survey rows, unavailable notes, and self-review gates.",
                vec![
            ...
            artifact(
                ...
                "ArchSig v0.5.2 ArchMap authoring",
                vec!["archsig-contract:archmap-authoring-v0.5.2"],
                "Extraction consistency v0.5.2 records atom-match-key comparison between reading passes, unmatched queues, matchRate, context differences, and integrator adjudications.",
                vec![
            ...
            artifact(
                ...
                "ArchSig v0.5.2 ArchMap authoring",
                vec!["archsig-contract:archmap-authoring-v0.5.2"],
                "Coverage ledger v0.5.2 records selected-scope survey rows and the fixed claim boundary for authoring provenance.",
                vec![
            ...
            artifact(
                ...
                "AAT atom binding vocabulary manifest v0.5.2",
                LAW_SURFACE_BINDING_VOCABULARY_SCHEMA,
                "authoring",
                "ArchSig v0.5.2 LawPolicy Stage 2",
                vec!["archsig-contract:v0.5.2-law-equation-surface"],
            ...
            artifact(
                ...
                "Law equation surface v0.5.2 author declaration",
            ...
            artifact(
                "law-policy/v0.5.2",
                "LawPolicy v0.5.2 selector artifact",
                LAW_POLICY_V1_SCHEMA,
                "primary",
                "ArchMap Atom-to-AAT contract",
                vec!["archsig-contract:archmap-minimal-observation"],
                "LawPolicy v0.5.2 selects explicit law/evaluator pairs with registry-owned basis, scope, and severity. Retired policy pack selectors, unknown evaluators, unresolved basis refs, and DSL-style witness rules are rejected before analysis.",
                vec![
                    "LawPolicy v0.5.2 selects evaluators; it does not define witness predicates, axis valuation, obstruction definitions, or Lean proofs.",
            ...
            artifact(
                ...
                "ArchSig v0.5.2 LawPolicy Stage 2",
                vec!["archsig-contract:v0.5.2-law-equation-surface"],
                "Policy bundle v0.5.2 fixes LawPolicy, law-equation-surface, and MeasurementProfile references together with canonical JSON SHA-256 component fingerprints for one analyze run.",
                vec![
            ...
            artifact(
                ...
                "MeasurementProfile v0.5.2 AG evaluator selector",
            ...
            artifact(
                ...
                "ArchSig RepairPlan v0.5.2 SAGA supplied input artifact",
                ARCHSIG_REPAIR_PLAN_V1_SCHEMA,
                "primary",
                "ArchSig v0.5.2 SAGA Stage 1",
                vec!["archsig-contract:saga-stage1-v0.5.2"],
                    "RepairPlan v0.5.2 supplies the checked SAGA descent input side: residual refs, finite complex, primitive restriction differences, semantic projection, faithfulness regime, and F2-additive coefficient.",
                vec![
            ...
            artifact(
                ...
                "ArchMap Atom-to-AAT contract",
                vec!["archsig-contract:archmap-minimal-observation"],
                "Law evaluator registry v0.5.2 owns evaluator manifests, basis refs, missing blocker rules, pass / violation criteria, and output refs. LawPolicy v0.5.2 selects entries from this registry.",
                vec![
                    "Evaluator registry manifest is an ArchSig computation contract, not a Lean theorem proof.",
                    "LawPolicy v0.5.2 cannot override witness rules, axis rules, distance formula, pass criteria, or violation criteria.",
                ],
            ),
            artifact(
                ...
                "Normalized ArchMap v0.5.2 is generated by the ArchSig normalizer without rereading the source repository. Finite-poset-site output records deterministic context, cover, and selected-site presentation under the fixed AAT canonical doctrine fingerprint.",
                vec![
            ...
            artifact(
                ...
                "ArchSig BoundaryStatement v0.5.2",
                ARCHSIG_BOUNDARY_STATEMENT_V1_SCHEMA,
                "primary",
                "ArchSig v0.5.2 Algebraic Geometry Measurement",
                vec!["archsig-contract:v0.5.2-improvement"],
                "BoundaryStatement v0.5.2 is the typed scoped qualifier contract for measurement packet boundaries. It records id, kind, scopeRefs, reason, and text while preserving nonConclusions as a compatibility view.",
                vec![
            ...
            artifact(
                ...
                "ArchSig declared refactor morphism v0.5.2",
                "refactor-morphism/v0.5.2",
                "primary",
                "ArchSig v0.5.2 Algebraic Geometry Measurement",
                vec!["archsig-contract:v0.5.2-ag-measurement"],
            ...
            artifact(
                ...
                "ArchSig coarse-to-fine refinement comparison v0.5.2",
                "refinement-comparison/v0.5.2",
                "primary",
                "ArchSig v0.5.2 Algebraic Geometry Measurement",
                vec!["archsig-contract:v0.5.2-ag-measurement"],
            ...
            artifact(
                ...
                vec!["archsig-contract:artifact-ci-v0.5.2"],
                &format!(
                    "Gate report v0.5.2 records {} together with ruleOutcomes[].appliedMapping rows that preserve original measurement verdict vocabulary.",
            ...
            artifact(
                ...
                "ArchSig Output / CI workflow",
                vec!["archsig-contract:artifact-ci-v0.5.2"],
                "ArchMap diff v0.5.2 records deterministic added, removed, and modified sources, atoms, contexts, and covers computed from two normalized-archmap/v0.5.2 artifacts.",
                vec![
            ...
            artifact(
                ...
                vec!["archsig-contract:artifact-ci-v0.5.2"],
                &format!(
                    "Comparison report v0.5.2 records identical, verdict-row, or not-comparable run comparison together with record-level verdict transitions and archmap-diff intersections. With a validated refinement-comparison/v0.5.2 artifact it can also record class-zero preservation. Registered conclusionCode values are {}.",
        ...
        compatibility_policy: SchemaCompatibilityPolicyV0 {
            ...
            policy_version: "llm-atom-archmap/v0.5.2".to_string(),
            applies_to_catalog_version: "llm-atom-archmap/v0.5.2".to_string(),
            dimensions: vec![
