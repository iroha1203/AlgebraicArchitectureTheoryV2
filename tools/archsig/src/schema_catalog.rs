    ...
    SchemaVersionCatalogV0 {
        ...
        artifacts: vec![
            ...
            artifact(
                ...
                vec!["archsig-contract:artifact-ci-v0.5.2"],
                &format!(
                    "Comparison report v0.5.2 records identical, verdict-row, or not-comparable run comparison together with record-level verdict transitions and archmap-diff intersections. Registered conclusionCode values are {}.",
