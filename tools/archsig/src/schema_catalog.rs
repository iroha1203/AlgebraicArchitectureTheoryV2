    ...
    SchemaVersionCatalogV0 {
        ...
        artifacts: vec![
            ...
            artifact(
                ...
                "Validation checks identity, ArchMap and LawPolicy refs, workflow risk readings, spectral analysis readings, spectral mode readings, spectral drilldown readings, curvature support readings, curvature transfer readings, transfer bridge readings, bridge edge source refs / review focus / cut recommendations, v0.3.0 measurement expansion readings including reverse-import projection / trajectory / bridge-transfer readings, AAT structural state readings, structural reading review surface, current-state/evolution boundary, law-relative obstruction links, signature and flatness boundaries, repair candidate guardrails, LLM interpretation surface, and non-conclusions without computing the analysis engine.",
                vec![
