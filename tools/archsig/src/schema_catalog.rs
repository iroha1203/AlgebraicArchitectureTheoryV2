    ...
    SchemaVersionCatalogV0 {
        ...
        artifacts: vec![
            ...
            artifact(
                ...
                "ArchSig analysis packet owns AAT concept surfaces, architecture state, design pressure, change impact, architecture object projections, invariant family readings, LawUniverse reading, molecule readings, obstruction circuits, signature axes, analytic representations, coupling/cohesion readings, workflow risk readings, spectral analysis readings, spectral mode readings, spectral drilldown readings, transfer bridge readings with edge source refs and cut recommendations, representation strength readings, local curvature diagram readings, three-layer flatness readings, observation projection readings, state transition algebra readings, operation/invariant Galois readings, split readiness readings, design principle readings, operation deltas, path/homotopy/diagram readings, bounded judgements, LLM interpretation packet, evidence boundary, excluded readings, and non-conclusions.",
                vec![
            ...
            artifact(
                ...
                "Validation checks identity, ArchMap and LawPolicy refs, workflow risk readings, spectral analysis readings, spectral mode readings, spectral drilldown readings, transfer bridge readings, bridge edge source refs and cut recommendations, AAT structural state readings, law-relative obstruction links, signature and flatness boundaries, repair candidate guardrails, LLM interpretation surface, and non-conclusions without computing the analysis engine.",
                vec![
