...
pub fn static_schema_version_catalog() -> SchemaVersionCatalogV0 {
    SchemaVersionCatalogV0 {
        ...
        catalog_version: "llm-atom-archmap/v0.5.3".to_string(),
        ...
        artifacts: vec![
            artifact(
                ...
                vec![
                    ...
                    "archsig-contract:v0.5.3-ag-measurement",
                ],
                "ArchMap v0.5.3 records source-grounded architecture observations. Finite-poset-site inputs contain sources, subject/axis-decorated atoms, contexts, and covers for AG measurement. They reject legacy v0 root fields, unknown atom kinds or predicates, and unresolved source refs before analysis.",
                vec![
            ...
            artifact(
                ...
                "primary",
                "ArchSig v0.5.3 Algebraic Geometry Measurement",
                vec!["archsig-contract:v0.5.3-improvement"],
                "AAT atom vocabulary v0.5.3 is an artifact-side projection of allowed ArchMap atom kind tokens with provenance refs back to the AAT doctrine. ArchMap v2 validation enforces the compiled-in fixed AAT canonical doctrine before checking atoms[].kind membership.",
                vec![
            ...
            artifact(
                ...
                "authoring",
                "ArchSig v0.5.3 ArchMap authoring",
                vec!["archsig-contract:archmap-authoring-v0.5.3"],
                "Scope manifest v0.5.3 records the selected authoring scope, repository revision, deterministic worklist, content hashes, exclusions, and author-supplied evidence files before reading begins.",
                vec![
            ...
            artifact(
                ...
                "ArchSig v0.5.3 ArchMap authoring",
                vec!["archsig-contract:archmap-authoring-v0.5.3"],
                "Candidate packet v0.5.3 records one reading pass chunk: reviewed sources, candidate observations, survey rows, unavailable notes, and self-review gates.",
                vec![
            ...
            artifact(
                ...
                "ArchSig v0.5.3 ArchMap authoring",
                vec!["archsig-contract:archmap-authoring-v0.5.3"],
                "Extraction consistency v0.5.3 records atom-match-key comparison between reading passes, unmatched queues, matchRate, context differences, and integrator adjudications.",
                vec![
            ...
            artifact(
                ...
                "ArchSig v0.5.3 ArchMap authoring",
                vec!["archsig-contract:archmap-authoring-v0.5.3"],
                "Coverage ledger v0.5.3 records selected-scope survey rows and the fixed claim boundary for authoring provenance.",
                vec![
            ...
            artifact(
                ...
                "AAT atom binding vocabulary manifest v0.5.3",
                LAW_SURFACE_BINDING_VOCABULARY_SCHEMA,
                "authoring",
                "ArchSig v0.5.3 LawPolicy Stage 2",
                vec!["archsig-contract:v0.5.3-law-equation-surface"],
            ...
            artifact(
                ...
                "Law equation surface v0.5.3 author declaration",
                LAW_EQUATION_SURFACE_V1_SCHEMA,
                "primary",
                "ArchSig v0.5.3 LawPolicy Stage 2",
                vec!["archsig-contract:v0.5.3-law-equation-surface"],
                "Law equation surface v0.5.3 records the authoring input contract for law identifiers, condition types, witness bindings, and closed-equational forbidden support generators. This stage's standalone command validates the declaration contract.",
                vec![
                    "The surface does not supply verdicts, certificates, boundary membership, or global coherence conclusions.",
                    "Stage 3 law-surface fields and diagnostic ceilings are validated under the supplied v0.5.3 contract.",
                ],
            ),
            artifact(
                "law-policy/v0.5.3",
                "LawPolicy v0.5.3 selector artifact",
                LAW_POLICY_V1_SCHEMA,
                "primary",
                "ArchMap Atom-to-AAT contract",
                vec!["archsig-contract:archmap-minimal-observation"],
                "LawPolicy v0.5.3 selects explicit law/evaluator pairs with registry-owned basis, scope, and severity. Retired policy pack selectors, unknown evaluators, unresolved basis refs, and DSL-style witness rules are rejected before analysis.",
                vec![
                    "LawPolicy v0.5.3 selects evaluators; it does not define witness predicates, axis valuation, obstruction definitions, or Lean proofs.",
            ...
            artifact(
                ...
                "ArchSig v0.5.3 LawPolicy Stage 2",
                vec!["archsig-contract:v0.5.3-law-equation-surface"],
                "Policy bundle v0.5.3 fixes LawPolicy, law-equation-surface, and MeasurementProfile references together with canonical JSON SHA-256 component fingerprints for one analyze run.",
                vec![
            ...
            artifact(
                ...
                "MeasurementProfile v0.5.3 AG evaluator selector",
                MEASUREMENT_PROFILE_V1_SCHEMA,
                "primary",
                "ArchSig v0.5.3 Algebraic Geometry Measurement",
                vec!["archsig-contract:v0.5.3-ag-measurement"],
                "MeasurementProfile v0.5.3 declares selected site, cover, coefficient, EffCoeff procedure, resolution selector, Dom/Zero/NonZero/Cert predicates, optional analytic innerProduct / weights / costModel declarations, and five-valued verdict discipline. Witness variables are supplied by the referenced law-equation-surface.",
                vec![
            ...
            artifact(
                ...
                "ArchSig RepairPlan v0.5.3 SAGA supplied input artifact",
                ARCHSIG_REPAIR_PLAN_V1_SCHEMA,
                "primary",
                "ArchSig v0.5.3 SAGA Stage 1",
                vec!["archsig-contract:saga-stage1-v0.5.3"],
                    "RepairPlan v0.5.3 supplies the checked SAGA descent input side: residual refs, finite complex, primitive restriction differences, semantic projection, faithfulness regime, and F2-additive coefficient.",
                vec![
            ...
            artifact(
                ...
                "ArchMap Atom-to-AAT contract",
                vec!["archsig-contract:archmap-minimal-observation"],
                "Law evaluator registry v0.5.3 owns evaluator manifests, basis refs, missing blocker rules, pass / violation criteria, and output refs. LawPolicy v0.5.3 selects entries from this registry.",
                vec![
                    "Evaluator registry manifest is an ArchSig computation contract, not a Lean theorem proof.",
                    "LawPolicy v0.5.3 cannot override witness rules, axis rules, distance formula, pass criteria, or violation criteria.",
                ],
            ),
            artifact(
                ...
                "Normalized ArchMap v0.5.3 is generated by the ArchSig normalizer without rereading the source repository. Finite-poset-site output records deterministic context, cover, and selected-site presentation under the fixed AAT canonical doctrine fingerprint.",
                vec![
            ...
            artifact(
                ...
                "ArchSig grounded SAGA conclusions packet v0.5.3",
                ARCHSIG_SAGA_CONCLUSIONS_V1_SCHEMA,
                "primary",
                "ArchSig v0.5.3 Algebraic Geometry Measurement",
                vec!["archsig-contract:v0.5.3-ag-measurement"],
                "The grounded SAGA conclusions packet v0.5.3 records the generated finite Boolean quotient, lawDependent 3-conclusion section, lawIndependent 7-conclusion section, degree-zero contribution, and chart detector findings.",
                vec![
            ...
            artifact(
                ...
                "ArchSig BoundaryStatement v0.5.3",
                ARCHSIG_BOUNDARY_STATEMENT_V1_SCHEMA,
                "primary",
                "ArchSig v0.5.3 Algebraic Geometry Measurement",
                vec!["archsig-contract:v0.5.3-improvement"],
                "BoundaryStatement v0.5.3 is the typed scoped qualifier contract for measurement packet boundaries. It records id, kind, scopeRefs, reason, and text while preserving nonConclusions as a compatibility view.",
                vec![
            ...
            artifact(
                ...
                "ArchSig declared refactor morphism v0.5.3",
                "refactor-morphism/v0.5.3",
                "primary",
                "ArchSig v0.5.3 Algebraic Geometry Measurement",
                vec!["archsig-contract:v0.5.3-ag-measurement"],
            ...
            artifact(
                ...
                "ArchSig coarse-to-fine refinement comparison v0.5.3",
                "refinement-comparison/v0.5.3",
                "primary",
                "ArchSig v0.5.3 Algebraic Geometry Measurement",
                vec!["archsig-contract:v0.5.3-ag-measurement"],
            ...
            artifact(
                ...
                vec!["archsig-contract:artifact-ci-v0.5.3"],
                "Gate policy v0.5.3 records institutional verdict-to-action mappings for absolute and introduced-by-change rules. Absolute rules must map measured_zero, measured_nonzero, unmeasured, unknown, not_computed, and violated_assumption_dependency; violated_assumption_dependency must map exactly to block, while unmeasured, unknown, and not_computed cannot map to plain pass. Introduced-by-change rules must map new, cleared, preexisting, removed, and other.",
                vec![
            ...
            artifact(
                ...
                vec!["archsig-contract:artifact-ci-v0.5.3"],
                &format!(
                    "Gate report v0.5.3 records {} together with ruleOutcomes[].appliedMapping rows that preserve original measurement verdict vocabulary.",
            ...
            artifact(
                ...
                "ArchSig Output / CI workflow",
                vec!["archsig-contract:artifact-ci-v0.5.3"],
                "ArchMap diff v0.5.3 records deterministic added, removed, and modified sources, atoms, contexts, and covers computed from two normalized-archmap/v0.5.3 artifacts.",
                vec![
            ...
            artifact(
                ...
                vec!["archsig-contract:artifact-ci-v0.5.3"],
                &format!(
                    "Comparison report v0.5.3 records identical, verdict-row, or not-comparable run comparison together with record-level verdict transitions and archmap-diff intersections. With a validated refinement-comparison/v0.5.3 artifact it can also record class-zero preservation. Registered conclusionCode values are {}.",
                    registry_sentence(&ARCHSIG_COMPARISON_CONCLUSION_CODES),
                ),
                vec![
                    "Comparison report does not infer class transport, obstruction identity transport, repair causality, or semantic equivalence without a validated refinement-comparison/v0.5.3 artifact whose fingerprints bind the corresponding run siteCoverDigest values.",
        ...
        compatibility_policy: SchemaCompatibilityPolicyV0 {
            ...
            policy_version: "llm-atom-archmap/v0.5.3".to_string(),
            applies_to_catalog_version: "llm-atom-archmap/v0.5.3".to_string(),
            dimensions: vec![
