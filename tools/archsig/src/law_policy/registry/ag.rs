...
fn ag_refactor_transport_manifest() -> LawEvaluatorManifestV1 {
    LawEvaluatorManifestV1 {
        ...
        required_molecule_condition:
            "refactor-morphism/v0.5.4 with a validated site/law/coefficient/witness compatibility map"
                .to_string(),
...
fn ag_harmonic_debt_manifest() -> LawEvaluatorManifestV1 {
    LawEvaluatorManifestV1 {
        ...
        required_predicates: Vec::new(),
        required_molecule_condition:
            "measurement-profile/v0.5.4 analytic innerProduct weights plus finite cellular Laplacian witnesses"
                .to_string(),
        scope_filtering_rule:
...
fn ag_coherence_manifest() -> LawEvaluatorManifestV1 {
    LawEvaluatorManifestV1 {
        ...
        required_molecule_condition:
            "archmap/v0.5.4 contexts and selected cover triple-overlap 2-skeleton".to_string(),
        scope_filtering_rule:
...
fn ag_period_stokes_audit_manifest() -> LawEvaluatorManifestV1 {
    LawEvaluatorManifestV1 {
        ...
        required_molecule_condition:
            "archmap/v0.5.4 selected cover with supplied dOmegaIntegral and boundaryPeriod audit values"
                .to_string(),
        scope_filtering_rule:
...
fn ag_section_manifest() -> LawEvaluatorManifestV1 {
    LawEvaluatorManifestV1 {
        ...
        required_molecule_condition:
            "archmap/v0.5.4 selected cover, finite forbidden supports, and one selected Boolean section"
                .to_string(),
        scope_filtering_rule:
...
fn ag_restriction_manifest() -> LawEvaluatorManifestV1 {
    LawEvaluatorManifestV1 {
        ...
        required_molecule_condition:
            "archmap/v0.5.4 contexts, selected cover restriction edges, and finite ideal generator supports"
                .to_string(),
        scope_filtering_rule:
            "selected finite poset site and cover from MeasurementProfile".to_string(),
        missing_blocker_rule:
...
fn ag_manifest(evaluator_id: &str, law_id: &str) -> LawEvaluatorManifestV1 {
    LawEvaluatorManifestV1 {
        ...
        required_predicates: Vec::new(),
        required_molecule_condition:
            "archmap/v0.5.4 contexts and covers replace molecule primary input".to_string(),
