...
pub use schema::{
    ...
    ARCHSIG_GENERATED_CONTRACT_IDS, ARCHSIG_MEASURED_AG_OBSTRUCTION_UNDER_PROFILE,
    ARCHSIG_MEASURED_H1_OBSTRUCTION_UNDER_PROFILE, ARCHSIG_MEASURED_LAW_DEFECT_AT_CHART,
