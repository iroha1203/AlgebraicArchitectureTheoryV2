use crate::{
    ...
    ARCHITECTURE_POLICY_VALIDATION_REPORT_SCHEMA_VERSION, CALIBRATION_REVIEW_RECORD_SCHEMA_VERSION,
    ...
    OPERATION_SUPPORT_ESTIMATE_SCHEMA_VERSION, OWNERSHIP_BOUNDARY_MONITOR_SCHEMA_VERSION,
    ...
    SCHEMA_VERSION_CATALOG_SCHEMA_VERSION, SFT_REVIEW_SUMMARY_SCHEMA_VERSION,
    ...
    SchemaVersionCatalogV0 {
        ...
        artifacts: vec![
            ...
            artifact(
                ...
                "implemented",
                vec!["tools/fieldsig/docs/artifacts-and-boundaries.md"],
                vec!["#1149", "#1150", "#1156"],
                compatibility_boundary(
