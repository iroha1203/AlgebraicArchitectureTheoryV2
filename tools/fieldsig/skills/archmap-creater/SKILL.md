...
Use FieldSig planning skills after ArchSig has produced `archsig-measurement-packet/v0.5.4` with all three component fingerprints and the user asks for planning forecast.
