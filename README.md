...
| --- | --- | --- |
| 数学的中核 | feature extension、operation、invariant、obstruction witness、proof obligation、signature trajectory | [AAT 総合理論](docs/aat/README.md) |
...
| Tooling | AIR、extractor、measured Signature、coverage / exactness metadata、Feature Extension Report、CI policy | [AAT Tooling Documentation](docs/tooling/README.md), [ArchSig tooling index](docs/design/archsig_tooling_index.md) |
...
- [AAT 総合理論](docs/aat/README.md)
- [Part 1: AAT 基礎編](docs/aat/part1_foundations.md)
- [Part 2: AAT 発展編](docs/aat/part2_advanced_theory.md)
- [Part 3: Architecture Dynamics / Chaos Game 編](docs/aat/part3_dynamics_chaos_game.md)
- [アーキテクチャ零曲率定理 Lean 化設計](docs/formal/flatness_obstruction_lean_design.md)
- [Lean module 階層整理方針](docs/formal/lean_module_organization.md)
- [設計原則の分類](docs/aat/README.md#設計原則)
- [証明義務と実証仮説](docs/proof_obligations.md)
- [Lean 定義・定理索引](docs/lean_theorem_index.md)
- [AAT Tooling Documentation](docs/tooling/README.md)
...
- `docs`
  - 第一級理論文書、Lean status、proof obligations、tooling docs、個別 design、empirical protocol。
- `Main.lean`
