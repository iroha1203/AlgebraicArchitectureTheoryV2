...
- 状態: reviewing(投稿前確認を実施中)
- 投稿先・種別・カテゴリ・資格: Zenodo / Publication–Preprint。資格=権利を持つ登録ユーザーなら誰でも deposit 可。
...
- 著者・所属・題名・要旨・版・識別子・license の照合: TBD(zenodo_metadata.md を deposit フォームと突合)
- 人間の著者による最終確認・日付: TBD
- 投稿先生成 preview の hash・確認者・結果: TBD(Zenodo preview で file 数・一覧を zip 記録と突合)
- 実際の投稿日時・識別子: TBD
- 公開 URL・DOI / arXiv ID・版: TBD
- 公開後に取得した source・PDF の hash・照合結果: TBD
