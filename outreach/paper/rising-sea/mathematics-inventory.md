...
一般の輸送・lens・基底変換・比較群の対象・仮定と固定版のLean宣言は、[主張と証拠の対応](claims.md#c型の主張とlean宣言の対応)および[付録A](ja/15-appendix-a-lean-correspondence.md)に対応する。
...
| 4-D 合成と射影 | 定理。fiber 間 transport functor、compositor / unitor、単位・三重合成の整合、塔の pseudonatural compatibility | 任意の関手と選択したstrong liftから構成する。AATの塔へも適用する | [ArbitraryStrongLiftPseudofunctor][core-pseudo]、[Pseudofunctor][geom-pseudo]、[TowerCompatibility][tower-coherence] |
| 4-E authored 比較の障害 | 構成・同値。raw 2-cell defect、辺 reselection の作用、障害消滅と coherent な再選択の存在 | 有限 presentation と許容比較を固定。raw defect は無条件に定義し、3-cell の cocycle 則には syzygy compatibility を使う | [ArbitraryObstruction][transport-pasting]、[ArbitraryObstruction][transport-vanishing]、[UnifiedObstruction][transport-unified] |
| 4-F 段横断の障害 | 構成・条件付き分解。core への射影、kernel、辺水準 section、全体障害と段内・段間障害の関係 | 因子順を保つ。各段の消滅と joint な coherentization を区別し、alignment の失敗を扱う | [CompositeQualification](https://github.com/iroha1203/AlgebraicArchitectureTheoryV2/blob/7e68ec6e77ef0249ede6a4c875715cfaf1cb3ee6/research/lean/ResearchLean/AG/CrossStageCoherence/CompositeQualification.lean)、[SectionDecomposition][section-decomposition]、[GlobalVanishing][global-vanishing]、[FiniteWitnesses][cross-witness] |
...
一次資料は [一般の相対lens](https://github.com/iroha1203/AlgebraicArchitectureTheoryV2/blob/7e68ec6e77ef0249ede6a4c875715cfaf1cb3ee6/research/lean/ResearchLean/AG/RealizationReconstruction/GeneralRelativeLens.lean)、[protocol の adapter 図式][protocol-squares]。
...
| 5-B cartesian reindexing | 構成・普遍性。任意の exact semantic 底射と target package への strong cartesian lift、cleavage と合成整合 | 任意のsemantic cartesian liftの選択を用い、単位・合成の整合性を導く | [CartesianTarget][cartesian-target]、[ExactBottomGlobalLift][global-lift]、[同 coherence][global-lift-coherence] |
...
| 5-D canonical Beck–Chevalley mate | 構成・同型。pointed exact pullback square の push / pull 二経路と canonical mate | 普遍性から生成する mate、authored 比較との一致、後の projector を含む比較を区別する | [SemanticCoreBeckChevalleyMate][bc-mate]、[SemanticCoreBeckChevalleyFactorization][bc-exact]、[G-110][g110] |
...
| 6-H 完全幾何での実比較 | 定理・非可逆例。実生成 `barAlpha` の core mate への射影、`barBeta=bar d barAlpha`、Karoubi 同型と可逆性分類 | 同じ square・cell・cochain・係数・source geometry から両経路を生成する。G-116 と G-118 の接続を endpoint triangle で証明する | [SemanticDerivedBarAlphaTriangle][bar-alpha]、[SemanticExactBarBetaClassification][bar-beta]、[ExactBarBetaFiniteWitness][bar-beta-witness] |
...
| 項目 | 種類・数学内容 | 入力・成立条件と結論 | 主な一次資料 |
| --- | --- | --- | --- |
| 7-A 比較保存群 | 構成・分類。`Γ_c={(u,v) ∣ vc=cu}`、両射影の像・核・非空 fiber の torsor | 任意の圏の比較と許容端点部分群。完全幾何では底固定群にも適用する。`c` が同型で許容群が共役により対応すれば両射影は同型 | [F37GeneralComparison][qualified-stabilizer]、[G-118 A][g118] |
...
| 7-F AAT 正規化の分類 | 構成・定理。G-122 の実比較の制限準同型に群準同型の section、分裂短完全列、各 lift fiber の torsor | 選択子の二場合と canonical 正規化を分ける。全端点群と底を固定する群の双方で、section が底・係数成分を保持する | [SemanticDerivedSelectorGlobalSection][beta-section]、[SemanticDerivedSelectorGlobalComparison][beta-exactness]、[底固定版][beta-bottom] |
...
| 7-H 比較対象の自己同型群 | 群同型。恒等冪等で埋め込んだ比較対象の自己同型群を許容端点群へ制限し、`Γ_c` と同定。G-118 の実生成 mate への特殊化 | 任意の圏の比較 `c` を `Arr(Kar(C))` の最大亜群の対象として扱い、許容端点部分群へ制限する。同定は両端射影と可換。底を固定する条件は端点変更に課し、比較 `c` 自身の底への像は恒等に制限しない | [F37GeneralComparison][comparison-object-group]、[GeneratedQualifiedComparison][generated-comparison-object-group]、[G-119 B][g119] |
...
`(|K|!)^{|π₀(Q)|}` になる。`H` の連結成分への作用を合成に含め、半直積として記述する（[FixedFSemidirectProduct](https://github.com/iroha1203/AlgebraicArchitectureTheoryV2/blob/7e68ec6e77ef0249ede6a4c875715cfaf1cb3ee6/research/lean/ResearchLean/AG/RealizationReconstruction/FixedFSemidirectProduct.lean)）。
...
[core-pseudo]: https://github.com/iroha1203/AlgebraicArchitectureTheoryV2/blob/7e68ec6e77ef0249ede6a4c875715cfaf1cb3ee6/research/lean/ResearchLean/AG/CrossStageCoherence/ArbitraryStrongLiftPseudofunctor.lean
...
[transport-pasting]: https://github.com/iroha1203/AlgebraicArchitectureTheoryV2/blob/7e68ec6e77ef0249ede6a4c875715cfaf1cb3ee6/research/lean/ResearchLean/AG/TransportCoherence/ArbitraryObstruction.lean
[transport-vanishing]: https://github.com/iroha1203/AlgebraicArchitectureTheoryV2/blob/7e68ec6e77ef0249ede6a4c875715cfaf1cb3ee6/research/lean/ResearchLean/AG/TransportCoherence/ArbitraryObstruction.lean
...
[global-lift-coherence]: https://github.com/iroha1203/AlgebraicArchitectureTheoryV2/blob/7e68ec6e77ef0249ede6a4c875715cfaf1cb3ee6/research/lean/ResearchLean/AG/DoctrineFiberProduct/ArbitrarySemanticCleavageCoherence.lean
[coverage-classification]: ../../../research/lean/ResearchLean/AG/DoctrineFiberProduct/ExactBottomCoverageClassification.lean
[bc-mate]: https://github.com/iroha1203/AlgebraicArchitectureTheoryV2/blob/7e68ec6e77ef0249ede6a4c875715cfaf1cb3ee6/research/lean/ResearchLean/AG/DoctrineFiberProduct/SemanticCoreBeckChevalleyMate.lean
[bc-exact]: https://github.com/iroha1203/AlgebraicArchitectureTheoryV2/blob/7e68ec6e77ef0249ede6a4c875715cfaf1cb3ee6/research/lean/ResearchLean/AG/DoctrineFiberProduct/SemanticCoreBeckChevalleyFactorization.lean
...
[comparison-object-group]: https://github.com/iroha1203/AlgebraicArchitectureTheoryV2/blob/7e68ec6e77ef0249ede6a4c875715cfaf1cb3ee6/research/lean/ResearchLean/AG/ComparisonInformation/F37GeneralComparison.lean
...
[bar-alpha]: https://github.com/iroha1203/AlgebraicArchitectureTheoryV2/blob/7e68ec6e77ef0249ede6a4c875715cfaf1cb3ee6/research/lean/ResearchLean/AG/FullGeometryNormalization/SemanticDerivedBarAlphaTriangle.lean
[bar-beta]: https://github.com/iroha1203/AlgebraicArchitectureTheoryV2/blob/7e68ec6e77ef0249ede6a4c875715cfaf1cb3ee6/research/lean/ResearchLean/AG/FullGeometryNormalization/SemanticExactBarBetaClassification.lean
[bar-beta-witness]: ../../../research/lean/ResearchLean/AG/FullGeometryNormalization/ExactBarBetaFiniteWitness.lean
[qualified-stabilizer]: https://github.com/iroha1203/AlgebraicArchitectureTheoryV2/blob/7e68ec6e77ef0249ede6a4c875715cfaf1cb3ee6/research/lean/ResearchLean/AG/ComparisonInformation/F37GeneralComparison.lean
...
[beta-section]: https://github.com/iroha1203/AlgebraicArchitectureTheoryV2/blob/7e68ec6e77ef0249ede6a4c875715cfaf1cb3ee6/research/lean/ResearchLean/AG/FullGeometryNormalization/SemanticDerivedSelectorGlobalSection.lean
[beta-exactness]: https://github.com/iroha1203/AlgebraicArchitectureTheoryV2/blob/7e68ec6e77ef0249ede6a4c875715cfaf1cb3ee6/research/lean/ResearchLean/AG/FullGeometryNormalization/SemanticDerivedSelectorGlobalComparison.lean
[beta-bottom]: https://github.com/iroha1203/AlgebraicArchitectureTheoryV2/blob/7e68ec6e77ef0249ede6a4c875715cfaf1cb3ee6/research/lean/ResearchLean/AG/FullGeometryNormalization/SemanticDerivedSelectorGlobalBottomReflection.lean
