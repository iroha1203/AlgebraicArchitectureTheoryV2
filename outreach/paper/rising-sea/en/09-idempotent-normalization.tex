...
A normalization is idempotent when aligning something that has already been aligned once more to
the standard representation does not change the result.
