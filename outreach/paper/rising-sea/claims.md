...
| F20・1.34後、4.36–4.39 | 任意の状態型・view型を持つlens間の射。put保存からget保存、直和で束ねた操作平方、可逆変更の部分群、任意の隠れ成分写像。 | [RealizationReconstruction/GeneralRelativeLens](https://github.com/iroha1203/AlgebraicArchitectureTheoryV2/blob/7e68ec6e77ef0249ede6a4c875715cfaf1cb3ee6/research/lean/ResearchLean/AG/RealizationReconstruction/GeneralRelativeLens.lean) の `get_comm_of_put_comm`、`operation_square_iff`、`autMulEquivPutGroup`、`getGroup_inf_putGroup`、`productMap`、`boolToPoint_not_injective` |
...
- 原稿 SHA-256: `e027a7d9d7c953bfbf4f8a04514fd9b89d8bc90c0d21e6c82344b1c0b68ddc4d`。
...
| C4-13 | 定義4.36–例4.39 | 三法則を持つlens、一般の状態・view写像、同じ状態写像の再利用 | [GeneralRelativeLens][c4-lens]、第1章の定義1.32・命題1.34・例1.35・定義1.42 | getとputを直和写像に束ね、共有されたhとh×uによる一つの平方との同値を証明。第一・第二法則から更新保存が読取り保存を含意することを原稿内で導出し、可逆な組の共通部分がput保存群に等しいことを示す。非単射の意味保存射も保持 |
...
| READMEに定めた要旨〜結び（要旨・序論・準備節・第1〜8章・Related Work・結び）の結合原稿 | `db192328e997ca672555f221c6b6ce15eda19232510aff8a52d7d1751e527739` |
