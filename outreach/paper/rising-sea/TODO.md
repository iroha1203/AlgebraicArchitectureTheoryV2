...
- [ ] 06 第3章 標準解像度と診断不変性 — [日本語原稿](ja/06-resolution-invariance.md)とコードレビューへの応用可能性の追記を人間が確認し、PR作成を承認。一次資料・有限例・数式構文・ローカル表示を確認済み。GitHub表示確認とClaudeレビューの対象commit・結果はPRに記録する。
