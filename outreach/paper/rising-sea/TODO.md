...
**日本語原文17パートの執筆・レビュー → 日本語版全体の確認 → 英訳・TeX化 → 投稿前確認・公開**
の順に進める。
...
- [ ] 日本語原稿で共用する記号・用語・訳語、定義・定理・図表・引用の参照方法を定め、準備節へ記す。
...
各項目は、執筆、一次資料との照合、Claude との PR 上でのレビューと修正を終えたら
...
- [ ] 11 第8章 表示・局所再構成・有限決定性 — `ja/11-local-reconstruction.md`
...
- [ ] 定義・記号・訳語、定理番号、相互参照、本文と付録の重複を整える。
...
- [ ] 日本語原文とのパート対応を保って英語 TeX 原稿へ翻訳し、`main.tex` から組み立てる。References は確認済みの書誌を `.bib` に移す。
- [ ] 投稿言語、本文・書誌・図の編集元を README に明記する。
- [ ] [paper tools](../_tools/README.md)に従い、`paper.json` に入力ファイルと固定ビルド環境を設定する。
- [ ] 日英を照合し、量化・仮定・結論・証明、定理番号、数式、数値、図表、引用の対応を確認する。内容変更は両版へ反映する。
...
レビュー後に変更した箇所は、影響する主張・文献・日英対応・組版を再確認する。
