...
- [ ] 07 第4章 輸送と合成の整合性 — [日本語初稿](ja/07-transport-coherence.md)を作成。一次資料との照合、有限例の検算、数式構文とローカル表示を確認し、導入とまとめの注文APIの例を加えて人間の原稿確認を終えた。GitHub上の表示確認とClaudeの独立レビューはPR段階で行う。
