...
を与える。従って命題1.37により、これらの有限状態・辺写像・観測を持つ実現
$`(X,o)`$ が一意に定まる。
...
両方のdecoderは圏同値であり、系8.25の原始読取りとの合成
...
従って、これらの反例を適用する際には、モデルにおける無限集合、許す変更の範囲、読取り方式を指定する必要がある。
