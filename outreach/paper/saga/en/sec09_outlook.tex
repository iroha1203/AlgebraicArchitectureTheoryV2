...
This raising of the water level has two distinctive features. First,
...
AAT is a theory of statics: it treats the consistency of an architecture at a
...
the decision of what deserves protection --- indeed, it is refined into
precisely that. The diagnosis staircase of Section~\ref{sec:7} (nonzero residual
...
SAGA is the first instance traversing the mathematics, formalization,
and measurement stages of this chain in a single theorem. The provenance discipline this paper has fixed (classifying
