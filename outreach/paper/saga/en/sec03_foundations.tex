...
described in Appendix~\ref{app:C2}. Inside AAT, Atoms are the given generators.
...
morphisms are reinterpretations $g:W'\to W$ (restriction, projection,
...
\begin{definition}[presheaf and sheaf condition]\label{def:presheaf}\sloppy
...
(\S\ref{sec:34}) and computation with
...
global gluing. Fixed as the cover, inputs 1--8, and the sheaf
hypothesis of stage (iii) of Theorem~\ref{thm:central} \\
\addlinespace
generated &
