...
MeasurementProfile), together with a repair plan that declares only
the selected complex (\S\ref{sec:74}). This section first presents a full SAGA diagnosis
...
of three conventions) and the absence of a face (triple overlap) filling
...
the witness bindings (law surface), and the repaired variant.
