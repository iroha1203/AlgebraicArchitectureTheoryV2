...
per-artifact input contract, the definition of the computation, the
kinds of conditions behind the conclusions, and the reproduction procedure ---
is fixed in
Appendix~\ref{app:C}.
...
observation artifacts (\S\ref{sec:72}, Appendix~\ref{app:C2}).
...
Appendix~\ref{app:C2}), no nonzero residual can be erected on an edge
...
row by the condition matrix of Appendix~\ref{app:C2}, and the
reproduction procedure by Appendix~\ref{app:C3}.
...
ArchSig's reading stays at boundary membership (Appendix~\ref{app:C2}). The
...
the condition matrix of Appendix~\ref{app:C2}. No correspondence transporting
