...
Release tag \code{saga-paper-v1.0.0}; version DOI
\href{https://doi.org/10.5281/zenodo.21603762}{10.5281/zenodo.21603762};
ArchSig tool version \code{0.5.4}; artifact schema versions
...
(\code{git clone --branch saga-paper-v1.0.0}) and run, from the
