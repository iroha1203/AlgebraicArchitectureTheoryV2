...
- **保護ファイル**: ユーザーの明示的な指示なしに `docs/aat/mathematical_theory/`、`docs/sft/software_field_theory.md`、`docs/sft/aat_interface.md` を更新しない。
...
| 領域 | 場所 | 役割 |
| --- | --- | --- |
| Lean / AAT | `Formal/Arch`, `Formal.lean`, `Main.lean` | AAT / SFT の形式化(定義・定理・例) |
