...
Do not edit files. Stay anchored in the assigned perspective. If a cross-perspective suspicious signal is clearly visible from that perspective, report it as such, but do not perform a full review of the other perspective or infer conclusions outside your evidence.
```
