...
- `target theorem completion criteria`: 何をもって証明完了と判定するか。原則は sorry なし Lean proof、対象 declaration の axiom audit、G3.5 同期、G4 監査、G5 レビュー、G6 target completion 判定である。
