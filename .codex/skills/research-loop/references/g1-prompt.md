...
Read only: research/goals/<goal-id>.md, research/ideas/TEMPLATE.md, research/reports/<goal-id>.md if it exists, the tracking Issue summary supplied by the main agent, and source references explicitly named by the GOAL.
