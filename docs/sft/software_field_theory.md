...
evidence boundaries、non-conclusions を含む `archsig-analysis-packet-v0` を作る。これは
bounded local AAT state / FieldSig handoff であり、FieldSig が SFT 側で operation support、
