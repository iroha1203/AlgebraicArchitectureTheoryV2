...
AAT 側では、ArchSig は `archsig-analysis-packet-v0` として molecule readings、
...
SFT 側では、FieldSig が `archsig-analysis-packet-v0` を局所 AAT algebra state として読み、
...
FieldSig handoff tooling:
  archsig-analysis-packet-v0 refs
