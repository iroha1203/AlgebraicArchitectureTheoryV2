...
| Architecture operations | `FeatureExtension` | feature addition を first-class operation として扱う最小 schema と、静的 split extension 条件を扱う。 |
...
| `Formal/Arch/Operations` | `FeatureExtension` |
