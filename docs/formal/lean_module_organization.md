...
| Architecture operations | `FeatureExtension`, `ArchitecturePath`, `Flatness` | feature addition を first-class operation として扱う最小 schema、有限 evolution path / path homotopy skeleton、静的 split extension 条件、coverage-aware three-layer flatness predicate を扱う。 |
