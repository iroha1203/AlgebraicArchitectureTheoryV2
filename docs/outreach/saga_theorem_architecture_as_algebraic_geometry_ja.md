...
- その AAT で、**SAGA 定理**(SAGA Grounding Theorem)と呼ぶ定理を Lean 4 で証明しました。アーキテクチャ意味論の側で育てた `H^1` と、Atom から生成された site 上の本物の Čech `H^1` が一致する、という比較定理です。
...
![代数幾何を地図として読む挿絵](./assets/aat_ag_saga_jp.png)
