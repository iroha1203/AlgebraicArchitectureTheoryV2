...
私たちの[リポジトリ](https://github.com/iroha1203/AlgebraicArchitectureTheoryV2)で開発している、コードベースや PR の変化を複数の軸で読むための観測枠組みを指します。依存、境界、抽象化、実行時露出、意味のずれ、テストでの観測しやすさなどを、一つの点数ではなく複数の特徴量として扱います。
