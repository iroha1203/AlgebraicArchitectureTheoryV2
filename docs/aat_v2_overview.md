...
| matrix bridge | 行列的伝播 | `nilpotencyIndex`, `rho(A)` | executable / proved bridge for `nilpotencyIndex`; proved `DAG -> rho(A)=0`; future proof obligation for cycle positivity |
