...
| [#279](https://github.com/iroha1203/AlgebraicArchitectureTheoryV2/issues/279) | Architecture Calculus laws の bounded theorem package | `future proof obligation` | bounded universe、compatibility、coverage、observation equivalence を明示する theorem package として扱う。 |
| [#277](https://github.com/iroha1203/AlgebraicArchitectureTheoryV2/issues/277) | repair termination / synthesis / no-solution certificate soundness | `future proof obligation` | repair step decreases とは分離し、termination と synthesis soundness は追加前提つきの別 theorem package として扱う。 |
| [#278](https://github.com/iroha1203/AlgebraicArchitectureTheoryV2/issues/278) | ArchitectureEvolution transition theorem package | `future proof obligation` | finite transition path と invariant preservation の発展形として扱う。 |
| [#280](https://github.com/iroha1203/AlgebraicArchitectureTheoryV2/issues/280) | AnalyticRepresentation bridge と representation strength | `future proof obligation` | analytic layer への bridge と strength ordering を、structural theorem とは別 package として扱う。 |
