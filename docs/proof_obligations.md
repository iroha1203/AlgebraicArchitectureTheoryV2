...
Lean では `ArchitectureLawModel.signatureOf` が concrete count で埋めた
...
complete witness coverage と required axis exactness を構成した。最終 theorem
`architectureLawful_iff_requiredSignatureAxesAvailableAndZero` は、
`ArchitectureLawful X` と
