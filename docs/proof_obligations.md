...
| `OperationRoleSchema` | Schema / carrier + accessor theorem + preserve role bridge | role tag と generated obligation の対応、discharge wrapper、preserve role を selected invariant preservation として読む bridge。 | role tag だけからの reflection、improvement、localization、translation、transfer、assumption discharge。非 preserve role の bounded conclusion は Issue [#411](https://github.com/iroha1203/AlgebraicArchitectureTheoryV2/issues/411) で扱う。 |
