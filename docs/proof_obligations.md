...
| Runtime propagation | `defined only` / `proved` for 0/1 runtime graph zero bridge; tooling theorem metadata bridge; policy-aware coverage is separate | [runtimePropagation 設計](design/runtime_propagation_design.md), [Lean theorem index](lean_theorem_index.md#finite-universe--bridge-theorems), Issue [#522](https://github.com/iroha1203/AlgebraicArchitectureTheoryV2/issues/522) |
