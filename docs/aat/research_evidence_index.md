...
| `ChartCircuitLocus.mem_support_chartResponseCokernel_iff_exists_supportMinimalCircuit` | `AG/QualitySurface/IntrinsicLawResponseCircuitDescent/ChartCircuitLocus.lean` | - | actual chart response-cokernel support所属とtarget-containing support-minimal residue-field circuitの存在を双方向に証明 | なし | G-aat-quality-surface-08 Cycle 14 | unported | #3557 |
| `ChartCircuitLocus.chartCircuitLocus_eq_support` | `AG/QualitySurface/IntrinsicLawResponseCircuitDescent/ChartCircuitLocus.lean` | - | actual labeled responsesから定義したselected chart circuit locusとresponse-cokernel supportの集合等式を証明 | なし | G-aat-quality-surface-08 Cycle 14 | unported | #3557 |
