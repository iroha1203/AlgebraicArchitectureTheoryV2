...
| PRD-2 | AC5 | 補題7.2A は `WitnessClosureCover` package assumptions に相対化される。 | `packaged (assumption-relative)` | `Formal/AG/Site/Adequate.lean`, `witnessClosureCover_uAdequate`; 詳細は II-1。 |
