...
| PRD-2 | AC11 | finite model examples は singleton / selected finite-poset fixture に相対化される。 | `packaged (assumption-relative)` | `Formal/AG/Examples/FiniteModel.lean`, `siteSingletonCover_uAdequate`; 詳細は II-5。 |
