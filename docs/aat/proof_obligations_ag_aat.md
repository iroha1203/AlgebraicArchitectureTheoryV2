...
| PRD-6 | AC10 | `pi1^AAT` universal property needs `PresentedGroup` hardening. | `packaged (assumption-relative)` | `Formal/AG/SingularityMonodromyStack/OperationHomotopy.lean`; 詳細は VI-2。 |
