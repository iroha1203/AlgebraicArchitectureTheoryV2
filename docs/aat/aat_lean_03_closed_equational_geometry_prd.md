...
AC1〜AC44、review、CI、merge、runtime status同期が完了し、repository-wideのlive referenceがzeroになった後、
contentを変更せず`git mv`でarchiveする。archive後にAC45を判定し、archive文書を現行source of truthとして参照しない。
