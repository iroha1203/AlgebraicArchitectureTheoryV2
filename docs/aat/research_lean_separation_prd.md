...
- Research成果と移植状況: `docs/aat/research_evidence_index.md`、
  `Formal/AG/Research/**`、`research/reports/**`
...
- `docs/aat/research_evidence_index.md` の全 `ported` 行に加え、
  `Formal/AG/Research/**`、reports、本体側のResearch対応記述から
...
- `docs/aat/guideline.md`、`docs/aat/lean_quality_standard.md`、evidence index、
  `Formal/AG/Research/**`、reportsの恒久規律を更新する。
...
- [ ] **AC6**: evidence index、`Formal/AG/Research/**`、reports、本体側対応記述から作った
