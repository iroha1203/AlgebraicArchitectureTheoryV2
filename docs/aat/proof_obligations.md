...
| [研究ループ theorem status 台帳](proof_obligations_research.md) | `Formal/AG/Research`、`research/goals/`、target-theorem / research-loop の成果 | 研究ループで固定された theorem package、tracking issue、最終 review status を確認する。 |
...
- `Formal/AG` の AG 版 AAT PRD / 本文ラベル対応を更新した場合は、[proof_obligations_ag_aat.md](proof_obligations_ag_aat.md) を更新する。
- `Formal/AG/Research` や `research/goals/` の target-theorem / research-loop 成果を更新した場合は、[proof_obligations_research.md](proof_obligations_research.md) を更新する。
