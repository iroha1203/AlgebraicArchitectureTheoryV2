...
| proved | repair-relation soundness、SAGA presentation exactness、`Phi` の同型性、微分可換性、cocycle / coboundary 保存、`H^1` 同型、residual class 対応、零類と actual global repair の同値 |
