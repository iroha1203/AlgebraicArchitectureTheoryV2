...
Part3 の flatness theorem は、選ばれた law universe、witness family、signature axes、
...
### 原則 2.3 Obstruction Sheaf Relativity
...
`C_core` と `F` がそれぞれ U-flat であるため、local obstruction ideal はそれぞれ消える。
