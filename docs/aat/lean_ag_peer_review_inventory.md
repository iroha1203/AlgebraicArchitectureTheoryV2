...
| IV-7 | 部分昇格(差し戻し) | concrete `TwoChartGloballyUFlat` 実述語と `BoundaryResidueHypotheses.globallyUFlat` への置換は完了。2チャート soundness と 13.2 基底計算は未完了。#3086 の docs-only closure では完了扱いしない。 | #3100 |
