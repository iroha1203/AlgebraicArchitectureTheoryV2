...
| `AAT.AG.AxiomAudit.semanticRepairTheorem75GeneratedEndToEndFromGeneratedProvenanceInputs` | `AAT.AG.SemanticRepair.lawEquation_constructs_groundedComparisonPacket_fromGeneratedProvenanceInputs` | `propext`, `Classical.choice`, `Quot.sound` |
...
| `AAT.AG.AxiomAudit.semanticRepairExample91GeneratedF2EndToEndFromGeneratedProvenanceInputs` | `AAT.AG.Examples.SemanticRepairPart10.lawfulFiring_generatedF2_endToEndPacket_fromGeneratedProvenanceInputs` | `propext`, `Classical.choice`, `Quot.sound` |
...
| `SemanticRepairLawEquationGeneratedInputs` grounding route | `Formal/AG/LawAlgebra/LawEquation.lean`, `Formal/AG/SemanticRepair/SagaComparison.lean`, `Formal/AG/SemanticRepair/Boundary.lean` | `LawEquationDefectSource`, `DisplayedRequiredLawsHoldOn`, `GeneratedRestrictionEvaluator`, `displayedRequiredLawsHoldOn_constructs_interpret_eq_zero`, `displayedRequiredLawsHoldOn_constructs_restrictionEvaluator`, `interpret_eq_zero_iff_defect_mem_obstructionIdeal`, `interpret_ne_zero_of_defect_notMem_obstructionIdeal`, `obstructionQuotientPresheaf`, `lawEquation_grounding_packet`, `SemanticRepairGeneratedComparisonProvenance`, `SemanticRepairGeneratedEndToEndProvenanceInputs`, `SemanticRepairNativeGeneratedEndToEndProvenanceInputs`, `lawEquation_constructs_groundedComparisonPacket`, `lawEquation_constructs_groundedComparisonPacket_fromGeneratedProvenanceInputs`, `lawEquation_constructs_groundedComparisonPacket_fromNativeGeneratedProvenanceInputs`, `displayedRequiredLawsHoldOn_constructs_generatedSourceC0_zeroPackage` | law equation は degree-zero contribution と generated quotient coefficient surface を供給する。#3102 completion route は coefficient/cover/sheaf provenance に加えて、degree-wise carrier maps と4本の differential law から `toH1Comparison` を再構成する。H1 comparison や prepackaged cochain realization は theorem 7.5 の material premise にしない。ただし law equation だけから任意の comparison provenance を無条件生成する claim はしない。 |
| `SemanticRepairLawEquationEndToEndInstance` | `Formal/AG/Examples/SemanticRepairPart10.lean`, `Formal/AG/AxiomAudit.lean` | `generatedF2QuotientPresheaf_nontrivial`, `generatedF2QuotientIsSheaf`, `generatedF2ComparisonProvenance`, `generatedF2EndToEndProvenanceInputs`, `generatedLawQuotientPresheaf`, `generatedLawQuotientIsSheaf`, `generatedLawQuotientObstructionSheaf`, `generatedLawComparisonProvenance`, `generatedLawNativeEndToEndProvenanceInputs`, `lawfulFiring_generatedF2_endToEndPacket_fromGeneratedProvenanceInputs`, `lawfulFiring_generatedLawQuotient_endToEndPacket_fromNativeGeneratedProvenanceInputs`, `AxiomAudit.semanticRepairExample91GeneratedF2EndToEndFromGeneratedProvenanceInputs`, `AxiomAudit.semanticRepairExample91GeneratedLawQuotientEndToEndFromNativeGeneratedProvenanceInputs`, `lawfulFiring_generatedSourceC0Zero`, `circleNerve_nonzeroClassTransfer_packet` | 例9.1 lawful zero firing は native `lawEquationCore.obstructionQuotientPresheaf` route で発火し、completion witness は `generatedLawNativeEndToEndProvenanceInputs` から theorem 7.5 を発火する。旧 `generatedLawNativeEndToEndInputs` / `generatedLawH1Realization` route は互換 evidence として残すが、完了根拠には使わない。legacy `PUnit` singleton route も完了根拠にしない。例9.2 nonzero circle witness は supplied circle-nerve simplicial data に相対化する。 |
