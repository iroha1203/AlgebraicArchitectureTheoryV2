...
| `AAT.AG.AxiomAudit.semanticRepairTheorem75GeneratedBoundaryGroundedResearchConjuncts` | `AAT.AG.SemanticRepair.lawEquation_constructs_groundedResearchConjuncts_fromSource` | `propext`, `Classical.choice`, `Quot.sound` |
| `AAT.AG.AxiomAudit.semanticRepairTheorem75StandardFinitePosetSourceC0DifferentialGroundedResearchConjuncts` | `AAT.AG.SemanticRepair.StandardFinitePosetGeneratedBoundary.lawEquation_constructs_groundedResearchConjunctsWithSourceC0DifferentialZero_fromStandardFinitePosetSource` | `propext`, `Classical.choice`, `Quot.sound` |
...
| `AAT.AG.AxiomAudit.semanticRepairExample91GeneratedLawCircleSingleWitnessNativeEndToEndPacket` | `AAT.AG.Examples.SemanticRepairPart10.generatedLawCircle_singleWitness_nativeEndToEndPacket` | `propext`, `Classical.choice`, `Quot.sound` |
| `AAT.AG.AxiomAudit.semanticRepairExample91GeneratedLawCircleSingleWitnessWithStandardSourceC0ResearchConjuncts` | `AAT.AG.Examples.SemanticRepairPart10.generatedLawCircle_singleWitness_withStandardSourceC0ResearchConjuncts` | `propext`, `Classical.choice`, `Quot.sound` |
| `AAT.AG.AxiomAudit.semanticRepairExample91GeneratedLawCircleGeneratedBoundaryPacketFromPrimitive` | `AAT.AG.Examples.SemanticRepairPart10.lawfulFiring_generatedLawCircleQuotient_generatedBoundaryPacket_fromPrimitive` | `propext`, `Classical.choice`, `Quot.sound` |
| `AAT.AG.AxiomAudit.semanticRepairExample91GeneratedLawStandardSourceC0ResearchConjuncts` | `AAT.AG.Examples.SemanticRepairPart10.lawfulFiring_generatedLawStandardSourceC0ResearchConjuncts` | `propext`, `Classical.choice`, `Quot.sound` |
...
| `SemanticRepairLawEquationEndToEndInstance` | `Formal/AG/Site/FinitePosetGeometry.lean`, `Formal/AG/SemanticRepair/LawEquationGeneratedPair.lean`, `Formal/AG/Examples/SemanticRepairPart10.lean`, `Formal/AG/AxiomAudit.lean` | `lawEquationCoverBridge`, `lawEquationCurrentG06InputSurface`, `lawEquationCompleteRepairSupport`, `lawEquationCompleteSupportOf`, `lawEquationCompleteRepairSupport_semanticRepairClosed`, `lawEquationCompleteRepairSupport_componentCoverage_and_faithfulness`, `lawEquationCompleteSupport_componentCovered_of_boundary`, `lawEquationCompleteSupport_componentFaithful_of_boundary`, `coverRelativeCechDataOfComplex`, `coverRelativeAdditiveCechDataOfComplex`, `coverRelativeBoundaryAdditiveDataOfComplex`, `coverRelativeIdentityCochainRealizationOfComplex`, `coverRelativeGeneratedBoundary_additiveH1ZeroOfPrimitive`, `coverRelativeGeneratedBoundary_surfaceH1ZeroOfPrimitive`, `lawEquation_generatedBoundary_lawIndependentConclusions_fromPrimitive`, `Site.FinitePosetCoverGeometry.canonicalTupleOverlapFromOverlap`, `Site.FinitePosetCoverGeometry.canonicalTupleCoverGeometryFromOverlap`, `Site.FinitePosetCoverGeometry.constructs_canonicalTupleCoverGeometry_from_overlap`, `StandardFinitePosetGeneratedBoundary.standardDifferential_add`, `StandardFinitePosetGeneratedBoundary.coverRelativeComplexOfStandardFinitePosetLaw`, `StandardFinitePosetGeneratedBoundary.canonicalTupleGeneratedBoundaryObstructionSheaf`, `StandardFinitePosetGeneratedBoundary.canonicalTupleGeneratedBoundaryLaw`, `StandardFinitePosetGeneratedBoundary.canonicalTupleGeneratedBoundaryComplex`, `StandardFinitePosetGeneratedBoundary.lawEquationRegime`, `StandardFinitePosetGeneratedBoundary.lawEquationStandardComplex`, `StandardFinitePosetGeneratedBoundary.lawEquationCechComplex`, `StandardFinitePosetGeneratedBoundary.lawEquationCoverRelativeCover`, `lawEquation_constructs_generatedPair_groundedComparisonPacket_fromCoverRelativeComplex`, `lawEquation_constructs_generatedBoundary_groundedComparisonPacket_fromPrimitive`, `lawEquation_constructs_generatedBoundary_groundedComparisonPacket_fromFinitePosetComparisonPrimitive`, `StandardFinitePosetGeneratedBoundary.lawEquation_constructs_generatedBoundary_groundedComparisonPacket_fromStandardFinitePosetPrimitive`, `StandardFinitePosetGeneratedBoundary.lawEquation_constructs_generatedBoundary_groundedComparisonPacket_fromCanonicalTuplePrimitive`, `StandardFinitePosetGeneratedBoundary.lawEquation_constructs_generatedBoundary_groundedComparisonPacket_fromLawEquationSpinePrimitive`, `StandardFinitePosetGeneratedBoundary.lawEquation_constructs_generatedBoundary_groundedComparisonPacket_fromOverlapGeneratedSpinePrimitive`, `toCoverRelativeBaseRestrictionSource`, `displayedRequiredLawsHoldOn_constructs_primitive_realizes_displayedInterpretations`, `generatedLawQuotientPresheaf`, `generatedLawQuotientIsSheaf`, `generatedLawQuotientObstructionSheaf`, `generatedLawQuotientOne_ne_zero`, `generatedLawQuotientNontrivial`, `generatedLawCircleCoverRelativeComplex`, `generatedLawCircleResidual_not_coboundary`, `generatedLawCircleSemanticH1_nonzero`, `generatedLawCircle_singleWitness_nativeEndToEndPacket`, `generatedLawCircle_singleWitness_withStandardSourceC0ResearchConjuncts`, `generatedLawFinitePosetCoverGeometry`, `generatedLawStandardSourceC0Complex`, `generatedLawStandardBodySource`, `generatedLawStandardSourceC0BoundaryAdditiveData`, `lawfulFiring_generatedLawStandardSourceC0ResearchConjuncts`, `lawfulFiring_generatedLawCircleQuotient_endToEndPacket_fromConstructedInputs`, `lawfulFiring_generatedLawCircleQuotient_generatedBoundaryPacket_fromPrimitive`, `AxiomAudit.semanticRepairTheorem75GeneratedPairGroundedComparisonPacket`, `AxiomAudit.semanticRepairTheorem75GeneratedBoundaryGroundedComparisonPacket`, `AxiomAudit.semanticRepairTheorem75GeneratedBoundaryLawIndependentConclusions`, `AxiomAudit.semanticRepairTheorem75CompleteSupportClosure`, `AxiomAudit.semanticRepairTheorem75CompleteSupportComponentFaithfulness`, `AxiomAudit.semanticRepairTheorem75FinitePosetGeneratedBoundaryGroundedComparisonPacket`, `AxiomAudit.semanticRepairTheorem75StandardFinitePosetGeneratedBoundaryGroundedComparisonPacket`, `AxiomAudit.semanticRepairTheorem75CanonicalTupleGeneratedBoundaryGroundedComparisonPacket`, `AxiomAudit.semanticRepairTheorem75LawEquationSpineGeneratedBoundaryGroundedComparisonPacket`, `AxiomAudit.semanticRepairTheorem75OverlapGeneratedLawEquationSpineGroundedComparisonPacket`, `AxiomAudit.semanticRepairExample91GeneratedLawQuotientNontrivial`, `AxiomAudit.semanticRepairExample91GeneratedLawCircleSemanticH1Nonzero`, `AxiomAudit.semanticRepairExample91GeneratedLawCircleQuotientEndToEndFromConstructedInputs`, `AxiomAudit.semanticRepairExample91GeneratedLawCircleSingleWitnessNativeEndToEndPacket`, `AxiomAudit.semanticRepairExample91GeneratedLawCircleSingleWitnessWithStandardSourceC0ResearchConjuncts`, `AxiomAudit.semanticRepairExample91GeneratedLawCircleGeneratedBoundaryPacketFromPrimitive`, `AxiomAudit.semanticRepairExample91GeneratedLawStandardSourceC0ResearchConjuncts`, `lawfulFiring_generatedSourceC0Zero`, `circleNerve_nonzeroClassTransfer_packet` | #3102 の body evidence は、Research import を使わず、Research 側 `completeRepairSupport` を `lawEquationCompleteRepairSupport` として AG 抽象 projection 上へ蒸留し、complete-support closure から component coverage と residual faithfulness を生成する。AG 本体型で cover-relative complex `K` から bounded Cech data、additive laws、identity cochain realization、H1 comparison を生成する `lawEquation_constructs_generatedPair_groundedComparisonPacket_fromCoverRelativeComplex` に置く。追加で `lawEquation_generatedBoundary_lawIndependentConclusions_fromPrimitive` は displayed-law premise なしで theorem 7.3 conclusion group、generated H1 comparison、bounded/surface H¹ zero、cover-relative H¹ zero を構成する。`lawEquation_constructs_generatedBoundary_groundedComparisonPacket_fromPrimitive` は residual を `K.d 0 primitive` として固定し、law-independent theorem と `LawEquationDefectSource.lawEquation_grounding_packet` の degree-zero law-dependent conclusions を合成する。`lawEquation_constructs_generatedBoundary_groundedComparisonPacket_fromFinitePosetComparisonPrimitive` は `K`、zero one-cochain、support witnesses を入力から消す。さらに `StandardFinitePosetGeneratedBoundary.coverRelativeComplexOfStandardFinitePosetLaw` と `...fromStandardFinitePosetPrimitive` は `FinitePosetCechComparisonData` も要求せず、standard finite-poset law/face data から cover-relative complex を構成する。`Site.FinitePosetCoverGeometry.canonicalTupleCoverGeometryFromOverlap` は site overlap と cover inclusion から canonical tuple geometry を生成する。`StandardFinitePosetGeneratedBoundary.lawEquationRegime` / `lawEquationStandardComplex` / `lawEquationCechComplex` は研究ループ側 spine と同名の AG 本体定義であり、native law-equation quotient coefficient と generated canonical tuple geometry から finite-poset regime、standard complex、cover-relative complex を生成する。`...fromOverlapGeneratedSpinePrimitive` はこの spine から theorem 7.5 generated-boundary route を発火し、Research theorem を呼ばない。#3102 の単一 witness は `generatedLawCircle_singleWitness_withStandardSourceC0ResearchConjuncts` であり、native standard source-C0 route も同じ theorem で同じ generated coefficient から発火する。native `lawEquationCore.obstructionQuotientPresheaf` / `obstructionQuotientCoefficient` 由来の同じ generated quotient surface 上で、生成 quotient `ZMod 4 ⧸ span{2}` の `Nontrivial`、非零 H¹、非零 locus support、generated-complex route 経由の theorem 7.5 firing を束ねる。`lawfulFiring_generatedLawCircleQuotient_generatedBoundaryPacket_fromPrimitive` は同じ coefficient surface 上の別 residual に対する generated-boundary/H¹-zero route の発火確認であり、この単一 witness の非零 H¹ claim と同一視しない。`generatedLawQuotientObstructionSheaf` は `ObstructionSheaf.ofAddCommGrpValued lawEquationCore.obstructionQuotientCoefficient generatedLawQuotientIsSheaf` から生成する。legacy `PUnit` singleton route と generated `F₂` route は completion evidence にしない。 |
