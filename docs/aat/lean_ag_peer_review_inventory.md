...
| `SemanticRepairLawEquationGeneratedInputs` grounding route | `Formal/AG/LawAlgebra/LawEquation.lean`, `Formal/AG/SemanticRepair/SagaComparison.lean`, `Formal/AG/SemanticRepair/Boundary.lean` | `LawEquationDefectSource`, `DisplayedRequiredLawsHoldOn`, `GeneratedRestrictionEvaluator`, `displayedRequiredLawsHoldOn_constructs_interpret_eq_zero`, `displayedRequiredLawsHoldOn_constructs_restrictionEvaluator`, `interpret_eq_zero_iff_defect_mem_obstructionIdeal`, `interpret_ne_zero_of_defect_notMem_obstructionIdeal`, `obstructionQuotientPresheaf`, `lawEquation_grounding_packet`, `SemanticRepairGeneratedEndToEndInputs`, `lawEquation_constructs_groundedComparisonPacket`, `lawEquation_constructs_groundedComparisonPacket_fromGeneratedInputs`, `displayedRequiredLawsHoldOn_constructs_generatedSourceC0_zeroPackage` | law equation は degree-zero contribution と generated quotient coefficient surface を供給し、H1 / descent / global coherence は theorem 7.3 側の selected certificate と generated-input record に任せる。 |
| `SemanticRepairLawEquationEndToEndInstance` | `Formal/AG/Examples/SemanticRepairPart10.lean`, `Formal/AG/AxiomAudit.lean` | `generatedF2QuotientPresheaf_nontrivial`, `generatedF2QuotientIsSheaf`, `generatedF2H1Realization`, `generatedF2EndToEndInputs`, `lawfulFiring_generatedF2_endToEndPacket_fromGeneratedInputs`, `AxiomAudit.semanticRepairExample91GeneratedF2EndToEndFromGeneratedInputs`, `lawfulFiring_generatedSourceC0Zero`, `circleNerve_nonzeroClassTransfer_packet` | 例9.1 lawful zero firing は #3102 の completion witness として generated `F₂` quotient coefficient route で theorem 7.5 を発火する。legacy `PUnit` singleton route は残すが完了根拠にしない。例9.2 nonzero circle witness は supplied circle-nerve simplicial data に相対化する。 |
