...
| `AAT.AG.AxiomAudit.partVIDecompositionEffectiveDescentPositive` | `AAT.AG.FiniteModel.SingularityMonodromyStackPart6.toyEffectiveDescent_positive` | none |
| `AAT.AG.AxiomAudit.partVIDecompositionEffectiveDescentNegative` | `AAT.AG.FiniteModel.SingularityMonodromyStackPart6.toyEffectiveDescent_negative` | none |
...
| `AAT.AG.AxiomAudit.partVIDecompositionGlobalCanonicalNegative` | `AAT.AG.FiniteModel.SingularityMonodromyStackPart6.toyGlobalCanonicalDecomposition_negative` | none |
| `AAT.AG.AxiomAudit.partVIDecompositionGlobalCanonicalVanishesClass` | `AAT.AG.FiniteModel.SingularityMonodromyStackPart6.toyGlobalCanonicalDecomposition_vanishes_class` | none |
| `AAT.AG.AxiomAudit.partVIDecompositionGerbeClassEqualsComputedLocalClass` | `AAT.AG.FiniteModel.SingularityMonodromyStackPart6.toyGerbeClass_eq_computed_local_class` | none |
| `AAT.AG.AxiomAudit.partVIDecompositionGerbeClassComputedNonzero` | `AAT.AG.FiniteModel.SingularityMonodromyStackPart6.toyGerbeClassFromLocalData_nonzero` | none |
...
| `AAT.AG.AxiomAudit.partVIDecompositionSoundnessFromLocalData` | `AAT.AG.FiniteModel.SingularityMonodromyStackPart6.toyNoCanonicalDecomposition_soundness_from_local_data` | none |
...
| `AAT.AG.AxiomAudit.semanticRepairTheorem75NativeGeneratedEndToEndFromNativeGeneratedProvenanceInputs` | `AAT.AG.SemanticRepair.lawEquation_constructs_groundedComparisonPacket_fromNativeGeneratedProvenanceInputs` | `propext`, `Classical.choice`, `Quot.sound` |
| `AAT.AG.AxiomAudit.semanticRepairExample91GeneratedLawQuotientEndToEndFromNativeGeneratedProvenanceInputs` | `AAT.AG.Examples.SemanticRepairPart10.lawfulFiring_generatedLawQuotient_endToEndPacket_fromNativeGeneratedProvenanceInputs` | `propext`, `Classical.choice`, `Quot.sound` |
...
| `SemanticRepairLawEquationRealization` §5 | `Formal/AG/LawAlgebra/LawEquation.lean` | `SemanticLawEquationWitnessIdealCore`, `lawWitnessIdeal`, `selectedLawWitnessIdealFamily`, `obstructionIdeal`, `lawWitnessIdeal_le_obstructionIdeal`, `map_lawWitnessIdeal_le`, `restrictionCompatible`, `map_obstructionIdeal_le`, `obstructionQuotientRestrict`, `obstructionQuotientCoefficient`, `quotient_mk_eq_zero_iff_mem_obstructionIdeal`, `generatedCoefficient_package` | law-equation generated coefficient は explicit restriction compatibility に相対化する。一般 quotient sheaf 生成は主張しない。 |
| `SemanticRepairLawEquationNativeGeneratedInputs` grounding route | `Formal/AG/LawAlgebra/LawEquation.lean`, `Formal/AG/SemanticRepair/SagaComparison.lean`, `Formal/AG/SemanticRepair/Boundary.lean` | `LawEquationDefectSource`, `DisplayedRequiredLawsHoldOn`, `GeneratedRestrictionEvaluator`, `displayedRequiredLawsHoldOn_constructs_interpret_eq_zero`, `displayedRequiredLawsHoldOn_constructs_restrictionEvaluator`, `interpret_eq_zero_iff_defect_mem_obstructionIdeal`, `interpret_ne_zero_of_defect_notMem_obstructionIdeal`, `obstructionQuotientPresheaf`, `obstructionQuotientCoefficient`, `lawEquation_grounding_packet`, `SemanticRepairGeneratedComparisonProvenance`, `SemanticRepairNativeGeneratedEndToEndProvenanceInputs`, `lawEquation_constructs_groundedComparisonPacket`, `lawEquation_constructs_groundedComparisonPacket_fromNativeGeneratedProvenanceInputs`, `displayedRequiredLawsHoldOn_constructs_generatedSourceC0_zeroPackage` | law equation は degree-zero contribution と native generated quotient coefficient surface を供給する。任意 `F` へ再包装する generated end-to-end route は Lean 本体・AxiomAudit・台帳の completion surface から削除した。#3102 は完了扱いせず、cochain comparison provenance の単一 witness 化などの残 AC は issue 側へ残す。 |
| `SemanticRepairLawEquationEndToEndInstance` | `Formal/AG/Examples/SemanticRepairPart10.lean`, `Formal/AG/AxiomAudit.lean` | `generatedF2QuotientPresheaf_nontrivial`, `generatedF2QuotientIsSheaf`, `generatedF2ComparisonProvenance`, `generatedLawQuotientPresheaf`, `generatedLawQuotientIsSheaf`, `generatedLawQuotientObstructionSheaf`, `generatedLawComparisonProvenance`, `generatedLawNativeEndToEndProvenanceInputs`, `lawfulFiring_generatedLawQuotient_endToEndPacket_fromNativeGeneratedProvenanceInputs`, `AxiomAudit.semanticRepairExample91GeneratedLawQuotientEndToEndFromNativeGeneratedProvenanceInputs`, `lawfulFiring_generatedSourceC0Zero`, `circleNerve_nonzeroClassTransfer_packet` | 例9.1 lawful zero firing は native `lawEquationCore.obstructionQuotientPresheaf` route で発火する。旧 arbitrary-`F` generated route と generated `F₂` theorem-7.5 firing は completion evidence から削除した。legacy `PUnit` singleton route も完了根拠にしない。例9.2 nonzero circle witness は supplied circle-nerve simplicial data に相対化する。 |
