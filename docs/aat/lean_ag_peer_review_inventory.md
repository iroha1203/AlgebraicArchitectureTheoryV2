...
| `SemanticRepairLawEquationEndToEndInstance` | `Formal/AG/SemanticRepair/LawEquationGeneratedPair.lean`, `Formal/AG/Examples/SemanticRepairPart10.lean`, `Formal/AG/AxiomAudit.lean` | R1 common-restriction realization / negative rejection、R2 restriction-level evaluator、R4 generated-cover provenance、R3 actual displayed-source C0 Cech zero、R5 rich material-input / atom-supported finite-free ten-conclusion final theorem、R6 separate circle-nonzero / singleton-standard example package | `lawEquation_constructs_groundedComparisonPacket_finiteFree` は source、law、K、generated cover、realization、comparison、residual/H1-zeroを内部生成し、1–3だけが`hholds`を使う。`generatedLaw_sharedCoefficient_separateCircleNonzero_andSingletonStandardPackets` は同じgenerated coefficientを共有するFin-3 circle非零residualとPUnit singleton generated-zero packetを別fieldに保持する。同じcoefficientを同じcomplex/residualと解釈しない。AxiomAuditはR1–R5のheadline、bridge、negative theoremとR6 examplesを直接監査する。 |
