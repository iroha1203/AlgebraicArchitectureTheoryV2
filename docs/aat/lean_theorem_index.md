...
| `GeneratedGraphRank`, `GeneratedGraphRank.strictLayering`, `GeneratedGraphRank.walkAcyclic`, `GeneratedRuntimeGraphRank`, `GeneratedRuntimeGraphRank.strictLayering`, `GeneratedRuntimeGraphRank.walkAcyclic`, `GeneratedArchitectureLawModel`, `GeneratedArchitectureLawModel.ofGraphRank`, `GeneratedArchitectureLawModel.toArchitectureLawModel`, `GeneratedArchitectureLawModel.generatedSignatureOf`, `signatureOfGenerated`, `GeneratedArchitectureLawModel.generatedDesignLaw`, `GeneratedArchitectureLawModel.generatedAATCore`, `GeneratedArchitectureLawModel.generatedZeroCurvaturePackage` | `structure` / `def` | generated object / graph / observation から `ArchitectureLawModel` と signature reading を構成し、その generated lawfulness から pure AAT `DesignLaw` / `AATCore` / `ZeroCurvaturePackage` を構成する law / signature 層。`GeneratedGraphRank` は generated carrier rank が every generated relation edge で減少することを証明し、acyclicity premise を generated graph certificate へ寄せる。`GeneratedRuntimeGraphRank` は generated runtime-interaction edge に同じ rank certificate を与え、runtime surface の acyclicity も generated structure として扱う。 | `defined only` |
