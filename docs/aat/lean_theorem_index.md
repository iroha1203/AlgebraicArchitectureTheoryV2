...
| `TheoremPackageClass`, `ReconstructionAction`, `ClassificationEvidence`, `ActionAllowed`, `TheoremPackageClassification`, `LegacyBridgeSurface`, `genericSignatureBridgeLegacySurface`, `legacyBridgeSurfaces`, `AATCandidate`, `classifyAATCandidate`, `classifyChapter7`, `classifyChapter8`, `classifyChapter9`, `classifyChapter10`, `classifyChapter11`, `classifySFT`, `allClassifications`, `allPackageIds`, `allClassificationClasses`, `allClassificationActions` | `inductive` / `structure` / `def` | 再構成計画 8.2 の theorem package 分類 registry。各 row は `atomGenerated` / `bridgeAssumed` / `representationLevel` のいずれかで、分類ごとに generated entrypoint、bridge assumption、representation surface の evidence list を要求する。`unclassified` constructor は存在しない。generic Signature bridge のような caller-supplied bridge field を持つ compatibility API は `LegacyBridgeSurface` に分離し、theorem package source row には数えない。 | `defined only` |
| `registry_rows_have_classification_evidence`, `registry_rows_have_allowed_actions`, `theorem_package_registry_has_no_bridge_assumed_rows`, `theorem_package_registry_has_no_rewrite_targets`, `generic_signature_bridge_is_not_theorem_package_registry_row`, `generic_signature_bridge_is_legacy_replaced_surface`, `generated_signature_bridge_is_atom_generated`, `nonidentity_transport_handoff_is_atom_generated`, `generated_chapter8_path_diagram_is_atom_generated`, `generated_extension_obstruction_universe_is_atom_generated`, `generated_filling_failure_bridge_is_atom_generated`, `generated_split_lifting_bridge_is_atom_generated`, `generated_complexity_residual_bridge_is_atom_generated`, `generated_consequence_envelope_is_atom_generated`, `generated_analytic_extension_formula_is_atom_generated`, `finite_static_core_is_downstream_representation_library` | `theorem` | registry row が分類 evidence と許可された migration action を持つこと、current theorem package registry に bridge-assumed row / rewrite-target row が残らないこと、generic Signature bridge は legacy surface として generated replacement を持つが registry row ではないこと、generated Signature bridge / 非identity transport handoff / Chapter 8 path-diagram package / generated extension obstruction universe / generated filling-failure bridge / generated split-lifting bridge / generated complexity-residual bridge / generated consequence envelope / generated analytic extension formula は Atom-generated、finite static core は downstream representation library であることを固定する。 | `proved` |
| `AtomGeneratedSignatureExamples.*`, `AtomGeneratedRepairExamples.*`, `AtomGeneratedClassificationExamples.*`, `IncompatibleAtomCompositionExamples.*` | `def` / `theorem` | positive acceptance は source-like AtomShape から generated law model / signature / generated AATCore / operation transport / synthesis soundness / SFT handoff / generated ArchSig-FieldSig preservation and transport transition analysis / generated analytic extension formula package までを通す。classification acceptance は theorem package registry の row が分類 evidence と allowed action を持ち、bridge-assumed / rewrite-target row が残っていないこと、generic Signature bridge が legacy replacement surface であり registry source row ではないこと、Chapter 8 path / observation / diagram / non-fillability、generated extension obstruction universe、generated filling-failure bridge、generated self-view split-lifting bridge、generated complexity / residual coverage bridge が Atom-generated として分類され、Chapter 11 obstruction valuation / analytic extension formula も Atom-generated として分類することを固定する。generated repair acceptance は missing required port configuration が直接 generated molecule にならず、repair 後に generated target molecule / object / repair-clearing package へ到達することを固定する。negative acceptance は incompatible slot、missing required port、relation endpoint 欠落、authority 欠落、concern hint、observation gap、hand-authored graph 非含意を固定する。 | `proved` |
