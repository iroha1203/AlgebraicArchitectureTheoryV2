...
| `ArchitectureSignature.AtomDerivedZeroCurvaturePackage.atomZeroCurvature`, `atomLawful`, `architectureLawful`, `requiredSignatureAxesZero`, `architectureZeroCurvatureTheoremPackage`, `matrixDiagnosticCorollaries`, `architectureZeroCurvatureTheoremPackage_of_atomZeroCurvatureTheoremPackage`, `architectureLawful_of_pureTheoremSuite`, `requiredSignatureAxesZero_of_pureTheoremSuite`, `architectureZeroCurvatureTheoremPackage_of_pureTheoremSuite`, `matrixDiagnosticCorollaries_of_pureTheoremSuite` | `theorem` | atom-only zero curvature / no required atom obstruction circuit / pure atom theorem suite から atom lawfulness を読み、Signature arrangement readings の下で static architecture lawfulness、required Signature axes zero、zero-curvature theorem package、matrix diagnostic corollaries を順に導く。 | `proved` |
...
| `ArchitectureSignature.AtomAxiomatizedAAT.independent_of_observation`, `independent_of_sft`, `requiredMolecule_on_surface`, `atom_of_requiredMolecule`, `requiredMolecule_supportedBy_surface_atoms`, `requiredMolecule_atom_is_primitive`, `requiredCircuit_on_surface`, `atomZeroCurvature`, `atomLawful`, `architectureLawful`, `requiredSignatureAxesZero`, `architectureZeroCurvatureTheoremPackage`, `matrixDiagnosticCorollaries` | `theorem` | pure atom surface の observation / SFT 非依存を保ったまま、required molecule の surface 閉包と primitive atom 性を保存し、atom 公理系 package から atom zero curvature、零曲率 theorem package、matrix diagnostics まで導く。 | `proved` |
