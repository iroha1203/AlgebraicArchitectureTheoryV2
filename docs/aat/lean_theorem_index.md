...
AAT-GAGA comparison、finite golden examples は後続 Issue に残る。`Zero` と `NonZero` を論理補集合として扱う
...
一般 optimal transport theory、candidate-dependent readings から certified verdict への昇格は置かない。
