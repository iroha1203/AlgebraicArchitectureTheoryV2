...
| `ArchitectureSignature.AATCoreSignatureLawfulnessBridge` | `structure` | `AAT.ZeroCurvaturePackage` を消費し、`ArchitectureLawModel` の Signature lawfulness / required axes zero へ渡す後段 analysis bridge。AAT core を定義しない。 | `defined only` |
