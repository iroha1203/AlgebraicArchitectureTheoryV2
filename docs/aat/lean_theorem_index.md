...
| atom-derived entrypoint | `ArchitectureSignature.AtomDerivedZeroCurvaturePackage` | no required atom obstruction circuit から atom lawfulness、既存 static lawfulness、required Signature axes zero、zero-curvature theorem package へ接続する。 |
