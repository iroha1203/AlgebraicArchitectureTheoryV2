...
poset 比較 target、AC5/R3、AC6/R4、AC7/R5、AC8/R6 first half、AC9/R6 に対応する entrypoint である。現時点では
...
明示仮定ブロック下の Boundary Residue theorem までを Lean 上に置く。
...
boundary holonomy、R6 の explicit Boundary Residue hypotheses 下の theorem だけを示す。任意の finite-poset regime が
