...
R8 support-localized transfer / Wasserstein candidate までを実装する。measurement packet、AAT-GAGA comparison、
finite golden examples は後続 Issue に残る。`Zero` と `NonZero` を論理補集合として扱う
...
一般 optimal transport theory は置かない。
