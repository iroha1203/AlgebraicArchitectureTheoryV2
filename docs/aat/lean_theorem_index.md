...
Non-conclusions: この Part VIII 初期 surface は R0/R1 entrypoint / verdict discipline と R2 finite computability
package だけを実装する。Stanley-Reisner / Alexander dual repair、refactor invariance、Hodge decomposition、
...
universe の algorithm completeness theorem は置かない。
