...
R5 の replay descent / effective temporal adjustment / Temporal Descent Criterion までを実装する。
Dissipation、Lyapunov reading、force integrability statement、finite temporal examples は後続 R6 以降に残る。
