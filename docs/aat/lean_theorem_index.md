...
の AC1/R0、AC2/R1、AC3-AC4/R2、AC5-AC8/R3、AC9/R4、AC10/R5、AC11/R6、AC12-AC14/R7、および AC15/R8 に対応する entrypoint である。現時点では
...
| 本文ラベル | Lean 名 | 種別 | 意味 | Status |
| --- | --- | --- | --- | --- |
| `VI.R0` | `Formal.AG.SingularityMonodromyStack`, `Formal.AG.SingularityMonodromyStack.Stratum`, `Formal.AG.SingularityMonodromyStack.CotangentInterface`, `Formal.AG.SingularityMonodromyStack.SmoothSingular`, `Formal.AG.SingularityMonodromyStack.SingularityTheorems`, `Formal.AG.SingularityMonodromyStack.Kuranishi`, `Formal.AG.SingularityMonodromyStack.OperationCategory`, `Formal.AG.SingularityMonodromyStack.OperationHomotopy`, `Formal.AG.SingularityMonodromyStack.Monodromy`, `Formal.AG.SingularityMonodromyStack.MonodromyTheorems`, `Formal.AG.SingularityMonodromyStack.RefactorGalois` | `import` | 第VI部 Singularity・Monodromy・Stack module を `Formal/AG.lean` から import し、PRD-3 `LawAlgebra`、PRD-4 `Cohomology`、PRD-5 `Derived` の成果物上に立ち上げる。 | `defined only` |
...
Non-conclusions: この entrypoint は stack、
gerbe obstruction、finite Part6 examples をまだ形式化しない。Kuranishi Local Model の一般証明、
...
余接複体一般構成、RHom 一般構成、algebraic stack 一般論、
