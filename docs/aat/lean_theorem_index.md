...
の AC1/R0、AC2/R1、AC3-AC4/R2、AC5-AC8/R3、AC9/R4、AC10/R5、AC11/R6、および AC12-AC14/R7 に対応する entrypoint である。現時点では
...
| 本文ラベル | Lean 名 | 種別 | 意味 | Status |
| --- | --- | --- | --- | --- |
| `VI.R0` | `Formal.AG.SingularityMonodromyStack`, `Formal.AG.SingularityMonodromyStack.Stratum`, `Formal.AG.SingularityMonodromyStack.CotangentInterface`, `Formal.AG.SingularityMonodromyStack.SmoothSingular`, `Formal.AG.SingularityMonodromyStack.SingularityTheorems`, `Formal.AG.SingularityMonodromyStack.Kuranishi`, `Formal.AG.SingularityMonodromyStack.OperationCategory`, `Formal.AG.SingularityMonodromyStack.OperationHomotopy`, `Formal.AG.SingularityMonodromyStack.Monodromy`, `Formal.AG.SingularityMonodromyStack.MonodromyTheorems` | `import` | 第VI部 Singularity・Monodromy・Stack module を `Formal/AG.lean` から import し、PRD-3 `LawAlgebra`、PRD-4 `Cohomology`、PRD-5 `Derived` の成果物上に立ち上げる。 | `defined only` |
