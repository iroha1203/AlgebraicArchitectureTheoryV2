...
| 7.3 | Repair as Re-splitting | `SelectedObstructionUniverse`, `AdmissibleRepairRule`, `repairStepDecreases_of_admissible`, `extensionObstructionMeasure_decreases_of_admissible`, `Chapter7TheoremPackages.generatedRepair_target_shapeLevel`, `generatedRepair_clears_selected_target`, `generatedRepair_toRepairClearingPackage`, `generatedRepairFromProblem_shapeLevel`, `generatedRepairFromProblem_clears_selected_problem`, `generatedRepairFromProblem_toRepairClearingPackage` | `defined only` / `proved` | selected obstruction measure の decrease と、generated shape-level repair target / pre-molecule repair problem から generated target object の repair-clearing package への入口。全 obstruction removal や termination は結論しない。 |
...
| 7.6 | Architecture Evolution | `ArchitectureTransition`, `ArchitectureEvolution`, `ArchitectureTransition.flatness_of_transitionPreservesFlatness`, `ArchitectureTransition.reportedObstruction_of_drift`, `eventuallyFlat_of_targetFlat`, `evolutionPathPreservesFlatness`, `Chapter7TheoremPackages.generatedOperation_atomShape_transformed`, `generatedOperation_toOperationTransportPackage` | `defined only` / `proved` | selected transition / migration path に相対化する。generated operation は AtomShape transport と generated AATCore 間の operation transport package へ接続する。全 transition の自動 preservation は主張しない。 |
...
| generated repair clears shape-level target | `Chapter7TheoremPackages.generatedRepair_target_shapeLevel`, `Chapter7TheoremPackages.generatedRepair_clears_selected_target`, `Chapter7TheoremPackages.generatedRepair_toRepairClearingPackage`, `Chapter7TheoremPackages.generatedRepairFromProblem_shapeLevel`, `Chapter7TheoremPackages.generatedRepairFromProblem_clears_selected_problem`, `Chapter7TheoremPackages.generatedRepairFromProblem_toRepairClearingPackage` | generated repair target は port / slot / valence-level target として読み、generated target object 上の AAT repair-clearing package へ接続する。 |
...
| `EventuallyFlat plan` | `EventuallyFlat`, `eventuallyFlat_of_targetFlat`, `evolutionPathPreservesFlatness`, `Chapter7TheoremPackages.generatedOperation_atomShape_transformed`, `Chapter7TheoremPackages.generatedOperation_toOperationTransportPackage` | selected migration path または preserving path に対する bounded eventual flatness。generated operation は AtomShape transformation と generated AATCore transport package として読む。 |
...
global semantic completeness、HoTT / 高次圏論の completeness、
...
を Atom-generated path / diagram entrypoint として公開する。global semantic completeness、HoTT / 高次圏論の完全性、
...
ただし global semantic completeness、strict section / retraction equality、
all feature steps の automatic lifting、実コード extractor completeness を新たに主張しない。

| 設計書 | 候補 | 代表 Lean entrypoint | Status | Bounded reading / non-conclusion boundary |
| --- | --- | --- | --- | --- |
| 9.1 | Diagram filling and obstruction | `ArchitectureDiagram`, `AAT.GeneratedArchitectureDiagram`, `DiagramFiller`, `AAT.GeneratedDiagramFiller`, `Chapter9DiagramFilling.generatedDiagramFiller_refl`, `diagramFiller_observation_eq`, `Chapter9DiagramFilling.generatedObservationDifference_refutesDiagramFiller`, `NonFillabilityWitnessFor`, `AAT.GeneratedNonFillabilityWitnessFor`, `Chapter9DiagramFilling.generatedObservationDifference_nonFillabilityWitnessFor`, `obstructionAsNonFillability_sound`, `WitnessUniverseComplete`, `obstructionAsNonFillability_complete_bounded` | `defined only` / `proved` | selected finite diagram と finite witness universe に相対化された filling refutation / bounded completeness。Atom-generated diagram に対する filler / refutation / witness entrypoint を持つ。global semantic completeness や extractor completeness は主張しない。 |
| 9.2 | Split extension as lifting and section | `FeatureSectionLaw`, `FeatureViewSectionPackage`, `ObservationalCoreRetraction`, `SplitExtensionLiftingData`, `Chapter9DiagramFilling.generatedSelfFeatureExtension`, `Chapter9DiagramFilling.generatedSelfSplitExtensionLiftingData`, `LiftsFeatureStep`, `PreservesCoreInvariants`, `SplitExtensionLifting`, `SplitExtensionLiftingPreservationPackage`, `SplitExtensionLifting_preservationPackage`, `Chapter9DiagramFilling.generatedSelfSplitExtensionLifting_preservationPackage`, `Chapter9DiagramFilling.generatedSelfLiftingFailureExtensionObstructionWitness_classified`, `Chapter9DiagramFilling.generatedSelfLiftingFailureExtensionObstructionWitnessExists_of_not_liftingPreservationPackage` | `defined only` / `proved` | observation-relative section / retraction と selected generated feature step の bounded lifting。generated self-view feature extension 上で preservation package と lifting-failure classification に接続する。strict equality、一意分解、all feature steps の automatic lifting は主張しない。 |
...
| selected feature operations lift to `X'` | `SelectedFeatureStep`, `LiftedExtensionStep`, `LiftsFeatureStep`, `PreservesCoreInvariants`, `SplitExtensionLifting`, `SplitExtensionLiftingPreservationPackage`, `SplitExtensionLifting_preservationPackage`, `Chapter9DiagramFilling.generatedSelfFeatureExtension`, `Chapter9DiagramFilling.generatedSelfSplitExtensionLiftingData`, `Chapter9DiagramFilling.generatedSelfSplitExtensionLifting_preservationPackage`, `Chapter9DiagramFilling.generatedSelfLiftingFailureExtensionObstructionWitness_classified`, `Chapter9DiagramFilling.generatedSelfLiftingFailureExtensionObstructionWitnessExists_of_not_liftingPreservationPackage` | selected generated feature step と local compatibility package に相対化した generated self-view lifting / feature-core preservation。 |
...
| `GeneratedArchitectureLawModel -> ArchitectureSignatureV1` | `AAT.GeneratedArchitectureLawModel.generatedAnalyticRepresentation`, `Chapter11AnalyticRepresentation.generatedAnalyticRepresentation_represent_eq_signatureOfGenerated`, `Chapter11AnalyticRepresentation.generatedAnalyticRepresentation_zeroPreserving`, `Chapter11AnalyticRepresentation.generatedAnalyticRepresentation_zeroReflecting`, `Chapter11AnalyticRepresentation.generatedAnalyticRepresentation_obstructionPreserving`, `Chapter11AnalyticRepresentation.generatedAnalyticRepresentation_obstructionReflecting`, `Chapter11AnalyticRepresentation.generatedAnalyticRepresentation_nonConclusions` | Atom-generated law model を representation state とし、analytic value を `signatureOfGenerated` とする。preserving / reflecting direction は generated lawfulness theorem package から得る。 |
| `ObstructionValuation State Witness` | `ObstructionValuation`, `ObstructionValuation.ZeroReflectingSum`, `ObstructionValuation.no_obstruction_of_value_zero`, `ObstructionValuation.noSelectedObstruction_of_zeroReflectingSum`, `AAT.GeneratedArchitectureLawModel.generatedRequiredSignatureObstructionValuation`, `generatedRequiredSignatureObstructionValuation_value_zero`, `generatedRequiredSignatureObstructionValuation_noSelectedObstruction` | selected witness valuation の zero は selected witness absence に限って読む。generated law model では selected generated Signature-axis valuation が generated required axes zero から計算される。 |
...
| `ArchSigAATCoreTransition`, `FieldSigAATCoreTransitionAnalysis`, `GeneratedArchSigAATCoreTransition`, `GeneratedFieldSigAATCoreTransitionAnalysis`, `GeneratedArchSigAATCoreTransportTransition`, `GeneratedFieldSigAATCoreTransportTransitionAnalysis` | `structure` | ArchSig が観測した `AATCoreTransition` / `AATCoreTransportTransition` を FieldSig / SFT analysis input として読む boundary package。generated 版は source / target の generated law model から Signature bridge を計算し、transport 版は source / target law・molecule を preservation に潰さない。caller-supplied `architectureLawfulFromAAT` field は受け取らない。ArchSig / FieldSig は AAT を定義しない。 | `defined only` |
| `ArchSigAATCoreTransition.records_transition_boundary`, `archsig_transition_does_not_define_aat`, `records_fieldsig_analysis_boundary`, `transition_does_not_create_atoms`, `FieldSigAATCoreTransitionAnalysis.fieldsig_reads_archsig_transition_as_sft_analysis`, `fieldsig_does_not_define_aat`, `transition_does_not_create_atoms`, `forecast_correctness_remains_boundary`, `theorem_and_nonConclusions_remain_boundaries`, `GeneratedArchSigAATCoreTransition.sourceBridge`, `targetBridge`, `source_bridge_architectureLawful`, `target_bridge_architectureLawful`, `GeneratedFieldSigAATCoreTransitionAnalysis.fieldsig_reads_generated_archsig_transition_as_sft_analysis`, `GeneratedArchSigAATCoreTransportTransition.sourceBridge`, `targetBridge`, `source_bridge_architectureLawful`, `target_bridge_architectureLawful`, `GeneratedFieldSigAATCoreTransportTransitionAnalysis.fieldsig_reads_generated_archsig_transport_transition_as_sft_analysis`, `forecast_correctness_remains_boundary` | `def` / `theorem` | ArchSig transition / FieldSig analysis が AATCore preservation / transport transition を SFT analysis として読むだけで、generated transition では source / target bridge が generated law model 由来であること、transport transition では source / target law・molecule が別々に保持されること、AAT 定義、atom creation、forecast correctness へ昇格しないことを取り出す。 | `proved` |
...
| `SFTAATFundamentalModularity.Examples.canonicalGeneratedAATSupportedBoundary` | `def` | Atom-generated Signature acceptance の `GeneratedSFTInput` を singleton finite exact model 上の AAT-supported SFT boundary へ渡す example。 | `defined only` |
...
`Formal/Arch/AAT/TheoremClassification.lean`, and acceptance examples
...
| `generated_graph_edges_from_relation_atoms`, `generated_graph_edge_requires_distinct_endpoints`, `generated_runtime_edges_from_interaction_atoms`, `generated_runtime_edge_requires_distinct_endpoints`, `directedRelationGeneratedGraph_api_to_database_edge`, `directedRelationGeneratedGraph_edge_uses_source_target_ports`, `directedRelationGeneratedGraph_no_database_to_api_edge`, `directedRelationGeneratedGraph_edge_only_api_to_database`, `directedRelationGraphRank_walkAcyclic`, `directedRuntimeGeneratedGraph_api_to_database_edge`, `directedRuntimeGeneratedGraph_edge_uses_source_target_ports`, `directedRuntimeGeneratedGraph_no_database_to_api_edge` | `theorem` | generated relation / runtime atom から graph edge witness を得る方向と、generated edge が distinct endpoints を要求することを固定する。directed relation acceptance は API -> database relation atom が `relationSource` / `relationTarget` ports で向き付き edge を生成し、逆向き edge を生成せず、generated edge が API -> database に限られるため generated graph rank から acyclicity を得ることを固定する。directed runtime acceptance は API -> database runtime interaction atom が `runtimeSource` / `runtimeTarget` ports で向き付き runtime edge を生成し、逆向き runtime edge を生成しないことを固定する。 | `proved` |
| `GeneratedGraphRank`, `GeneratedGraphRank.strictLayering`, `GeneratedGraphRank.walkAcyclic`, `GeneratedArchitectureLawModel`, `GeneratedArchitectureLawModel.ofGraphRank`, `GeneratedArchitectureLawModel.toArchitectureLawModel`, `GeneratedArchitectureLawModel.generatedSignatureOf`, `signatureOfGenerated`, `GeneratedArchitectureLawModel.generatedDesignLaw`, `GeneratedArchitectureLawModel.generatedAATCore`, `GeneratedArchitectureLawModel.generatedZeroCurvaturePackage` | `structure` / `def` | generated object / graph / observation から `ArchitectureLawModel` と signature reading を構成し、その generated lawfulness から pure AAT `DesignLaw` / `AATCore` / `ZeroCurvaturePackage` を構成する law / signature 層。`GeneratedGraphRank` は generated carrier rank が every generated relation edge で減少することを証明し、acyclicity premise を generated graph certificate へ寄せる。 | `defined only` |
| `GeneratedArchitectureLawModel.generated_projection_sound`, `generated_lsp_compatible`, `generated_boundary_policy_sound`, `generated_abstraction_policy_sound`, `generatedArchitectureLawful`, `generated_law_model_from_generated_object`, `generated_law_model_from_generated_graph_rank`, `directedRelation_law_model_from_graph_rank`, `generated_requiredSignatureAxesZero`, `generatedArchitectureLawful_iff_requiredSignatureAxesZero`, `generatedArchitectureLawful_of_requiredSignatureAxesZero` | `theorem` | generated law model から selected lawfulness と required signature axes zero を得る。`generated_law_model_from_generated_graph_rank` は generated object と generated graph rank certificate から law model / lawfulness を構成し、directed relation acceptance では実際の API -> database generated edge に対して rank が下がることから law model を作る。`generatedArchitectureLawful_iff_requiredSignatureAxesZero` は hand-authored graph / law model や `architectureLawfulFromAAT` field を入力にしない。 | `proved` |
| `GeneratedArchitectureLawModel.generated_noRequiredObstructionCircuit`, `generatedLawfulnessBridge`, `generated_lawfulWithinMoleculeConfiguration`, `ArchitectureSignature.AATCoreSignatureLawfulnessBridge.ofGeneratedLawModel`, `AtomGeneratedSignatureExamples.atomGeneratedSignature_coreSignatureBridge`, `atomGeneratedSignature_coreSignatureBridge_architectureLawful` | `theorem` / `def` | generated law model から pure AAT lawfulness / no required obstruction circuit bridge を構成し、既存 `ZeroCurvaturePackage` と AATCore-to-Signature bridge へ接続する。AATCore-to-Signature bridge は generated constructor 経由なら `architectureLawfulFromAAT` field を caller が手入力しない。 | `proved` |
...
| `generatedSemanticDiagram`, `generatedFlatnessModel`, `generatedArchitectureFlatWithin`, `generatedArchitectureFlat`, `generatedObservationDistance`, `generatedAtomShapeCoordinateDistance`, `generatedAtomShapeCoordinateSemantics`, `generated_totalCurvature_eq_zero`, `generated_noMeasuredNumericalCurvatureObstruction`, `generated_shapeCoordinateTotalCurvature_eq_zero`, `generated_noMeasuredShapeCoordinateCurvatureObstruction`, `generatedComponent_shapeCoordinateTotalCurvature_eq_zero`, `generatedComponent_noMeasuredShapeCoordinateCurvatureObstruction` | `def` / `theorem` | generated semantic diagram / flatness model / curvature input を既存 bounded flatness / curvature API に接続する。shape-coordinate curvature は full AtomShape mismatch-count distance を zero-separating metric として使い、generated reflexive semantic diagrams が shape-coordinate curvature obstruction を持たないことを固定する。 | `defined only` / `proved` |
...
| `GeneratedArchitectureDiagram`, `GeneratedDiagramFamily`, `GeneratedDiagramFiller`, `GeneratedNonFillabilityWitness`, `GeneratedNonFillabilityWitnessFor`, `generatedDiagramFiller_refl`, `generated_obstructionAsNonFillability_sound`, `generatedDiagramFiller_observation_eq`, `generatedObservationDifference_refutesDiagramFiller`, `generatedObservationDifference_nonFillabilityWitnessFor`, `Chapter8HomotopySkeleton.generatedDiagramFiller_observation_eq`, `Chapter8HomotopySkeleton.generatedObservationDifference_refutesDiagramFiller`, `Chapter8HomotopySkeleton.generated_obstructionAsNonFillability_sound`, `Chapter8HomotopySkeleton.generatedObservationDifference_nonFillabilityWitnessFor`, `Chapter9DiagramFilling.generatedSelfFeatureExtension`, `generatedSelfSplitExtensionLiftingData`, `generatedSelfSplitExtensionLifting_preservationPackage`, `generatedSelfLiftingFailureExtensionObstructionWitness_classified`, `generatedSelfLiftingFailureExtensionObstructionWitnessExists_of_not_liftingPreservationPackage`, `generatedFillingFailureWitnessPayload`, `generatedFillingFailureExtensionObstructionWitness`, `generatedFillingFailureExtensionObstructionWitness_classified`, `generatedFillingFailureBridge_toNonSplitExtensionWitnessPackage`, `generatedFillingFailureBridge_selectedExtensionObstructionWitnessExists_of_generatedWitnessExists`, `generatedFillingFailureBridge_not_selectedSplitExtension_of_generatedWitness`, `Chapter10ArchitectureExtensionFormula.generatedFillingFailureExtensionObstructionWitness_multilabel_classified`, `generatedSelfLiftingFailureExtensionObstructionWitness_multilabel_classified` | `abbrev` / `structure` / `def` / `theorem` | generated step/path に制限された diagram family、filler、non-fillability witness surface。Chapter 8 / 9 entrypoint から selected generated observation difference、generated diagram filler refutation、generated non-fillability witness package を構成し、generated self-view feature extension の lifting / lifting-failure bridge と generated identity feature extension の filling-failure obstruction / non-split witness package / multi-label classification へ接続する。 | `defined only` / `proved` |
| `GeneratedAnalyticWitness`, `GeneratedArchitectureLawModel.generatedAnalyticRepresentation`, `generatedAnalyticRepresentation_zeroPreserving`, `generatedAnalyticRepresentation_zeroReflecting`, `generatedAnalyticRepresentation_obstructionPreserving`, `generatedAnalyticRepresentation_obstructionReflecting`, `generatedAnalyticRepresentation_nonConclusions`, `generatedRequiredSignatureObstructionValuation`, `generatedRequiredSignatureObstructionValuation_value_zero`, `generatedRequiredSignatureObstructionValuation_noSelectedObstruction`, `generatedRequiredSignatureObstructionValuation_recordsNonConclusions`, `Chapter11AnalyticRepresentation.generatedAnalyticRepresentation_represent_eq_signatureOfGenerated`, `Chapter11AnalyticRepresentation.generatedAnalyticRepresentation_zeroPreserving`, `Chapter11AnalyticRepresentation.generatedAnalyticRepresentation_zeroReflecting`, `Chapter11AnalyticRepresentation.generatedAnalyticRepresentation_obstructionPreserving`, `Chapter11AnalyticRepresentation.generatedAnalyticRepresentation_obstructionReflecting`, `Chapter11AnalyticRepresentation.generatedAnalyticRepresentation_nonConclusions`, `generatedIdentityAnalyticExtensionFormulaPackage`, `generatedIdentityAnalyticExtensionFormula_formula_holds`, `generatedIdentityAnalyticExtensionFormula_requiredAssumptions`, `generatedIdentityAnalyticExtensionFormula_recordsNonConclusions`, `generatedIdentityAnalyticExtensionFormula_obstructionValue_zero` | `inductive` / `def` / `theorem` | generated law model を state space とし、`signatureOfGenerated` を analytic value とする generated analytic representation。Chapter 11 entrypoint からも generated preserving / reflecting theorem を公開し、generated selected obstruction valuation と generated identity analytic extension formula package に接続する。hand-authored `ArchitectureLawModel` を representation 入力として受け取らない。 | `defined only` / `proved` |
...
| `GeneratedOperation`, `GeneratedOperation.atomShape_transformed`, `GeneratedOperation.operation_does_not_create_atoms`, `GeneratedOperation.toOperationTransportPackage`, `Chapter7TheoremPackages.generatedOperation_atomShape_transformed`, `Chapter7TheoremPackages.generatedOperation_toOperationTransportPackage`, `AtomGeneratedMoleculeExamples.generatedApiExpansionOperation`, `generatedApiExpansionOperationTransportPackage`, `generatedApiExpansionOperation_target_molecule_is_distinct` | `structure` / `def` / `theorem` | generated object 間の AtomShape transformation を、atom existence を生成しない operation として読み、source/target の generated AATCore 間の `OperationTransportPackage` へ接続する。API-only source object から API+database target object への非identity transport acceptance により、source molecule と target molecule が別物でも transport package が通ることを固定する。Chapter 7 entrypoint からも generated operation transport を公開する。 | `defined only` / `proved` |
| `GeneratedRepairTarget`, `GeneratedRepairTarget.shapeLevel`, `GeneratedRepair`, `GeneratedRepair.clears_selected_target`, `GeneratedRepair.repair_does_not_create_atoms`, `GeneratedRepair.toRepairClearingPackage`, `GeneratedRepairProblemConfiguration`, `GeneratedRepairProblem`, `GeneratedRepairProblemOperation`, `GeneratedRepairProblemCleared`, `GeneratedRepairFromProblem`, `GeneratedRepairFromProblem.clears_selected_problem`, `GeneratedRepairFromProblem.target_generated_molecule`, `GeneratedRepairFromProblem.repair_problem_does_not_create_atoms`, `GeneratedRepairFromProblem.toRepairClearingPackage`, `AtomGeneratedRepairExamples.repairedGeneratedGraphRank`, `AtomGeneratedRepairExamples.repaired_law_model_from_graph_rank`, `GeneratedSynthesisCandidate`, `GeneratedSynthesisCandidate.candidate_flatWithin`, `GeneratedSynthesisCandidate.candidate_totalCurvature_eq_zero`, `GeneratedSynthesisCandidate.synthesis_does_not_create_atoms`, `GeneratedSynthesisCandidate.toSynthesisSoundnessPackage`, `Chapter7TheoremPackages.generatedRepair_target_shapeLevel`, `Chapter7TheoremPackages.generatedRepair_clears_selected_target`, `Chapter7TheoremPackages.generatedRepair_toRepairClearingPackage`, `Chapter7TheoremPackages.generatedRepairFromProblem_shapeLevel`, `Chapter7TheoremPackages.generatedRepairFromProblem_clears_selected_problem`, `Chapter7TheoremPackages.generatedRepairFromProblem_toRepairClearingPackage`, `Chapter7TheoremPackages.generatedSynthesisCandidate_flatWithin`, `Chapter7TheoremPackages.generatedSynthesisCandidate_toSynthesisSoundnessPackage` | `inductive` / `structure` / `def` / `theorem` | valid generated object 内だけで repair target を仮定せず、`GeneratedMolecule` 前の failed atom configuration から port / slot / valence level repair problem を読み、generated repair operation によって valid generated target object / molecule へ到達する。repair / synthesis candidate は generated graph rank から構成された generated target law model から既存 AAT repair-clearing / synthesis-soundness package に接続し、Chapter 7 entrypoint からも公開する。 | `defined only` / `proved` |
| `GeneratedArchitectureLawModel.generatedAATTheoremStatusForSFT`, `GeneratedSFTInput`, `GeneratedSFTInput.theoremStatus`, `GeneratedSFTInput.theoremStatusFromGenerated`, `GeneratedSFTInput.measured_zero_from_generated`, `GeneratedSFTInput.reads_generated_aat`, `GeneratedSFTInput.reads_generated_aat_as_sft_local_premise`, `GeneratedSFTInput.toAATCoreLocalAlgebraForSFT`, `localAlgebra_reads_generated_aat`, `localAlgebra_forecast_correctness_remains_boundary`, `sft_does_not_redefine_atoms`, `sft_does_not_redefine_aat`, `forecast_correctness_remains_boundary`, `sft_event_does_not_create_atoms` | `def` / `structure` / `theorem` | generated law model の AAT theorem status を任意 field ではなく generated law model から計算し、その status が generated theorem package / measured-zero evidence を記録し、SFT local premise としてだけ渡されることを固定する。`toAATCoreLocalAlgebraForSFT` は generated SFT input から existing SFT local algebra boundary を構成する。SFT / FieldSig は Atom / AAT を再定義せず forecast correctness を結論しない。 | `defined only` / `proved` |
