...
| `ArchitectureSignature.AtomDerivedZeroCurvaturePackage.atomLawful`, `architectureLawful`, `requiredSignatureAxesZero`, `architectureZeroCurvatureTheoremPackage`, `architectureZeroCurvatureTheoremPackage_of_atomZeroCurvatureTheoremPackage` | `theorem` | atom-only zero curvature / no required atom obstruction circuit から `LawfulWithinAtomConfiguration` を得て、既存 `ArchitectureLawful X`、`RequiredSignatureAxesZero (signatureOf X)`、`ArchitectureZeroCurvatureTheoremPackage X` を導く。 | `proved` |
...
| `ArchitectureSignature.AtomAxiomatizedAAT.independent_of_observation`, `independent_of_sft`, `requiredMolecule_on_surface`, `atom_of_requiredMolecule`, `requiredMolecule_supportedBy_surface_atoms`, `requiredMolecule_atom_is_primitive`, `requiredCircuit_on_surface`, `atomLawful`, `architectureLawful`, `requiredSignatureAxesZero`, `architectureZeroCurvatureTheoremPackage` | `theorem` | atom 公理系 package から observation / SFT 非依存、surface 上の required molecule / circuit 選択、required molecule の selected atom universe 閉包、atom lawfulness、static lawfulness、required Signature axes zero、zero-curvature theorem package を取り出す。 | `proved` |
...
| `ArchitectureSignature.AtomAxiomatizedAAT.independent_of_observation`, `independent_of_sft`, `requiredMolecule_on_surface`, `atom_of_requiredMolecule`, `requiredMolecule_supportedBy_surface_atoms`, `requiredMolecule_atom_is_primitive`, `requiredCircuit_on_surface`, `atomLawful`, `architectureLawful`, `requiredSignatureAxesZero`, `architectureZeroCurvatureTheoremPackage` | `theorem` | pure atom surface の observation / SFT 非依存を保ったまま、required molecule の surface 閉包と primitive atom 性を保存し、atom 公理系 package から零曲率 theorem package まで導く。 | `proved` |
