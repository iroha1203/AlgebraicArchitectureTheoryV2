...
| `registry_rows_have_classification_evidence`, `registry_rows_have_allowed_actions`, `generic_signature_bridge_is_temporary_bridge`, `generated_signature_bridge_is_atom_generated`, `nonidentity_transport_handoff_is_atom_generated`, `generated_filling_failure_bridge_is_atom_generated`, `generated_split_lifting_bridge_is_atom_generated`, `generated_consequence_envelope_is_atom_generated`, `finite_static_core_is_downstream_representation_library` | `theorem` | registry row が分類 evidence と許可された migration action を持つこと、generic Signature bridge は temporary bridge、generated Signature bridge / 非identity transport handoff / generated filling-failure bridge / generated split-lifting bridge / generated consequence envelope は Atom-generated、finite static core は downstream representation library であることを固定する。 | `proved` |
