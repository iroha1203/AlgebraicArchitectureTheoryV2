...
AC1/R0、AC2/R1、AC3-AC4/R2、AC5/R3、AC6-AC7/R4、AC8-AC9/R5、AC10/R6、AC11/R7、AC12/R8、AC13-AC14/R9、AC15/R10、AC16/R11 に対応する site/context entrypoint である。現時点では
...
| `II.R11 finite model examples` | `AAT.AG.FiniteModel.siteContext`, `FiniteModel.siteContextIdentityMorphism`, `FiniteModel.siteContextPreorder`, `FiniteModel.siteOverlap`, `FiniteModel.siteCoverageRequirements`, `FiniteModel.site`, `FiniteModel.siteBase`, `FiniteModel.siteSingletonCover`, `FiniteModel.siteAdequacyRequirements`, `FiniteModel.siteSingletonCover_uAdequate`, `FiniteModel.site_requiredWitnessSubtype_finite`, `FiniteModel.siteWitnessClosureCover`, `FiniteModel.siteWitnessClosureCover_uAdequate`, `FiniteModel.siteCoefficient`, `FiniteModel.siteNerveSimplex`, `FiniteModel.finitePosetRegime`, `FiniteModel.finitePosetRegime_context_finite`, `FiniteModel.finitePosetRegime_context_meet_left`, `FiniteModel.site_top_mem`, `FiniteModel.finitePosetRegime_nerveDimension_zero`, `FiniteModel.finitePosetCechComplex`, `FiniteModel.finitePosetRegime_cechComplex_finite`, `FiniteModel.finitePosetRegime_cech_vanishes_above_dimension` | `def` / `theorem` | PRD-1 finite model 上の singleton context/site example。singleton admissible cover、witness-closure adequate cover、selected finite poset regime、top cover membership、degree 0 nerve dimension、および positive degree Čech vanishing theorem を持つ。 | `defined only` / `proved` |
...
finite poset cover-relative Čech vocabulary、nerve dimension 上の高次消滅、AAT sheaf category entrypoint だけを示す。
