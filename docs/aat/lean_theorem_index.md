...
、R6 cellular Laplacian / finite Hodge package までを実装する。LawConflict measurement、support-localized transfer、measurement packet、
...
Perron-Frobenius / spectral hotspot theorem は置かない。
