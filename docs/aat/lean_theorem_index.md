...
presheaf、selected descent predicate、temporal law surface までを実装する。Temporal obstruction、replay descent、
dissipation、Lyapunov reading、force integrability statement、finite temporal examples は後続 R4 以降に残る。
