...
dissipative policy / selected path predicates、R7 の Finite Dissipation Stopping package までを実装する。
Lyapunov reading、force integrability statement、finite temporal examples は後続 R8 以降に残る。
