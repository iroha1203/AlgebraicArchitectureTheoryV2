...
の AC1/R0、AC2/R1、AC3-AC4/R2、AC5-AC8/R3、および AC9/R4 に対応する entrypoint である。現時点では
...
Non-conclusions: この entrypoint は operation homotopy quotient、`pi_1^AAT`、monodromy、stack、
