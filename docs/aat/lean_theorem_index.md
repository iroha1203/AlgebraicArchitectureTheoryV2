...
temporal cover、Čech bridge、temporal coefficient、finite measurement bridge までを実装する。
State transition presheaf、temporal law、temporal obstruction、replay descent、
dissipation、Lyapunov reading、force integrability statement、finite temporal examples は後続 R3 以降に残る。
