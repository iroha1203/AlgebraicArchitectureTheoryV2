...
| `ArchitectureSignature.AtomAxiomatizedAAT.independent_of_observation`, `independent_of_sft`, `requiredCircuit_on_surface`, `atomLawful`, `architectureLawful`, `requiredSignatureAxesZero`, `architectureZeroCurvatureTheoremPackage` | `theorem` | atom 公理系 package から observation / SFT 非依存、surface 上の required circuit 選択、atom lawfulness、static lawfulness、required Signature axes zero、zero-curvature theorem package を取り出す。 | `proved` |
...
| `ArchitectureSignature.AtomAxiomatizedAAT.independent_of_observation`, `independent_of_sft`, `requiredCircuit_on_surface`, `atomLawful`, `architectureLawful`, `requiredSignatureAxesZero`, `architectureZeroCurvatureTheoremPackage` | `theorem` | pure atom surface の observation / SFT 非依存を保ったまま、atom 公理系 package から零曲率 theorem package まで導く。 | `proved` |
