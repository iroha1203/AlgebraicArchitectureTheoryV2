...
| `GeneratedArchitectureObject`, `GeneratedCarrier`, `GeneratedObservationCoordinate`, `GeneratedAuthority`, `GeneratedEffect`, `GeneratedContract`, `GeneratedSemanticInterpretation`, `GeneratedSemanticContractCoverage`, `GeneratedAuthorityPolicy`, `GeneratedEffectLawInput`, `GeneratedAuthorityEffectLawSatisfied` | `structure` / `abbrev` / `def` | generated molecule から architecture carrier、observation coordinate、authority / effect / contract / semantic interpretation、semantic-contract coverage、authority-effect law input を読む object 層。 | `defined only` |
| `GeneratedArchitectureObject.carrier_atom_primitive`, `generated_observation_from_semantic_atoms`, `generated_authority_policy_from_authority_atoms`, `generated_effect_law_input_from_effect_atoms`, `generated_contract_from_contract_atoms`, `generated_semantic_interpretation_from_semantic_atoms`, `generated_semantic_contract_coverage_from_contract_atoms`, `generated_authority_effect_law_satisfied_from_authority_policy`, `no_authority_policy_not_generated_authority_effect_law_satisfied` | `theorem` | generated object の carrier atom が primitive であり、semantic / authority / effect / contract atom から対応 surface が出ること、semantic atom と generated contract が同じ generated object 内にあると semantic-contract coverage が構成されること、effect atom と generated authority policy が同じ generated object 内にあると authority-effect law satisfied が構成されること、authority がない effect-only input から law satisfied は出ないことを示す。 | `proved` |
