...
までを実装する。Hodge decomposition、LawConflict measurement、support-localized transfer、measurement packet、
...
syntax-level refactor や external rewrite からの自動 preservation は置かない。
