...
、R6 cellular Laplacian / finite Hodge package、R7 LawConflict measurement / flat base-change candidate までを実装する。support-localized transfer、measurement packet、
...
comparison morphism なしの異 ambient law conflict comparison は置かない。
