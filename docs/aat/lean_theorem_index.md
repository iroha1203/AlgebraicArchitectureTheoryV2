...
package、R3 square-free repair package、R4 witness perturbation / stability candidate interface までを実装する。
refactor invariance、Hodge decomposition、LawConflict measurement、support-localized transfer、measurement packet、
...
semantics への自動昇格、candidate stability statement から certified stable measurement verdict への自動昇格は置かない。
