...
| `AtomAxiomatizedRepairPackage.target_noRequiredObstructionCircuit`, `target_atomLawful`, `architectureLawful_of_repair`, `requiredSignatureAxesZero_of_repair`, `architectureZeroCurvatureTheoremPackage_of_repair` | `theorem` | finite atom repair clearing から atom lawfulness、既存 `ArchitectureLawful`、required Signature axes zero、zero-curvature theorem package を導く。 | `proved` |
...
| `AtomAxiomatizedSynthesisPackage.candidate_satisfies`, `synthesisSoundnessPackage`, `candidate_satisfies_via_synthesisPackage`, `candidate_noRequiredObstructionCircuit`, `candidate_atomLawful`, `architectureLawful_of_synthesis`, `requiredSignatureAxesZero_of_synthesis`, `architectureZeroCurvatureTheoremPackage_of_synthesis` | `theorem` / `def` | atom-generated constraints に対する candidate soundness を通常の synthesis package として読み、candidate の no-required-circuit から atom lawfulness、architecture lawfulness、required Signature axes zero、zero-curvature theorem package を導く。 | `proved` / `defined only` |
...
| `AtomicExamples.noEdgeAtomRepair_target_atomLawful`, `architectureLawful`, `requiredSignatureAxesZero`, `zeroCurvatureTheoremPackage` | `theorem` | atom repair clearing から atom lawfulness、architecture lawfulness、required Signature axes zero、zero-curvature theorem package を得る example theorem。 | `proved` |
...
| `AtomicExamples.noEdgeAtomSynthesis_candidate_satisfies`, `candidate_satisfies_via_package`, `candidate_noRequiredCircuit`, `architectureLawful`, `requiredSignatureAxesZero`, `zeroCurvatureTheoremPackage` | `theorem` | atom-generated synthesis constraints の candidate soundness と、candidate no-required-circuit から zero-curvature theorem package まで導く smoke test。 | `proved` |
