...
| H5 | runtime propagation が大きい領域では incident scope と障害修正コストが増える。 | `runtimePropagation`, `runtimeFanout`, `unprotectedRuntimePropagationRadius`, `circuitBreakerCoverageRatio` | affected components, repair time, rollback, hotfix size |
