...
[`docs/aat/mathematical_theory.md`](../aat/mathematical_theory.md) に置き、Lean status と
...
Architecture Dynamics tooling は、[SFT: ソフトウェアの場の理論](../sft/software_field_theory.md)
...
Canonical measurement contract fixture:
