...
| [Architecture Signature Dynamics 設計](architecture_signature_dynamics.md) | compatibility entry | 旧設計本文は archive へ退避済み。新しい本文は [SFT](../sft/software_field_theory.md) に統合し、`ArchitectureEvolution` と `ArchitectureSignature` による bounded formal kernel と field / forecast / control layer を分離する。 |
