...
- 正式な statement / claim boundary: [research/GOALS.md](../../research/GOALS.md) の completed カード
...
- 完了台帳: `research/GOALS.md`(completed カード)、`docs/aat/proof_obligations.md`(research target-theorem 台帳)
