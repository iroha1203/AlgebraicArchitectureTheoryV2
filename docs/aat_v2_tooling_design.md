...
artifacts:
  - artifact_id: string
    kind: sig0 | validation | snapshot | diff | pr_metadata | runtime_edges | policy | semantic | manual
...
evidence:
  - evidence_id: string
    kind: source_location | policy_rule | runtime_trace | pr_file | test | semantic_diagram | observation_result | manual_annotation
