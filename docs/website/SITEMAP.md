...
| `/archsig/` | `website/archsig/index.html` | ArchSig v1 output contract の Skill-first architecture analysis landing。 |
...
| `/archsig/manual/` | `website/archsig/manual/index.html` | `archsig-analysis-summary.json`、viewer data、analysis packet、measurement families、coverage gap、measurement basis の読み方。 |
