...
| `/sft/field-and-force/codebase-memory-artifact-force/` | `website/sft/field-and-force/codebase-memory-artifact-force/index.html` | 1-1. Codebase Memory and Artifact Force。古いコード、要求、設計ノート、incident が force-bearing memory になることを扱う。 |
| `/sft/field-and-force/agents-organization-recurrent-paths/` | `website/sft/field-and-force/agents-organization-recurrent-paths/index.html` | 1-2. Agents, Organization, and Recurrent Paths。開発者、AI agent、ownership、routine、recurrent path を field structure として扱う。 |
| `/sft/field-and-force/governance-feedback-futures/` | `website/sft/field-and-force/governance-feedback-futures/index.html` | 1-3. Governance Feedback and Architecture Futures。review、CI、operational feedback、governance が future support を更新することを扱う。 |
...
| `/sft/software-evolution/governance-attractor-engineering/` | `website/sft/software-evolution/governance-attractor-engineering/index.html` | 3-1. Governance and Attractor Engineering。review、CI、type systems、stable regions、field shaping を通じて attractor を設計する。 |
| `/sft/software-evolution/ai-proposal-governance/` | `website/sft/software-evolution/ai-proposal-governance/index.html` | 3-2. AI Proposal Governance。AI-generated proposal support を theorem boundary、shortcut witness、review、CI の中で制御する。 |
| `/sft/software-evolution/lifecycle-closed-loop/` | `website/sft/software-evolution/lifecycle-closed-loop/index.html` | 3-3. Lifecycle and Closed-Loop Evolution。repair、migration、contraction、deletion、posterior update により evolution loop を閉じる。 |
