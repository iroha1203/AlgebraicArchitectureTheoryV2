...
| --- | --- | --- | --- |
| `/aat2/` | `website/aat2/index.html` | `/aat/` | AAT2 landing。Atom refoundation 後の章構成、読書順、claim boundary の入口。 |
| `/aat2/atoms/` | `website/aat2/atoms/index.html` | `/aat/atoms/` | AAT2 Part I。Atom と primitive architectural facts の読者向け導入。 |
| `/aat2/architecture-objects/` | `website/aat2/architecture-objects/index.html` | `/aat/architecture-objects/` | AAT2 Part I。Molecule、ArchitectureObject、selected presentation、finite universe の読者向け導入。 |
| `/aat2/laws/` | `website/aat2/laws/index.html` | `/aat/laws/` | AAT2 Part I。DesignLaw、law universe、invariant family、lawfulness bridge の読者向け導入。 |
| `/aat2/obstruction-circuits/` | `website/aat2/obstruction-circuits/index.html` | `/aat/obstruction-circuits/` | AAT2 Part I。ObstructionCircuit、minimal bad molecule、finite witness universe の読者向け導入。 |
| `/aat2/zero-curvature/` | `website/aat2/zero-curvature/index.html` | `/aat/zero-curvature/` | AAT2 Part II。Flatness、ZeroCurvature、ZeroCurvaturePackage の読者向け導入。 |
| `/aat2/architecture-signature/` | `website/aat2/architecture-signature/index.html` | `/aat/architecture-signature/` | AAT2 Part II。Architecture Signature、multi-axis diagnostic、AATCore bridge、ArchSig boundary の読者向け導入。 |
| `/aat2/design-principle-layers/` | `website/aat2/design-principle-layers/index.html` | `/aat/design-principle-layers/` | AAT2 Part II。SOLID、Layered / Clean Architecture、Event Sourcing、Saga、Circuit Breaker、Replicated Log を law package layer として読む章。 |
| `/aat2/operations-and-calculus/` | `website/aat2/operations-and-calculus/index.html` | `/aat/operations-and-calculus/` | AAT2 Part II。ArchitectureOperation、operation law、feature extension、selected repair、synthesis soundness の章。 |
| `/aat2/dynamics-and-geometry/` | `website/aat2/dynamics-and-geometry/index.html` | `/aat/dynamics-and-geometry/` | AAT2 Part II。ArchitecturePath、signature trajectory、PathHomotopy、DiagramFiller、selected monodromy / continuation の章。 |
| `/aat2/representations-and-effects/` | `website/aat2/representations-and-effects/index.html` | `/aat/representations-and-effects/` | AAT2 Part III。graph、thin category、walk / matrix、analytic representation、state-transition algebra、effect law surface の章。 |
| `/aat2/canonical-examples-and-readings/` | `website/aat2/canonical-examples-and-readings/index.html` | `/aat/canonical-examples-and-readings/` | AAT2 Part III。atom / molecule / law / circuit、coupon extension、static-flat semantic obstruction、repair transfer、SOLID counterexamples の章。 |
| `/aat2/related-work/` | `website/aat2/related-work/index.html` | `/aat/related-work/` | AAT2 appendix。architecture description、ATAM、metrics、graph analysis、formal methods、category models に対する位置付け。 |
| `/aat2/status/` | `website/aat2/status/index.html` | `/aat/status/` | AAT2 appendix。Lean status vocabulary、proved surface、defined carriers、future proof obligations、empirical hypotheses の読み方。 |
| `/aat2/formal-anchors/` | `website/aat2/formal-anchors/index.html` | `/aat/formal-anchors/` | AAT2 appendix。AAT2 章の claim と代表 Lean declarations の audit index。 |
