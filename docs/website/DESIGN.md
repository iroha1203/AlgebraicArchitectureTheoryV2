...
/archsig/
  ...
  できること、できないこと、読む順序、ArchMap primary / adapter / review surface、
  CLI / artifact / workflow / reference への入口。

/archsig/getting-started/
  最短手順。
  ArchMap primary workflow、明示的な adapter-scan、validate。advanced surface は
...
/archsig/reading-output/
  Reading the Output。
  Sig0、validation report、signature diff、Feature Extension Report、
  policy decision、PR comment summary の読み方。

/archsig/air/
  AIR。
  scan evidence、policy、runtime evidence、semantic witness、coverage、claim、
...
/archsig/archmap/
  ...
  coverage、missing evidence、non-conclusions を AIR へ渡す。

/archsig/commands/
  Command reference。
  scan、validate、snapshot、signature-diff、air、archmap、air-from-archmap、
  theorem-check、feature-report、policy-decision、pr-comment、
  registry / schema / SFT forecasting commands。

/archsig/artifacts/
  Artifact reference。
  Sig0、validation report、snapshot、diff report、archmap-v0、
...
| `/archsig/getting-started/` | `tools/archsig/README.md`, `tools/archsig/docs/commands.md` | Minimal ArchMap-primary workflow and explicit adapter evidence path. |
| `/archsig/inputs/` | `tools/archsig/README.md`, `tools/archsig/docs/commands.md`, `tools/archsig/docs/artifacts-and-boundaries.md` | ArchMap input, optional adapter evidence, policy input, and boundary preparation. |
| `/archsig/reading-output/` | `tools/archsig/docs/artifacts-and-boundaries.md`, `tools/archsig/docs/commands.md` | Field-level guide for ArchMap validation, AIR, theorem checks, feature reports, observable bundles, and adapter diffs. |
...
| `/archsig/commands/` | `tools/archsig/docs/commands.md` | CLI command reference grouped by ArchMap primary workflow, adapter evidence, diff, policy, and schema surfaces. |
...
| `/archsig/workflows/` | `tools/archsig/docs/commands.md`, `tools/archsig/README.md` | ArchMap primary review workflow and optional adapter / diff workflow. |
...
| Canonical-source fidelity | `docs/` または tool docs の source of truth に忠実か。 | AAT は `docs/aat/mathematical_theory.md`、SFT は `docs/sft/software_field_theory.md`、ArchSig は `tools/archsig/README.md` と `tools/archsig/docs/` を source とし、`docs/tool/README.md` は再構築中の入口として扱う。 |
