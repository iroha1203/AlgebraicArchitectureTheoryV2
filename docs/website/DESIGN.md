...
| `/archsig/inputs/` | `tools/archsig/README.md`, `tools/archsig/docs/commands.md` | Policy, runtime edge, PR metadata, Python root, and proposal input preparation. |
| `/archsig/reading-output/` | `tools/archsig/docs/artifacts-and-boundaries.md`, `docs/tool/reports.md` | Field-level guide for Sig0, validation, diff, feature reports, policy decisions, and PR comments. |
| `/archsig/air/` | `docs/tool/air.md`, `docs/tool/reports.md`, `tools/archsig/docs/commands.md` | Architecture Intermediate Representation as the claim, coverage, evidence, and report normalization layer. |
