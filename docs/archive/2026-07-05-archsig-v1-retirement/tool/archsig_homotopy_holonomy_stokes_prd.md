...
- `Formal/`: Lean で支える範囲、future proof obligation、empirical hypothesis
- `Formal/`: 追加した Lean definition / theorem / non-conclusion
...
- `Formal/` と `Formal/` が Lean 追加分と claim boundary を反映する。
