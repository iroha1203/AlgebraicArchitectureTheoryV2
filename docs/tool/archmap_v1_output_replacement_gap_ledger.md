...
| FieldSig handoff | docs historically used `archsig-analysis-packet-v0` as bounded current AAT structural state. | FieldSig now reads `archsig-analysis-packet/v1` raw packets, preserves generated packet refs plus spectrum / homotopy / structural refs as downstream evidence, and treats v1 packet schema as the current handoff compatibility contract. | implemented-for-derived-output | #1842 |
