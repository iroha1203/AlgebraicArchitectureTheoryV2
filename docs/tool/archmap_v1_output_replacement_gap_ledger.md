...
- 現在の v1 raw packet は spectrum / homotopy / structural review refs を再生成する。
  ただし summary / viewer / FieldSig handoff / golden corpus / website docs の
  v1 output replacement 同期は後続 Issue の対象である。
...
| --- | --- | --- | --- | --- |
| 449-462 | v1 `analyze` は validation、normalization、typed evaluator の後に `analysis packet / summary / viewer / distanceDiagnosis` を作る。 | `main.rs` は v1 artifact chain を実行している。packet は spectrum / homotopy / structural derived refs を含む。summary / viewer / failure artifact policy / golden corpus の acceptance は後続。 | partial | #1845, #1843 |
...
| positive fixture carries evaluator basis refs | typed result has basis refs, and v1 packet carries generated / spectrum / homotopy / structural derived output refs. Golden corpus coverage is still missing. | partial | #1840, #1838, #1839, #1836, #1843 |
