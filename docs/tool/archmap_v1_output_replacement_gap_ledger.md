...
| 603-604 | summary / viewer / detail index は typed evaluator result と derived packet refs 前提へ置換する。 | summary / viewer / detail index は出る。spectrum / homotopy refs は v1 derived packet refs として入る。structural review refs の rich sync は後続。 | partial | #1845 |
