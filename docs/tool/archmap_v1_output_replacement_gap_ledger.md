...
| 579-587 | evaluator registry manifest は required atom / molecule shape、scope rule、missing blocker、pass / violation criteria、distance contribution、summary / detail output refs、negative fixtures を持つ。 | static registry は `solid@1` / layering evaluators と removed-field replacement evaluators を持つ。spectrum / homotopy / structural evaluators は不足。 | partial | #1840, #1838, #1839, #1836 |
