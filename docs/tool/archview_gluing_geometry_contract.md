...
- square-free repair: observed forbidden co-occurrenceのcageと、そのsupportに接続されたrepair morphを表示する。宣言された生成元が未生起のときはpacketのsilence boundaryを保持し、automatic repairとは主張しない。
