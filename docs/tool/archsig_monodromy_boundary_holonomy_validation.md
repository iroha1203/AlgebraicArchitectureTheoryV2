...
| AAT text separates proved guardrail, theorem candidate, conjecture, and tool diagnosis. | `docs/aat/mathematical_theory/part_2_flatness_calculus_geometry.md`, `part_3_analytic_state_examples.md`. | documented |
